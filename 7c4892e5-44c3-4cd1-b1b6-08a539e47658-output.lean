...
This project request had uuid: 7c4892e5-44c3-4cd1-b1b6-08a539e47658
-/
...
/-!
# IRC Section 413 - Collectively bargained plans, etc.

This file formalizes IRC §413 (Collectively bargained plans, etc.).

## References
- [26 USC §413](https://www.law.cornell.edu/uscode/text/26/413)
...
## Summary
   ...
   and
   411(d)(3)
   shall be applied as if all participants who are subject to the same benefit computation formula and who are employed by employers who are parties to the collective bargaining agreement were employed by a single employer.
   (3)
   Exclusive benefit
   ...
   Vesting
   Section 411
   (other than subsection (d)(3)) shall be applied as if all employers who have been parties to the collective-bargaining agreement constituted a single employer, except that the application of any rules with respect to breaks in service shall be made under regulations prescribed by the Secretary of Labor.
   (5)
   Funding
   The minimum funding standard provided by
   section 412
   shall be determined as if all participants in the plan were employed by a single employer.
   (6)
   ...
   For purposes of this subsection and section 4971(e), an employer’s withdrawal liability under part 1 of subtitle E of title IV of the
   Employee Retirement Income Security Act of 1974
   shall not be treated as a liability for contributions under the plan.
   (7)
   Deduction limitations
   Each applicable limitation provided by
   section 404(a)
   ...
   For purposes of this subsection, employees of employee representatives shall be treated as employees of an employer described in subsection (a)(1) if such representatives meet the requirements of sections
   401(a)(4)
   and
   410
   ...
   Vesting
   Section 411
   shall be applied as if all employers who maintain the plan constituted a single employer, except that the application of any rules with respect to breaks in service shall be made under regulations prescribed by the Secretary of Labor.
   (4)
   Funding
   (A)
   In general
   ...
   December 31, 1988
   , each employer shall be treated as maintaining a separate plan for purposes of
   section 412
   unless such plan uses a method for determining required contributions which provides that any employer contributes not less than the amount which would be required if such employer maintained a separate plan.
   (B)
   Other plans
   In the case of a plan not described in subparagraph (A), the requirements of section 412 shall be determined as if all participants in the plan were employed by a single employer unless the
   plan administrator
   elects not later than the close of the first plan year of the plan beginning after the date of enactment of the
   Technical and Miscellaneous Revenue Act of 1988
   to have the provisions of subparagraph (A) apply. An election under the preceding sentence shall take effect for the plan year in which made and, once made, may be revoked only with the consent of the Secretary.
   (5)
   Liability for funding tax
   ...
   (B)
   in the case of a plan not described in subparagraph (A), has a
   pooled plan provider
   ,
   then the plan shall not be treated as failing to meet the requirements under this title applicable to a plan described in
   section 401(a)
   ...
   If the
   pooled plan provider
   of a plan described in paragraph (1)(B) does not perform substantially all of the administrative duties which are required of the provider under paragraph (3)(A)(i) for any plan year, the Secretary may provide that the determination as to whether the plan meets the requirements under this title applicable to a plan described in
   section 401(a)
   or to a plan that consists of individual retirement accounts described in section 408 (including by reason of subsection (c) thereof), whichever is applicable, shall be made in the same manner as would be made without regard to paragraph (1).
   (3)
   Pooled plan provider
   (A)
   In general
   ...
   (i)
   is designated by the terms of the plan as a named fiduciary (within the meaning of section 402(a)(2) of the
   Employee Retirement Income Security Act of 1974
   ), as the
   plan administrator,
   and as the person responsible to perform all administrative duties (including conducting proper testing with respect to the plan and the employees of each employer in the plan) which are reasonably necessary to ensure that—
   (I)
   the plan meets any requirement applicable under the
   Employee Retirement Income Security Act of 1974
   or this title to a plan described in
   section 401(a)
   or to a plan that consists of individual retirement accounts described in section 408 (including by reason of subsection (c) thereof), whichever is applicable, and
   (II)
   ...
   registers as a
   pooled plan provider
   with the Secretary, and provides such other information to the Secretary as the Secretary may require, before beginning operations as a
   pooled plan provider
   ,
   (iii)
   acknowledges in writing that such person is a named fiduciary (within the meaning of section 402(a)(2) of the
   Employee Retirement Income Security Act of 1974
   ), and the
   plan administrator,
   with respect to the plan, and
   (iv)
   is responsible for ensuring that all persons who handle assets of, or who are fiduciaries of, the plan are bonded in accordance with section 412 of the
   Employee Retirement Income Security Act of 1974
   .
   (B)
   Audits, examinations and investigations
   The Secretary may perform audits, examinations, and investigations of
   pooled plan providers
   as may be necessary to enforce and carry out the purposes of this subsection.
   (C)
   Aggregation rules
   For purposes of this paragraph, in determining whether a person meets the requirements of this paragraph to be a
   pooled plan provider
   with respect to any plan, all persons who perform services for the plan and who are treated as a single employer under subsection (b), (c), (m), or (o) of
   section 414
   ...
   pooled plan provider
   described in subparagraph (A)(i), each employer in a plan which has a
   pooled plan provider
   shall be treated as the plan sponsor with respect to the portion of the plan attributable to employees of such employer (or beneficiaries of such employees).
   (4)
   Guidance
   (A)
   In general
   ...
   (i)
   to identify the administrative duties and other actions required to be performed by a
   pooled plan provider
   ...
   The Secretary shall take into account under clause (iii) whether the failure of an employer or
   pooled plan provider
   to provide any disclosures or other information, or to take any other action, necessary to administer a plan or to allow a plan to meet requirements applicable to the plan under
   section 401(a)
   or 408, whichever is applicable, has continued over a period of time that demonstrates a lack of commitment to compliance.
   (B)
   Good faith compliance with law before guidance
   An employer or
   pooled plan provider
   shall not be treated as failing to meet a requirement of guidance issued by the Secretary under this paragraph if, before the issuance of such guidance, the employer or
   pooled plan provider
   complies in good faith with a reasonable interpretation of the provisions of this subsection to which such guidance relates.
   (5)
   Model plan
   The Secretary shall publish model plan language which meets the requirements of this subsection and of paragraphs (43) and (44) of section 3 of the
   Employee Retirement Income Security Act of 1974
   and which may be adopted in order for a plan to be treated as a plan described in paragraph (1)(B).
   (Added
   ...
   104 Stat. 1388–518
   ;
   Pub. L. 113–97, title II, § 202(b)
   ,
   Apr. 7, 2014
   ,
   128 Stat. 1134
   ;
   Pub. L. 115–141, div. U, title IV, § 401(a)(86)
   ,
   Mar. 23, 2018
   ,
   132 Stat. 1188
   ;
   Pub. L. 116–94, div. O, title I, § 101(a)(1)
   , (2),
   Dec. 20, 2019
   ,
   133 Stat. 3138
   ...
   The
   Employee Retirement Income Security Act of 1974
   , referred to in subsecs. (b)(6) and (e), is
   Pub. L. 93–406
   ,
   Sept. 2, 1974
   ,
   88 Stat. 829
   . Part 1 of subtitle E of title IV of the
   Employee Retirement Income Security Act of 1974
   is classified generally to part 1 (§ 1381 et seq.) of subtitle E of subchapter III of chapter 18 of Title 29, Labor. Sections 3(43), (44), 402(a)(2), and 412 of the Act are classified to sections 1002(43), (44), 1102(a)(2), and 1112, respectively, of Title 29. For complete classification of this Act to the Code, see Short Title note set out under
   section 1001 of Title 29
   and Tables.
   The date of enactment of the
   Technical and Miscellaneous Revenue Act of 1988
   , referred to in subsec. (c)(4)(B), is the date of enactment of
   Pub. L. 100–647
   , which was approved
   Nov. 10, 1988
   .
   Amendments
   2019—Subsec. (c)(2).
   Pub. L. 116–94, § 101(a)(2)
   , substituted “sections 401(a) and 408(c)” for “section 401(a)”.
   Subsec. (e).
   Pub. L. 116–94, § 101(a)(1)
   , added subsec. (e).
   2018—Subsec. (b)(6).
   Pub. L. 115–141, § 401(a)(86)
   , substituted “and section 4971(e)” for “and the last sentence of section 4971(a)” in concluding provisions.
   2014—Subsec. (d).
   Pub. L. 113–97
   added subsec. (d).
   1990—Subsec. (c)(7)(B).
   Pub. L. 101–508
   substituted “Assets” for “Asset” in heading.
   1988—Subsec. (b)(9).
   Pub. L. 100–647, § 1011(h)(10)
   , added par. (9).
   Subsec. (c).
   Pub. L. 100–647, § 6058(c)
   , struck out at end “Allocations of amounts under paragraphs (4), (5), and (6), among the employers maintaining the plan, shall not be inconsistent with regulations prescribed for this purpose by the Secretary.”
   Subsec. (c)(4).
   Pub. L. 100–647, § 6058(a)
   , amended par. (4) generally. Prior to amendment, par. (4) read as follows: “The minimum funding standard provided by section 412 shall be determined as if all participants in the plan were employed by a single employer.”
   Subsec. (c)(6).
   Pub. L. 100–647, § 6058(b)
   , amended par. (6) generally. Prior to amendment, par. (6) read as follows: “Each applicable limitation provided by section 404(a) shall be determined as if all participants in the plan were employed by a single employer. The amounts contributed to or under the plan by each employer who maintains the plan, for the portion of this taxable year which is included within such a plan year, shall be considered not to exceed such a limitation if the anticipated employer contributions for such plan year (determined in a reasonable manner not inconsistent with regulations prescribed by the Secretary) do not exceed such limitation. If such anticipated contributions exceed such a limitation, the portion of each such employer’s contributions which is not deductible under section 404 shall be determined in accordance with regulations prescribed by the Secretary.”
   Subsec. (c)(7).
   Pub. L. 100–647, § 6058(c)
   , added par. (7).
   1980—Subsec. (b)(6).
   Pub. L. 96–364
   inserted provisions relating to withdrawal liability of employer.
   1976—Subsecs. (b), (c).
   Pub. L. 94–455
   ...
   Dec. 31, 2020
   , and not to be construed as limiting the authority of the Secretary of the Treasury or the Secretary’s delegate to provide for the proper treatment of a failure to meet any requirement applicable under the
   Internal Revenue Code of 1986
   with respect to one employer (and its employees) in a multiple employer plan, see
   section 101(e) of Pub. L. 116–94
   , set out as an Effective Date of 2019 Amendment note under
   ...
   102 Stat. 3699
   , provided that:
   “Except as provided in paragraph (2), the amendments made by this section [amending this section] shall apply to plan years beginning after the date of the enactment of this Act [
   Nov. 10, 1988
   ].”
   ...
   Pub. L. 117–328, div. T, title I, § 106(f)
   ,
   Dec. 29, 2022
   ,
   136 Stat. 5288
   ...
   “(1)
   Plan notifications.—
   The Secretary of the Treasury (or the Secretary’s delegate), in consultation with the Secretary of Labor, shall modify the model plan language published under section 413(e)(5) of the
   Internal Revenue Code of 1986
   to include language that requires participating employers be notified that the plan is subject to the
   Employee Retirement Income Security Act of 1974
   [
   29 U.S.C. 1001
   et seq.] and that such employer is a plan sponsor with respect to its employees participating in the multiple employer plan and, as such, has certain fiduciary duties with respect to the plan and to its employees.
   “(2)
   Model plans for multiple employer 403(b) plans.—
   For plans to which section 403(b)(15)(A) of the
   Internal Revenue Code of 1986
   applies (other than a plan maintained for its employees by a State, a political subdivision of a State, or an agency or instrumentality of any one or more of the foregoing), the Secretary of the Treasury (or the Secretary’s delegate), in consultation with the Secretary of Labor, shall publish model plan language similar to model plan language published under section 413(e)(5) of such Code.
   “(3)
   Educational outreach to employers exempt from tax.—
   The Secretary of the Treasury (or the Secretary’s delegate), in consultation with the Secretary of Labor, shall provide education and outreach to increase awareness to employers described in section 501(c)(3) of the
   Internal Revenue Code of 1986
   , and which are exempt from tax under section 501(a) of such Code, that multiple employer plans are subject to the
   Employee Retirement Income Security Act of 1974
   and that such employer is a plan sponsor with respect to its employees participating in the multiple employer plan and, as such, has certain fiduciary duties with respect to the plan and to its employees.”
   CFR Title
   Parts
   29
   2530
