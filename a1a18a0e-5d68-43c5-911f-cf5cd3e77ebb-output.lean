...
This project request had uuid: a1a18a0e-5d68-43c5-911f-cf5cd3e77ebb
-/
...
/-!
# IRC Section 511 - Imposition of tax on unrelated business income of charitable, etc., organizations

This file formalizes IRC §511 (Imposition of tax on unrelated business income of charitable, etc., organizations).

## References
- [26 USC §511](https://www.law.cornell.edu/uscode/text/26/511)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 511 - Imposition of tax on unrelated business income of charitable, etc., organizations
   U.S. Code
   Notes
   prev |
   next
   ...
   (as defined in section 512) of every organization described in paragraph (2) a tax computed as provided in section 11. In making such computation for purposes of this section, the term “taxable income” as used in section 11 shall be read as “
   unrelated business taxable income
   ”.
   (2)
   Organizations subject to tax
   (A)
   Organizations described in sections 401(a) and 501(c)
   ...
   There is hereby imposed for each taxable year on the
   unrelated business taxable income
   of every trust described in paragraph (2) a tax computed as provided in section 1(e). In making such computation for purposes of this section, the term “taxable income” as used in section 1 shall be read as “
   unrelated business taxable income
   ...
   section 501(c)(2)
   corporations
   If a corporation described in
   section 501(c)(2)
   —
   (1)
   pays any amount of its net income for a taxable year to an organization exempt from taxation under
   section 501(a)
   (or which would pay such an amount but for the fact that the expenses of collecting its income exceed its income), and
   (2)
   ...
   –(3), title III, § 301(b)(8), title VIII, § 803(d)(2),
   Dec. 30, 1969
   ,
   83 Stat. 536
   , 585, 684;
   ...
   .—
   “(1)
   Organizations taxable at corporate rates
   .—If an organization is subject to tax on
   unrelated business taxable income
   pursuant to subsection (a), the tax imposed by
   section 56
   shall apply to such organizations with respect to items of tax preference which enter into the computation of
   unrelated business taxable income
   in the same manner as section 56 applies to corporations.
   “(2)
   Organizations taxable as trusts
   .—If an organization is subject to tax on
   unrelated business taxable income
   pursuant to subsection (b), the taxes imposed by
   section 55
   shall apply to such organization with respect to items of tax preference which enter into the computation of
   unrelated business taxable income.
   ”
   1982—Subsec. (d)(2).
   Pub. L. 97–248
   substituted “section 55” for “section 55 and section 56 (as the case may be)”.
   1978—Subsec. (a)(1).
   Pub. L. 95–600, § 301(b)(5)(A)
   , substituted “a tax” for “a normal tax and a surtax”.
   Subsec. (a)(2).
   Pub. L. 95–600, § 301(b)(5)(B)
   , substituted “tax” for “taxes” wherever appearing.
   Subsec. (d).
   Pub. L. 95–600, § 421(e)(3)
   , substituted provisions relating to organizations taxable at corporate rates and organizations taxable as trusts, for provisions relating to imposition of the tax imposed by
   section 56 of this title
   to an organization subject to tax under this section for tax preferences computed in
   unrelated business taxable income.
   1977—Subsec. (b)(1).
   Pub. L. 95–30
   substituted “section 1(e)” for “section 1(d)”.
   1969—Subsec. (a)(2)(A).
   Pub. L. 91–172, § 121(a)(1)
   , removed reference, in heading, to pars. (2), (3), (5), (6), (14)(B), (C), and (17) of
   section 501(c) of this title
   , and, in text, struck out exemptions to churches, conventions, or associations of churches, from the imposition of tax on their unrelated business income, made corporations organized under
   section 501(c)(1) of this title
   (i.e. organized under Acts of
   Congress
   ), exempt from such tax, but made all such exemptions subservient to the exceptions in part II and
   section 501(a) of this title
   .
   Subsec. (b)(1).
   Pub. L. 91–172, § 803(d)(2)
   , substituted section 1(d) for section 1 in reference to section under which the computation of the tax dealing with the imposition of tax on the
   unrelated business taxable income
   of trusts, is computed.
   Subsec. (b)(2).
   ...
   , added subsec. (c). Former subsec. (c), covering the effective date, was struck out.
   Subsec. (d).
   Pub. L. 91–172, § 301(b)(8)
   , added subsec. (d).
   1966—Subsec. (a)(2)(A).
   Pub. L. 89–352
   inserted “(14)(B) or (C),” after “(6),” in heading and in text.
   1960—Subsec. (a)(2).
   Pub. L. 86–667, § 3(a)
   , included organizations described in section 501(c)(17) within subpar. (A).
   Subsec. (b).
   Pub. L. 86–667, § 3(b)
   , inserted a reference to section 501(c)(17).
   ...
   , and
   7605
   of this title] (other than by subsections (b)(3) and (e) [enacting sections
   277
   and
   6050
   ...
   ], as acquisition indebtedness for purposes of section 514(c)(1) of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] during a period of 10 years following the date of the transaction.”
   Amendment by
   section 301(b)(8) of Pub. L. 91–172
   ...
   .
   Amendment by
   section 803(d)(2) of Pub. L. 91–172
   applicable to taxable years beginning after
   Dec. 31, 1970
   , see
