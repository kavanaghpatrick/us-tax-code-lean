...
This project request had uuid: 54180def-aba2-431c-bf3a-5b0dd73fd1a9
-/
...
/-!
# IRC Section 334 - Basis of property received in liquidations

This file formalizes IRC §334 (Basis of property received in liquidations).

## References
- [26 USC §334](https://www.law.cornell.edu/uscode/text/26/334)
...
## Summary
   ...
   (1)
   In general
   If property is received by a
   corporate distributee
   in a distribution in a complete liquidation to which section 332 applies (or in a transfer described in section 337(b)(1)), the basis of such property in the hands of such distributee shall be the same as it would be in the hands of the transferor; except that, in the hands of such distributee—
   (A)
   ...
   corporate distributee
   ” means only the corporation which meets the stock ownership requirements specified in section 332(b).
   (Aug. 16, 1954, ch. 736,
   68A Stat. 104
   ;
   ...
   2005—Subsec. (b)(1).
   Pub. L. 109–135
   substituted “except that, in the hands of such distributee—” for “except that the basis of such property in the hands of such distributee shall be the fair market value of the property at the time of the distribution—” in introductory provisions, added subpars. (A) and (B), and struck out former subpars. (A) and (B) which read as follows:
   “(A) in any case in which gain or loss is recognized by the liquidating corporation with respect to such property, or
   “(B) in any case in which the liquidating corporation is a foreign corporation, the
   corporate distributee
   is a domestic corporation, and the
   corporate distributee
   ’s aggregate adjusted bases of property described in
   section 362(e)(1)(B)
   which is distributed in such liquidation would (but for this subparagraph) exceed the fair market value of such property immediately after such liquidation.”
   2004—Subsec. (b)(1).
   Pub. L. 108–357
   reenacted heading without change and amended text of par. (1) generally. Prior to amendment, text read as follows: “If property is received by a
   corporate distributee
   in a distribution in a complete liquidation to which section 332 applies (or in a transfer described in section 337(b)(1)), the basis of such property in the hands of such distributee shall be the same as it would be in the hands of the transferor; except that, in any case in which gain or loss is recognized by the liquidating corporation with respect to such property, the basis of such property in the hands of such distributee shall be the fair market value of the property at the time of the distribution.”
   1998—Subsec. (b)(1).
   Pub. L. 105–277
   substituted “section 332” for “section 332(a)”.
   1988—Subsec. (b).
   Pub. L. 100–647
   amended subsec. (b) generally. Prior to amendment, subsec. (b) read as follows:
   “(1)
   Distribution in complete liquidation
   .—If property is received by a corporation in a distribution in a complete liquidation to which section 332(a) applies, the basis of the property in the hands of the distributee shall be the same as it would be in the hands of the transferor.
   “(2)
   Transfers to which section 332
   (c)
   applies
   .—If property is received by a corporation in a transfer to which section 332(c) applies, the basis of the property in the hands of the transferee shall be the same as it would be in the hands of the transferor.
   “(3)
   Distributee defined
   ...
   , struck out “(other than a distribution to which section 333 applies)” after “liquidation”.
   Subsec. (c).
   Pub. L. 99–514, § 631(e)(4)(B)
   , struck out subsec. (c) relating to property received in liquidation under section 333.
   1982—Subsec. (a).
   ...
   section 1014(a) of this title
   the stock was not acquired in an exchange to which
   section 351 of this title
   applies, and the stock was not acquired from a person the ownership of whose stock would, under
   section 318(a) of this title
   , be attributed to the person acquiring such stock, but that “purchase” also meant an acquisition of stock from a corporation when ownership of such stock would be attributed under section 318(a) to the person acquiring such stock, if the stock of such corporation by reason of which such ownership would be attributed was acquired by purchase, and redesignated par. (4) as (3).
   1976—Subsec. (b)(2).
   Pub. L. 94–455
   , §§ 1901(a)(45), 1906(b)(13)(A), struck out in subpar. (A) provision relating to distributions made pursuant to a plan of liquidation adopted on or before
   June 22, 1954
   , and in provisions following subpar. (B)(ii) “or his delegate” after “Secretary”.
   1966—Subsec. (b)(2)(B).
   Pub. L. 89–809, § 202(b)
   , inserted provisions for the determination of the date on which to commence the running of the 12-month period during which the distributee must have acquired the stock by purchase by adding clauses (i) and (ii).
   Subsec. (b)(3).
   Pub. L. 89–809, § 202(a)
   , inserted provision that, for purposes of par. (2)(B), “purchase” also means an acquisition of stock from a corporation when ownership of such stock would be attributed under section 318(a) to the person acquiring such stock, if the stock of such corporation by reason of which such ownership would be attributed was acquired by purchase.
   ...
   118 Stat. 1596
   , provided that:
   “The amendment made by subsection (b) [amending this section] shall apply to liquidations after the date of the enactment of this Act [
   Oct. 22, 2004
   ].”
   ...
   Amendment by
   section 1901(a)(45) of Pub. L. 94–455
   ...
   Pub. L. 89–809, title II, § 202(d)
   ,
   Nov. 13, 1966
   ,
   80 Stat. 1576
   , provided that:
   “The amendment made by subsection (a) [amending this section] shall apply only with respect to acquisitions of stock after
   December 31, 1965
   . The amendment made by subsections (b) and (c) [amending this section and
   section 453 of this title
   ] shall apply only with respect to distributions made after the date of the enactment of this Act [
   Nov. 13, 1966
   ].”
   Adjustment for Liability to Basis of Property Distributed in Complete Liquidation of Corporation Prior to
   July 1, 1957
   ...
   , provided that:
   “(a)
   Notwithstanding the provisions of section 334 of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] (relating to basis of property received in liquidations), no adjustment to the basis of any property distributed in complete liquidation of a corporation prior to
   July 1, 1957
   , shall be made for any liability if—
   “(1)
   the distributor and distributee did not consider the liability relevant to the value of the stock with respect to which the distribution was made,
   “(2)
   the distributor and distributee reasonably relied upon a decision of a United States district court specifically adjudicating the amount of the liability and its affirmance by the appropriate United States court of appeals, and
   “(3)
   the amount of liability so adjudicated was not greater than would be compensated for by insurance.
   ...
   “(b)
   To the extent that the liability described in subsection (a) is not compensated for by insurance or otherwise, the amount thereof shall be allowed as a deduction under the appropriate provision of the
   Internal Revenue Code of 1986
   for the taxable year in which payment thereof was made and shall be effective in determining income tax liabilities of all taxable years prior thereto.”
   U.S. Code Toolbox
