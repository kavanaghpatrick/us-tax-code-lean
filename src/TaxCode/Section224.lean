...
This project request had uuid: 23052c6e-b3b8-4101-9021-c9ebaacdf9de
-/
...
/-!
# IRC Section 224 - Qualified tips

This file formalizes IRC §224 (Qualified tips).

## References
- [26 USC §224](https://www.law.cornell.edu/uscode/text/26/224)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 224 - Qualified tips
   U.S. Code
   Notes
   prev
   |
   ...
   qualified tips
   received during the taxable year that are included on statements furnished to the individual pursuant to section 6041(d)(3), 6041A(e)(3), 6050W(f)(2), or 6051(a)(18), or reported by the taxpayer on Form 4137 (or successor).
   (b)
   Limitation
   (1)
   In general
   ...
   In the case of
   qualified tips
   received by an individual during any taxable year in the course of a trade or business (other than the trade or business of performing services as an employee) of such individual, such
   qualified tips
   shall be taken into account under subsection (a) only to the extent that the gross income for the taxpayer from such trade or business for such taxable year (including such
   qualified tips
   ) exceeds the sum of the deductions (other than the deduction allowed under this section) allocable to the trade or business in which such
   qualified tips
   are received by the individual for such taxable year.
   (d)
   Qualified tips
   ...
   ” means
   cash tips
   received by an individual in an occupation which customarily and regularly received tips on or before
   December 31, 2024
   ...
   (B)
   the trade or business in the course of which the individual receives such amount is not a specified service trade or business (as defined in
   section 199A(d)(2)
   ), and
   (C)
   ...
   cash tips
   ” includes tips received from customers that are paid in cash or charged and, in the case of an employee, tips received under any tip-sharing arrangement.
   (e)
   ...
   (g)
   Regulations
   The Secretary shall prescribe such regulations or other guidance as may be necessary to prevent reclassification of income as
   qualified tips
   , including regulations or other guidance to prevent abuse of the deduction allowed by this section.
   (h)
   Termination
   ...
   .
   (Added
   Pub. L. 119–21, title VII, § 70201(a)
   ,
   July 4, 2025
   ,
   139 Stat. 170
   ...
   A prior
   section 224
   was sucessively renumbered section 225, then 226, of this title by
   ...
   Pub. L. 119–21, title VII, § 70201(h)
   ,
   July 4, 2025
   ,
   139 Stat. 173
   ...
   July 4, 2025
   ], the Secretary of the Treasury (or the Secretary’s delegate) shall publish a list of occupations which customarily and regularly received tips on or before
   December 31, 2024
   , for purposes of section 224(d)(1) of the
