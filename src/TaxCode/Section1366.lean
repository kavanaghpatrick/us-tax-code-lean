...
This project request had uuid: dfd7d60f-cdf5-406b-abfd-a4de9dfdcc7a
-/
...
This file formalizes IRC §1366 (Pass-thru of items to shareholders).

## References
- [26 USC §1366](https://www.law.cornell.edu/uscode/text/26/1366)
...
## Summary
   ...
   (A)
   the adjusted basis of the shareholder’s stock in the S corporation (determined with regard to paragraphs (1) and (2)(A) of
   section 1367(a)
   for the taxable year), and
   (B)
   the shareholder’s adjusted basis of any indebtedness of the S corporation to the shareholder (determined without regard to any adjustment under paragraph (2) of
   section 1367(b)
   ...
   (A)
   In general
   If for the last taxable year of a corporation for which it was an S corporation a loss or deduction was disallowed by reason of paragraph (1), such loss or deduction shall be treated as incurred by the shareholder on the last day of any
   post-termination transition period
   .
   (B)
   Cannot exceed shareholder’s basis in stock
   The aggregate amount of losses and deductions taken into account by a shareholder under subparagraph (A) shall not exceed the adjusted basis of the shareholder’s stock in the corporation (determined at the close of the last day of the
   post-termination transition period
   and without regard to this paragraph).
   (C)
   ...
   (D)
   At-risk limitations
   To the extent that any increase in adjusted basis described in subparagraph (B) would have increased the shareholder’s amount at risk under section 465 if such increase had occurred on the day preceding the commencement of the
   post-termination transition period
   , rules similar to the rules described in subparagraphs (A) through (C) shall apply to any losses disallowed by reason of section 465(a).
   (4)
   ...
   If any tax is imposed under
   section 1374
   for any taxable year on an S corporation, for purposes of subsection (a), the amount so imposed shall be treated as a loss sustained by the S corporation during such taxable year. The character of such loss shall be determined by allocating the loss proportionately among the recognized built-in gains giving rise to such tax.
   (3)
   Reduction in pass-thru for tax imposed on excess net passive income
   If any tax is imposed under
   section 1375
   for any taxable year on an S corporation, for purposes of subsection (a), each item of passive investment income shall be reduced by an amount which bears the same ratio to the amount of such tax as—
   (A)
   ...
   96 Stat. 1677
   ; amended
   Pub. L. 98–369, div. A, title IV, § 474(r)(26)
   , title VII, § 735(c)(16),
   July 18, 1984
   ,
   98 Stat. 844
   , 985;
   Pub. L. 99–514, title VI, § 632(c)(2)
   , title VII, § 701(e)(4)(K),
   Oct. 22, 1986
   ,
   100 Stat. 2277
   , 2343;
   Pub. L. 100–647, title I, § 1006(f)(5)(E)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3406
   ;
   Pub. L. 101–239, title VII, § 7811(c)(7)
   ,
   Dec. 19, 1989
   ,
   103 Stat. 2407
   ...
   , §§ 1302(e), 1307(c)(3)(A), 1309(a)(1), 1312,
   Aug. 20, 1996
   ,
   110 Stat. 1779
   , 1782, 1783, 1784;
   Pub. L. 108–357, title II, § 235(a)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1435
   ...
   121 Stat. 2474
   ;
   Pub. L. 115–141, div. U, title IV, § 401(a)(192)
   ,
   Mar. 23, 2018
   ,
   132 Stat. 1193
   ...
   2018—Subsec. (e).
   Pub. L. 115–141
   substituted “section 704(e)(2)” for “section 704(e)(3)”.
   2007—Subsec. (d)(4).
   Pub. L. 110–172
   added par. (4).
   2004—Subsec. (d)(2).
   Pub. L. 108–357
   reenacted heading without change and amended text of par. (2) generally. Prior to amendment, text read as follows: “Any loss or deduction which is disallowed for any taxable year by reason of paragraph (1) shall be treated as incurred by the corporation in the succeeding taxable year with respect to that shareholder.”
   1996—Subsec. (a)(1).
   Pub. L. 104–188, § 1302(e)
   , inserted “, or of a trust or estate which terminates,” after “who dies” in introductory provisions.
   Subsec. (d)(1)(A).
   Pub. L. 104–188, § 1309(a)(1)
   , substituted “paragraphs (1) and (2)(A)” for “paragraph (1)”.
   Subsec. (d)(3)(D).
   Pub. L. 104–188, § 1312
   , added subpar. (D).
   Subsec. (g).
   Pub. L. 104–188, § 1307(c)(3)(A)
   , struck out subsec. (g) which provided a cross reference to subchapter D of chapter 63 of this title.
   1989—Subsec. (f)(2).
   Pub. L. 101–239
   substituted “Treatment of tax imposed on built-in gains” for “Reduction in pass-thru for tax imposed on built-in gains” in heading and amended text generally. Prior to amendment, text read as follows: “If any tax is imposed under section 1374 for any taxable year on an S corporation, for purposes of subsection (a), the amount of each recognized built-in gain (within the meaning of section 1374) for such taxable year shall be reduced by its proportionate share of such tax.”
   1988—Subsec. (f)(2).
   Pub. L. 100–647
   substituted “within the meaning of section 1374” for “as defined in section 1374(d)(2)”.
   1986—Subsec. (f)(2).
   Pub. L. 99–514, § 632(c)(2)
   , amended par. (2) generally. Prior to amendment, par. (2), reduction in pass-thru for tax imposed on capital gain, read as follows: “If any tax is imposed under section 1374 for any taxable year on an S corporation, for purposes of subsection (a)—
   ...
   “(B) if the amount of such tax exceeds the amount of such long-term capital gains, the corporation’s gains from sales or exchanges of property described in
   section 1231
   ...
   Pub. L. 99–514, § 701(e)(4)(K)
   , struck out “56 or” before “1374”.
   1984—Subsec. (f).
   Pub. L. 98–369, § 474(r)(26)
   , substituted “section 34” for “section 39” in heading and text.
   Subsec. (f)(1).
   Pub. L. 98–369, § 735(c)(16)
   , substituted “and special fuels” for “, special fuels, and lubricating oil”.
   ...
   Pub. L. 108–357, title II, § 235(b)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1435
   , as amended by
   Pub. L. 109–135, title IV, § 403(c)
   ,
   Dec. 21, 2005
   ,
   119 Stat. 2620
   ...
   Amendment by
   section 632(c)(2) of Pub. L. 99–514
   applicable to taxable years beginning after
   Dec. 31, 1986
   ...
   .
   Amendment by
   section 701(e)(4)(K) of Pub. L. 99–514
   applicable to taxable years beginning after
   Dec. 31, 1986
   ...
   Amendment by
   section 474(r)(26) of Pub. L. 98–369
   applicable to taxable years beginning after
   Dec. 31, 1983
   ...
   .
   Amendment by
   section 735(c)(16) of Pub. L. 98–369
   ...
   Dec. 31, 1982
   , except that in the case of a taxable year beginning during 1982, subsec. (f)(3) of this section and sections
   1362(d)(3)
   and
   1375
