...
This project request had uuid: d8216669-4c64-46e2-90f4-672d0a15c776
-/
...
/-!
# IRC Section 1411 - Imposition of tax

This file formalizes IRC §1411 (Imposition of tax).

## References
- [26 USC §1411](https://www.law.cornell.edu/uscode/text/26/1411)
...
## Summary
   ...
   ” means—
   (1)
   in the case of a taxpayer making a joint return under
   section 6013
   ...
   (B)
   a trade or business of trading in financial instruments or commodities (as defined in
   section 475(e)(2)
   ).
   (3)
   ...
   The term “
   net investment income
   ” shall not include any distribution from a plan or arrangement described in section 401(a), 403(a), 403(b), 408, 408A, or 457(b).
   (6)
   Special rule
   ...
   For purposes of this chapter, the term “
   modified adjusted gross income
   ” means adjusted gross income increased by the excess of—
   (1)
   the amount excluded from gross income under section 911(a)(1), over
   (2)
   the amount of any deductions (taken into account in computing adjusted gross income) or exclusions disallowed under
   section 911(d)(6)
   with respect to the amounts described in paragraph (1).
   (e)
   ...
   Effective Date
   Pub. L. 111–152, title I, § 1402(a)(4)
   ,
   Mar. 30, 2010
   ,
   124 Stat. 1063
   , provided that:
   “The amendments made by this subsection [enacting this chapter and amending
