...
This file formalizes IRC §121 (Exclusion of gain from sale of principal residence).

## References
- [26 USC §121](https://www.law.cornell.edu/uscode/text/26/121)
...
## Summary
   ...
   The term “
   period of nonqualified use
   ” means any period (other than the portion of any period preceding
   January 1, 2009
   ) during which the property is not used as the principal residence of the taxpayer or the taxpayer’s spouse or former spouse.
   (ii)
   Exceptions
   The term “
   period of nonqualified use
   ...
   Solely for purposes of this section, an individual shall be treated as using property as such individual’s principal residence during any period of ownership while such individual’s spouse or former spouse is granted use of the property under a
   ...
   For purposes of this section, if the taxpayer holds stock as a tenant-stockholder (as defined in
   section 216
   ) in a cooperative housing corporation (as defined in such section), then—
   (A)
   ...
   Subsection (a) shall not apply to so much of the gain from the sale of any property as does not exceed the portion of the depreciation adjustments (as defined in
   section 1250(b)(3)
   ...
   Subparagraph (A) shall not apply to any sale to, or exchange with, any person who bears a relationship to the taxpayer which is described in
   section 267(b)
   or 707(b).
   (9)
   ...
   (A)
   In general
   At the election of an individual with respect to a property, the running of the 5-year period described in subsections (a) and (c)(1)(B) and paragraph (7) of this subsection with respect to such property shall be suspended during any period that such individual or such individual’s spouse is serving on
   qualified official extended duty
   —
   (i)
   as a member of the
   ...
   ” means any
   extended duty
   while serving at a duty station which is at least 50 miles from such property or while residing under Government orders in Government quarters.
   (ii)
   Uniformed services
   The term “
   uniformed services
   ” has the meaning given such term by
   section 101(a)(5) of title 10
   , United States Code, as in effect on the date of the enactment of this paragraph.
   (iii)
   Foreign Service of the United States
   The term “
   member of the Foreign Service of the United States
   ” has the meaning given the term “member of the Service” by paragraph (1), (2), (3), (4), or (5) of section 103 of the
   ...
   for the collection of specialized national intelligence through reconnaissance programs,
   (VIII)
   any of the intelligence elements of the Army, the Navy, the Air Force, the Marine Corps, the
   ...
   on
   qualified official extended duty
   (as defined in paragraph (9)(C)) as an
   employee
   of the
   Peace Corps
   , or
   (ii)
   as an enrolled volunteer or volunteer leader under section 5 or 6 (as the case may be) of the
   Peace Corps Act
   (
   22 U.S.C. 2504
   , 2505).
   ...
   This section shall not apply to any sale or exchange by an individual if the treatment provided by
   section 877(a)(1)
   applies to such individual.
   (f)
   ...
   For purposes of this section, in the case of property the acquisition of which by the taxpayer resulted under
   section 1034
   [1]
   (as in effect on the day before the date of the enactment of this section) in the nonrecognition of any part of the gain realized on the sale or exchange of another residence, in determining the period for which the taxpayer has owned and used such property as the taxpayer’s principal residence, there shall be included the aggregate periods for which such other residence (and each prior residence taken into account under
   section 1223(6)
   [1]
   in determining the holding period of such property) had been so owned and used.
   (Added
   ...
   , §§ 212(c), 213(c)(1), 221(a)(20),
   Dec. 19, 2014
   ,
   128 Stat. 4033
   , 4040;
   Pub. L. 115–97, title I, § 11051(b)(3)(A)
   ,
   Dec. 22, 2017
   ,
   131 Stat. 2089
   ...
   Section 103 of the
   Foreign Service Act of 1980
   , referred to in subsec. (d)(9)(C)(iii), is classified to
   section 3903 of Title 22
   ...
   Pub. L. 105–34
   which amended this section generally and was approved
   Aug. 5, 1997
   .
   Section 1034
   was repealed by
   ...
   111 Stat. 839
   .
   Section 1223(6), referred to in subsec. (g), was repealed by
   ...
   .
   Codification
   Pub. L. 109–135, title IV, § 403(ee)(1)
   , (nn),
   Dec. 21, 2005
   ,
   119 Stat. 2631
   , 2632, which directed that subsec. (d) of this section be amended by redesignating the paragraph (10) relating to property acquired from a decedent as paragraph (11), effective as if included in the provisions to which such amendment relates of the
   American Jobs Creation Act of 2004
   ,
   Pub. L. 108–357
   , was executed as the probable intent of
   Congress
   by redesignating as paragraph (11) the paragraph (10) directed to be added to subsec. (d) of this section by
   Pub. L. 107–16, § 542(c)
   , (f)(1), applicable to estates of decedents dying after
   Dec. 31, 2009
   . See Codification note, 2001, 2003, and 2005 Amendment notes, and Effective Date of 2005 Amendment note below.
   Pub. L. 108–121, title I, § 101(a)
   , (b)(1),
   Nov. 11, 2003
   ,
   117 Stat. 1336
   , which directed that subsec. (d) of this section be amended by redesignating paragraph (9) as (10) and adding a new paragraph (9), effective as if included in the amendments made by section 312 of the
   Taxpayer Relief Act of 1997
   ,
   Pub. L. 105–34
   , could not literally be executed insofar as it directed the redesignation because subsec. (d), as amended by
   Pub. L. 105–34
   , did not contain a paragraph (9). However, to reflect the probable intent of
   Congress
   , the amendment was executed by redesignating as paragraph (10) the paragraph (9) directed to be added to subsec. (d) of this section by
   Pub. L. 107–16, § 542(c)
   , (f)(1), applicable to estates of decedents dying after
   Dec. 31, 2009
   . See Codification note above and 2001, 2003, and 2005 Amendment notes and Effective Date of 2003 Amendment note below.
   Prior Provisions
   A prior
   section 121
   was renumbered
   ...
   Amendments
   2017—Subsec. (d)(3)(B).
   Pub. L. 115–97, § 11051(b)(3)(A)(i)
   , struck out “(as defined in section 71(b)(2))” after
   “divorce or separation instrument”
   .
   Subsec. (d)(3)(C).
   Pub. L. 115–97, § 11051(b)(3)(A)(ii)
   , added subpar. (C).
   2014—Subsec. (b)(3).
   Pub. L. 113–295, § 221(a)(20)
   , struck out subpar. (A) designation and heading and subpar. (B) and realigned margins. Prior to amendment, text of subpar. (B) read as follows: “Subparagraph (A) shall be applied without regard to any sale or exchange before
   May 7, 1997
   .”
   Subsec. (b)(4), (5).
   Pub. L. 113–295, § 212(c)
   , redesignated par. (4), relating to exclusion of gain allocated to nonqualified use, as (5).
   Subsec. (d)(12)(B).
   Pub. L. 113–295, § 213(c)(1)
   , inserted “of paragraph (9)” after “and (D)”.
   2010—Subsec. (d)(11).
   Pub. L. 111–312
   amended subsec. (d) to read as if amendment by
   Pub. L. 107–16, § 542(c)
   , which originally added par. (9), had never been enacted. See Codification notes above and 2001 Amendment note and Effective Date of 2010 Amendment note below. Prior to amendment, par. (11) read as follows: “
   Property acquired from a decedent
   .—The exclusion under this section shall apply to property sold by—
   “(A) the estate of a decedent,
   “(B) any individual who acquired such property from the decedent (within the meaning of
   section 1022
   ), and
   “(C) a trust which, immediately before the death of the decedent, was a qualified revocable trust (as defined in
   section 645(b)(1)
   ) established by the decedent,
   determined by taking into account the ownership and use by the decedent.”
   2008—Subsec. (b)(4).
   Pub. L. 110–289
   added par. (4) relating to exclusion of gain allocated to nonqualified use.
   Subsec. (d)(9)(C)(vi).
   Pub. L. 110–245, § 113(b)
   , struck out heading and text of cl. (vi). Text read as follows: “An
   employee of the intelligence community
   shall not be treated as serving on qualified
   extended duty
   unless such duty is at a duty station located outside the United States.”
   Subsec. (d)(9)(E).
   Pub. L. 110–245, § 113(a)
   , struck out heading and text of subpar. (E). Text read as follows: “Clause (iii) of subparagraph (A) shall not apply with respect to any sale or exchange after
   December 31, 2010
   .”
   Subsec. (d)(12).
   Pub. L. 110–245, § 110(a)
   ...
   2007—Subsec. (b)(4).
   Pub. L. 110–142
   added par. (4) relating to special rule for certain sales by surviving spouses.
   Subsec. (d)(9)(E).
   Pub. L. 110–172
   added subpar. (E).
   2006—Subsec. (d)(9).
   ...
   , substituted
   “Uniformed services,
   Foreign Service, and intelligence community” for “Members of
   uniformed services
   and Foreign Service” in heading.
   Subsec. (d)(9)(A).
   Pub. L. 109–432, § 417(a)
   , substituted “duty—
   ...
   uniformed services
   or of the Foreign Service of the United States.”
   Subsec. (d)(9)(C)(iv), (v).
   Pub. L. 109–432, § 417(b)
   ...
   , added cl. (vi).
   2005—Subsec. (d)(10).
   Pub. L. 109–135, § 403(ee)(2)
   , amended heading and text of par. (10) relating to property acquired in like-kind exchange generally. Prior to amendment, text read as follows: “If a taxpayer acquired property in an exchange to which section 1031 applied, subsection (a) shall not apply to the sale or exchange of such property if it occurs during the 5-year period beginning with the date of the acquisition of such property.”
   Subsec. (d)(11).
   Pub. L. 109–135, § 403(ee)(1)
   , redesignated par. (10), formerly par. (9), as added by
   Pub. L. 107–16
   , as (11). See Codification notes above and 2001 and 2003 Amendment notes and Effective Date of 2001 Amendment note below.
   Subsec. (g).
   Pub. L. 109–135, § 402(a)(3)
   , substituted “section 1223(6)” for “section 1223(7)”.
   2004—Subsec. (d)(10).
   Pub. L. 108–357
   added par. (10) relating to property acquired in like-kind exchange.
   2003—Subsec. (d)(9), (10).
   Pub. L. 108–121
   added par. (9) and redesignated former par. (9), as added by
   Pub. L. 107–16
   , as (10). See Codification notes above and 2001 Amendment note and Effective Date of 2001 Amendment note below.
   2001—Subsec. (d)(9).
   Pub. L. 107–16, § 542(c)
   , added par. (9). See Codification notes above and Effective Date of 2001 Amendment note below.
   1998—Subsec. (b)(2).
   Pub. L. 105–206, § 6005(e)(1)
   , substituted “Special rules for joint returns” for “$500,000 limitation for certain joint returns” in heading and amended text generally. Prior to amendment, text read as follows: “Paragraph (1) shall be applied by substituting ‘$500,000’ for ‘$250,000’ if—
   ...
   1997—
   Pub. L. 105–34
   amended section catchline and text generally. Prior to amendment, section related to one-time exclusion of gain from sale of principal residence by individual who had attained age 55.
   1988—Subsec. (d)(9).
   Pub. L. 100–647
   added par. (9).
   1981—Subsec. (b)(1).
   Pub. L. 97–34
   substituted “$125,000 ($62,500” for “$100,000 ($50,000”.
   1978—
   Pub. L. 95–600, § 404(a)
   , substituted “One-time exclusion of gain from sale of principal residence by individual who has attained age 55” for “Gain from sale or exchange of residence of individual who has attained age 65” in section catchline.
   Subsec. (a).
   Pub. L. 95–600, § 404(a)
   , substituted “55” for “65”, “5-year” for “8-year”, and “3 years” for “5 years”.
   Subsec. (b).
   Pub. L. 95–600, § 404(a)
   , in par. (1) substituted provisions respecting dollar limitations for amount of gain for provisions setting forth applicable limitations where the adjusted sales price exceeds $35,000 and added par. (3).
   Subsec. (d)(2).
   Pub. L. 95–600, § 404(c)(1)
   , substituted “5-year period” for “8-year period”.
   Subsec. (d)(5).
   Pub. L. 95–600, § 404(c)(2)
   , substituted “5-year period” for “8-year period” and “3 years” for “5 years”.
   Subsec. (d)(8).
   Pub. L. 95–600, § 404(b)
   , added par. (8).
   1976—Subsec. (b)(1).
   Pub. L. 94–455, § 1404(a)
   , substituted “$35,000” for “$20,000” in three places.
   Subsecs. (c), (d)(5).
   ...
   Amendment by
   section 212(c) of Pub. L. 113–295
   ...
   Amendment by
   section 221(a)(20) of Pub. L. 113–295
   effective
   Dec. 19, 2014
   ...
   124 Stat. 3301
   , provided that:
   “Except as otherwise provided in this section, the amendments made by this section [amending this section and sections
   170
   ,
   684
   ,
   ...
   , and
   6716
   of this title] shall apply to estates of decedents dying, and transfers made, after
   December 31, 2009
   .”
   ...
   ,
   124 Stat. 3304
   , which provided that section 901 of the
   Economic Growth and Tax Relief Reconciliation Act of 2001
   ,
   Pub. L. 107–16
   , would apply to the amendments made by title III of
   Pub. L. 111–312
   , was repealed by
   Pub. L. 112–240, title I, § 101(a)(2)
   ,
   Jan. 2, 2013
   ,
   126 Stat. 2315
   ...
   Pub. L. 112–240
   (repealing
   section 304 of Pub. L. 111–312
   , formerly set out above) applicable to taxable, plan, or limitation years beginning after
   Dec. 31, 2012
   , and estates of decedents dying, gifts made, or generation skipping transfers after
   Dec. 31, 2012
   , see
   section 101(a)(3) of Pub. L. 112–240
   , set out as a note following former
   section 901 of Pub. L. 107–16
   which was set out as an Effective and Termination Dates of 2001 Amendment note under
   section 1 of this title
   .]
   ...
   122 Stat. 2912
   , provided that:
   “The amendment made by this section [amending this section] shall apply to sales and exchanges after
   December 31, 2008
   .”
   ...
   122 Stat. 1635
   , provided that:
   “The amendments made by this section [amending this section] shall apply to sales or exchanges after the date of the enactment of this Act [
   June 17, 2008
   ].”
   ...
   121 Stat. 1806
   , provided that:
   “The amendment made by this section [amending this section] shall apply to sales or exchanges after
   December 31, 2007
   .”
   ...
   Amendment by
   section 402(a)(3) of Pub. L. 109–135
   effective as if included in the provisions of the
   ...
   .
   Amendment by
   section 403(ee) of Pub. L. 109–135
   ...
   118 Stat. 1597
   , provided that:
   “The amendment made by this section [amending this section] shall apply to sales or exchanges after the date of the enactment of this Act [
   Oct. 22, 2004
   ].”
   ...
   “(1)
   Effective date.—
   The amendments made by this section [amending this section] shall take effect as if included in the amendments made by section 312 of the
   Taxpayer Relief Act of 1997
   [
   Pub. L. 105–34
   ].
   ...
   “(1)
   In general.—
   Except as provided in paragraph (2), the amendments made by this section [enacting sections
   1022
   and
   6716
   ...
   The amendments made by subsection (e)(1) [amending
   ...
   “(3)
   Section 4947.—
   The amendment made by subsection (e)(4) [amending
   section 4947 of this title
   ...
   111 Stat. 841
   , as amended by
   Pub. L. 105–206, title VI, § 6005(e)(3)
   ,
   July 22, 1998
   ,
   112 Stat. 806
   ...
   (as amended by this section) shall be applied without regard to subsection (c)(2)(B) thereof in the case of any sale or exchange of property during the 2-year period beginning on the date of the enactment of this Act if the taxpayer held such property on the date of the enactment of this Act and fails to meet the ownership and use requirements of subsection (a) thereof with respect to such property.
   “(4)
   Binding contracts.—
   ...
   “(B)
   without regard to such amendments, gain would not be recognized under section 1034 of the
   Internal Revenue Code of 1986
   (as in effect on the day before the date of the enactment of this Act) on such sale or exchange by reason of a new residence acquired on or before such date or with respect to the acquisition of which by the taxpayer a binding contract was in effect on such date.
   This paragraph shall not apply to any sale or exchange by an individual if the treatment provided by section 877(a)(1) of the
   Internal Revenue Code of 1986
   applies to such individual.”
   ...
   102 Stat. 3691
   , provided that:
   “The amendment made by subsection (a) [amending this section] shall apply with respect to any sale or exchange after
   September 30, 1988
   ...
   95 Stat. 197
   , provided that:
   “The amendment made by this section [amending this section] shall apply to residences sold or exchanged after
   July 20, 1981
   .”
   ...
   , and
   6012
   of this title] shall apply to sales or exchanges after
   July 26, 1978
   , in taxable years ending after such date.”
   ...
   78 Stat. 40
   , provided that:
   “The amendments made by this section [enacting this section, redesignating former
   section 121
   as 122, and amending sections
   1033
   ,
   1034
   , and
   ...
   Sense of
   Congress
   Concerning Tax Treatment of Principal Residence of Members of Armed Forces While Away From Home on Active Duty
   ...
   “It is the sense of
   Congress
   that a member of the Armed Forces should be treated for purposes of section 121 of the
   Internal Revenue Code of 1986
   as using property as a principal residence during any continuous period that the member is serving on active duty for 180 days or more with the Armed Forces, but only if the member used the property as a principal residence for any period during or immediately before that period of active duty.”
   ...
   July 26, 1981
   , a taxpayer who has attained age 65 on the date of such sale or exchange may elect to have section 121 of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] applied by substituting ‘8-year period’ for ‘5-year period’ and ‘5 years’ for ‘3 years’ in subsections (a), (d)(2), and (d)(5) of such section.”
   CFR Title
   Parts
   26
   301
