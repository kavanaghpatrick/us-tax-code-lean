...
This project request had uuid: 2bf65e8f-1a20-40e3-b049-e2d73bd60b17
-/
...
This file formalizes IRC §1212 (Capital loss carrybacks and carryovers).

## References
- [26 USC §1212](https://www.law.cornell.edu/uscode/text/26/1212)
...
## Summary
   ...
   (i)
   such loss is not attributable to a
   foreign expropriation capital loss
   , and
   (ii)
   the carryback of such loss does not increase or produce a net operating loss (as defined in
   section 172(c)
   ...
   foreign expropriation capital loss
   ” means, for any taxable year, the sum of the losses taken into account in computing the net capital loss for such year which are—
   (i)
   ...
   For purposes of paragraph (1), the portion of any net capital loss for any taxable year attributable to a
   foreign expropriation capital loss
   is the amount of the
   foreign expropriation capital loss
   for such year (but not in excess of the net capital loss for such year).
   (C)
   Priority of application
   For purposes of paragraph (1), if a portion of a net capital loss for any taxable year is attributable to a
   foreign expropriation capital loss
   , such portion shall be considered to be a separate net capital loss for such year to be applied after the other portion of such net capital loss.
   (3)
   ...
   (A)
   for which it is a regulated investment company (as defined in
   section 851
   ), or
   (B)
   for which it is a real estate investment trust (as defined in
   section 856
   ).
   (b)
   Other taxpayers
   ...
   (2)
   Treatment of amounts allowed under
   section 1211(b)(1)
   or (2)
   (A)
   In general
   ...
   adjusted taxable income
   ” means taxable income increased by the sum of—
   (i)
   ...
   (c)
   Carryback of losses from
   section 1256
   contracts to offset prior gains from such contracts
   (1)
   In general
   If a taxpayer (other than a corporation) has a net
   section 1256
   contracts loss for the taxable year and elects to have this subsection apply to such taxable year, the amount of such net section 1256 contracts loss—
   (A)
   ...
   (i)
   40 percent of the amount so allowed shall be treated as a short-term capital loss from
   section 1256
   contracts, and
   (ii)
   60 percent of the amount so allowed shall be treated as a long-term capital loss from
   section 1256
   contracts.
   (2)
   ...
   (A)
   such amount does not exceed the net
   section 1256
   contract gain for such year, and
   (B)
   the allowance of such carryback does not increase or produce a net operating loss (as defined in
   section 172(c)
   ) for such year.
   (4)
   Net
   section 1256
   contracts loss
   For purposes of paragraph (1), the term “net
   section 1256
   contracts loss” means the lesser of—
   (A)
   the net capital loss for the taxable year determined by taking into account only gains and losses from
   section 1256
   contracts, or
   (B)
   ...
   (i)
   the capital gain net income for the taxable year determined by taking into account only gains and losses from
   section 1256
   contracts, or
   (ii)
   ...
   The net
   section 1256
   contract gain for any taxable year before the loss year shall be computed without regard to the net section 1256 contracts loss for the loss year or for any taxable year thereafter.
   (6)
   Coordination with carryforward provisions of subsection (b)(1)
   (A)
   Carryforward amount reduced by amount used as carryback
   For purposes of applying subsection (b)(1), if any portion of the net
   section 1256
   contracts loss for any taxable year is allowed as a carryback under paragraph (1) to any preceding taxable year—
   (i)
   ...
   (B)
   Carryover loss retains character as attributable to
   section 1256
   contract
   Any amount carried forward as a short-term or long-term capital loss to any taxable year under subsection (b)(1) (after the application of subparagraph (A)) shall, to the extent attributable to losses from
   section 1256
   contracts, be treated as loss from section 1256 contracts for such taxable year.
   (7)
   ...
   The term “
   section 1256
   contract” means any section 1256 contract (as defined in section 1256(b)) to which section 1256 applies.
   (B)
   ...
   83 Stat. 638
   , 639, 641, 642;
   Pub. L. 94–455, title XIV, § 1403
   (a), title XIX, § 1901(b)(33)(O),
   Oct. 4, 1976
   ,
   90 Stat. 1733
   , 1802;
   Pub. L. 95–600, title VII, § 703(k)
   ,
   Nov. 6, 1978
   ,
   92 Stat. 2942
   ;
   Pub. L. 97–34, title V, § 504
   ,
   Aug. 13, 1981
   ,
   95 Stat. 330
   ...
   96 Stat. 1695
   ;
   Pub. L. 97–448, title I, § 105(c)(7)
   ,
   Jan. 12, 1983
   ,
   96 Stat. 2387
   ;
   Pub. L. 98–369, div. A, title I, § 102(e)(3)
   , title X, § 1002(a),
   July 18, 1984
   ,
   98 Stat. 624
   , 1012;
   Pub. L. 99–514, title III, § 301(b)(11)
   , title XVIII, § 1899A(67),
   Oct. 22, 1986
   ,
   100 Stat. 2218
   , 2962;
   Pub. L. 100–647, title I, § 1003(a)(3)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3382
   ;
   Pub. L. 108–357, title IV, § 413(c)(20)(A)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1509
   ;
   Pub. L. 111–325, title I, § 101(a)
   , (b)(1),
   Dec. 22, 2010
   ,
   124 Stat. 3538
   ...
   Amendments
   2010—Subsec. (a)(1)(C).
   Pub. L. 111–325, § 101(b)(1)
   , amended subpar. (C) generally. Prior to amendment, subpar. (C) read as follows: “a capital loss carryover—
   ...
   Subsec. (c)(6)(B), (7)(A).
   Pub. L. 99–514, § 1899A(67)
   , amended directory language of
   Pub. L. 98–369, § 102(e)(3)(C)
   , resulting in amendment of subsec. (c)(6)(B). See 1984 Amendment note below.
   1984—Subsec. (b)(3).
   Pub. L. 98–369, § 1002(a)
   , struck out par. (3) which read as follows: “In the case of any amount which, under paragraph (1) and section 1211(b) (as in effect for taxable years beginning before
   January 1, 1970
   ), is treated as a capital loss in the first taxable year beginning after
   December 31, 1969
   , paragraph (1) and
   section 1211(b)
   (as in effect for taxable years beginning before
   January 1, 1970
   ) shall apply (and paragraph (1) and
   section 1211(b)
   as in effect for taxable years beginning after
   December 31, 1969
   , shall not apply) to the extent such amount exceeds the total of any net capital gains (determined without regard to this subsection) of taxable years beginning after
   December 31, 1969
   .”
   Subsec. (c).
   Pub. L. 98–369, § 102(e)(3)(A)
   , (B), substituted “net section 1256 contracts loss” for “net commodity futures loss” and “section 1256 contracts” for “regulated futures contracts” wherever appearing.
   Subsec. (c)(3)(A), (5).
   Pub. L. 98–369, § 102(e)(3)(D)
   , substituted “net section 1256 contract gain” for “net commodity futures gain” wherever appearing.
   Subsec. (c)(6)(B), (7)(A).
   Pub. L. 98–369, § 102(e)(3)(C)
   , as amended by
   Pub. L. 99–514, § 1899A(67)
   , substituted “section 1256 contract” for “regulated futures contract” wherever appearing.
   1983—Subsec. (c)(4)(A).
   Pub. L. 97–448
   struck out “and positions to which section 1256 applies” after “losses from regulated futures contracts”.
   1982—Subsec. (a)(3), (4).
   Pub. L. 97–354
   struck out par. (3) relating to electing small business corporations, and redesignated par. (4) as (3).
   1981—Subsec. (c).
   Pub. L. 97–34
   added subsec. (c).
   1978—Subsec. (a)(1)(C)(ii).
   Pub. L. 95–600
   substituted “succeeding the loss year” for “exceeding the loss year”.
   1976—Subsec. (a)(1).
   Pub. L. 94–455
   , §§ 1403(a), 1901(b)(33)(O), in subpar. (B) inserted introductory text “except as provided in subparagraph (C),” and struck out “(10) taxable years to the extent such loss is attributable to a
   foreign expropriation capital loss)
   ” after “5 taxable years” and added subpar. (C), and substituted “capital gain net income” for “net capital gains”, “net capital gain” and “net capital gain” in last three sentences, respectively.
   1969—
   Pub. L. 91–172, § 512(f)(1)
   , substituted “carrybacks and carryovers” for “carryover” in section catchline.
   Subsec. (a)(1).
   Pub. L. 91–172, § 512(a)
   , provided for a 3-year capital loss carryback for corporations, not available for
   foreign expropriation capital losses
   for which a special 10-year carryforward is presently available, in addition to the 5–year capital loss carryforward presently allowed corporations, to the extent the carryback of such loss does not increase or produce a net operating loss for the taxable year to which it is being carried back.
   Subsec. (a)(3), (4).
   Pub. L. 91–172, § 512(b)
   , added pars. (3) and (4).
   Subsec. (b).
   ...
   Dec. 31, 1963
   , struck out determination of a short-term capital gain as an amount equal to the excess allowed for the taxable year under former
   section 1211(b)
   over the gains from sales or exchanges of capital assets, struck out par. (2) treating as a short-term capital loss in the first taxable year beginning after
   Dec. 31, 1963
   , any amount which is treated as a short-term capital loss in such year under this subchapter as in effect immediately before the enactment of the
   Revenue Act of 1964
   , added new par. (2) dealing with special rules for determining the excesses referred to in par. (1)(A) and par. (1)(B) and added par. (3).
   1964—Subsec. (a).
   Pub. L. 88–571
   provided that if any portion of a net capital loss is attributable to a
   foreign expropriation capital loss,
   such portion shall be a short-term capital loss in each of the 10 succeeding taxable years, defined
   foreign expropriation capital loss,
   stated what portion of loss is attributable to
   foreign expropriation capital loss
   and the priority of application of the net capital loss, and struck out provisions that net capital losses for taxable years beginning before
   Oct. 20, 1951
   , were to be determined under the applicable law relating to the computation of capital gains and losses in effect before such date.
   Pub. L. 88–272
   designated existing provisions as subsec. (a), limited such subsection to corporations, and added subsec. (b).
   ...
   124 Stat. 3538
   , as amended by
   Pub. L. 113–295, div. A, title II, § 205(a)(1)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4025
   ...
   ] shall apply to net capital losses for taxable years beginning after the date of the enactment of this Act [
   Dec. 22, 2010
   ].
   “(2)
   Coordination rules.—
   Subparagraph (B) of section 1212(a)(3) of the
   Internal Revenue Code of 1986
   , as added by this section, shall apply to taxable years beginning after the date of the enactment of this Act.
   “(3)
   Excise tax.—
   “(A)
   In general.—
   Except as provided in subparagraph (B), for purposes of section 4982 of the
   Internal Revenue Code of 1986
   , paragraphs (1) and (2) shall apply by substituting ‘the 1-year periods taken into account under subsection (b)(1)(B) of such section with respect to calendar years beginning after
   December 31, 2010
   ...
   Amendment by
   section 301(b)(11) of Pub. L. 99–514
   ...
   Amendment by
   section 102(e)(3) of Pub. L. 98–369
   applicable to positions established after
   July 18, 1984
   , in taxable years after that date, except as otherwise provided, see section 102(f), (g) of
   Pub. L. 98–369
   , set out as a note under
   ...
   98 Stat. 1012
   , provided that:
   “The repeal made by subsection (a) [amending this section] shall apply to taxable years beginning after
   December 31, 1986
   .”
   ...
   100 Stat. 2095
   , provided that:
   “The amendments made by this section [amending this section] shall apply to loss years (within the meaning of section 1212(a)(1) of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954]) ending on or after
   January 1, 1970
   .”
   Amendment by
   section 1901(b)(33)(O) of Pub. L. 94–455
   ...
   , and
   6611
   of this title] shall apply with respect to net capital losses sustained in taxable years beginning after
   December 31, 1969
   .”
   Amendment by
   section 513(b) of Pub. L. 91–172
   applicable to taxable years beginning after
   Dec. 31, 1969
   , see
   ...
   100 Stat. 2095
   , provided that:
   “The amendment made by subsection (a) [amending this section] shall apply with respect to net capital losses (to the extent attributable to
   foreign expropriation capital losses
   , as defined in section 1212(a)(2)(A) of the
   Internal Revenue Code of 1986
   ...
   , provided that:
   “(a)
   For purposes of applying section 1212(a) of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] (as amended by section 512 of the
   Tax Reform Act of 1969
   ) in the case of a corporation which makes an election under subsection (b), any net capital loss sustained in a taxable year beginning after
   December 31, 1969
   , may not be carried back to any taxable year beginning before
   January 1, 1970
   , for which it was subject to taxation under section 802 of such Code [
   section 802 of this title
   ], if the carryback of such loss would result in an increase in such corporation’s income tax liability for any such taxable year.
   “(b)
   An election to have the provisions of subsection (a) apply shall be made by a corporation—
   “(1)
   in such form and manner as the Secretary of the Treasury or his delegate may prescribe, and
   “(2)
   not later than the time prescribed by law for filing a claim for credit or refund of overpayment of income tax for the first taxable year beginning after
   December 31, 1969
   , in which such corporation sustains a net capital loss.
   “(c)
   The Secretary of the Treasury or his delegate shall prescribe such regulations as he determines necessary to carry out the purposes of this section.”
   U.S. Code Toolbox
