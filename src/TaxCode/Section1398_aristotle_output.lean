...
This project request had uuid: 24a62137-f094-45b0-8e94-8541297dbeef
-/
...
/-!
# IRC Section 1398 - Rules relating to individuals’ title 11 cases

This file formalizes IRC §1398 (Rules relating to individuals’ title 11 cases).

## References
- [26 USC §1398](https://www.law.cornell.edu/uscode/text/26/1398)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 1398 - Rules relating to individuals’ title 11 cases
   U.S. Code
   Notes
   prev |
   next
   ...
   (A)
   In general
   Notwithstanding section 442, the debtor may (without the approval of the Secretary) elect to treat the debtor’s taxable year which includes the
   commencement date
   as 2 taxable years—
   (i)
   the first of which ends on the day before the
   commencement date
   , and
   (ii)
   the second of which begins on the
   commencement date
   .
   (B)
   ...
   section 7703
   ), the spouse may elect to have the debtor’s election under subparagraph (A) also apply to the spouse, but only if the debtor and the spouse file a joint return for the taxable year referred to in subparagraph (A)(i).
   (C)
   ...
   commencement date
   ” means the day on which the case under title 11 of the United States Code to which this section applies commences.
   (e)
   Treatment of income, deductions, and credits
   (1)
   Estate’s share of debtor’s income
   The gross income of the estate for each taxable year shall include the gross income of the debtor to which the estate is entitled under title 11 of the United States Code. The preceding sentence shall not apply to any amount received or accrued by the debtor before the
   commencement date
   ...
   A transfer (other than by sale or exchange) of an asset from the debtor to the estate shall not be treated as a
   disposition
   for purposes of any provision of this title assigning tax consequences to a
   disposition
   , and the estate shall be treated as the debtor would be treated with respect to such asset.
   (2)
   Transfer from estate to debtor not treated as disposition
   In the case of a termination of the estate, a transfer (other than by sale or exchange) of an asset from the estate to the debtor shall not be treated as a
   disposition
   for purposes of any provision of this title assigning tax consequences to a
   disposition
   , and the debtor shall be treated as the estate would be treated with respect to such asset.
   (g)
   ...
   section 503 of title 11
   of the United States Code, and any fee or charge assessed against the estate under chapter
   123
   of title 28 of the United States Code, to the extent not disallowed under any other provision of this title, shall be allowed as a deduction.
   (2)
   Carryback and carryover of excess administrative costs, etc., to estate taxable years
   (A)
   Deduction allowed
   There shall be allowed as a deduction for the taxable year an amount equal to the aggregate of (i) the administrative expense carryovers to such year, plus (ii) the administrative expense
   carrybacks
   to such year.
   (B)
   Administrative expense loss, etc.
   If a net operating loss would be created or increased for any estate taxable year if section 172(c) were applied without the modification contained in paragraph (4) of section 172(d), then the amount of the net operating loss so created (or the amount of the increase in the net operating loss) shall be an administrative expense loss for such taxable year which shall be an administrative expense
   carryback
   to each of the 3 preceding taxable years and an administrative expense carryover to each of the 7 succeeding taxable years.
   (C)
   Determination of amount carried to each taxable year
   The portion of any administrative expense loss which may be carried to any other taxable year shall be determined under section 172(b)(2), except that for each taxable year the computation under
   section 172(b)(2)
   with respect to the net operating loss shall be made before the computation under this paragraph.
   (D)
   ...
   If any
   carryback year
   of the estate is a taxable year before the estate’s first taxable year, the
   carryback
   to such
   carryback year
   shall be taken into account for the debtor’s taxable year corresponding to the
   carryback year
   .
   (B)
   Carrybacks from debtor’s activities
   The debtor may not carry back to a taxable year before the debtor’s taxable year in which the case commences any
   carryback
   ...
   The term “
   carryback
   ” means a net operating loss
   carryback
   under
   section 172
   or a
   carryback
   of any credit provided by part IV of subchapter A.
   (ii)
   Carryback year
   The term “
   carryback year
   ” means the taxable year to which a
   carryback
   is carried.
   (Added
   Pub. L. 96–589, § 3(a)(1)
   ...
   94 Stat. 3397
   ; amended
   Pub. L. 99–514, title I, § 104(b)(14)
   , title XIII, § 1301(j)(8), title XVIII, § 1812(a)(5),
   Oct. 22, 1986
   ,
   100 Stat. 2105
   , 2658, 2833.)
   ...
   Amendments
   1986—Subsec. (c).
   Pub. L. 99–514, § 104(b)(14)(A)
   , substituted “basic standard deduction” for “zero bracket amount” in heading.
   Subsec. (c)(3).
   Pub. L. 99–514, § 104(b)(14)(B)
   , amended par. (3) generally, substituting “Basic standard deduction” for “Amount of zero bracket amount” in heading and substituting “In the case of an estate which does not itemize deductions, the basic standard deduction for the estate” for “The amount of the estate’s zero bracket amount” in text.
   Subsec. (d)(2)(B).
   Pub. L. 99–514, § 1301(j)(8)
   , substituted “section 7703” for “section 143”.
   Subsec. (g)(3).
   Pub. L. 99–514, § 1812(a)(5)
   , amended par. (3) generally. Prior to amendment, par. (3), recovery exclusion, read as follows: “Any recovery exclusion under section 111 (relating to recovery of bad debts, prior taxes, and delinquency amounts).”
   Statutory Notes and Related Subsidiaries
   Effective Date of 1986 Amendment
   Amendment by
   section 104(b)(14) of Pub. L. 99–514
   ...
   .
   Amendment by
   section 1812(a)(5) of Pub. L. 99–514
   ...
   .
   Effective Date
   Subchapter applicable to bankruptcy cases commencing more than 90 days after
   Dec. 24, 1980
   , see
