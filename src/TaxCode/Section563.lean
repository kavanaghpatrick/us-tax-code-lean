...
This project request had uuid: 0886c5b1-3c89-4c59-b027-d1e643072de2
-/
...
/-!
# IRC Section 563 - Rules relating to dividends paid after close of taxable year

This file formalizes IRC §563 (Rules relating to dividends paid after close of taxable year).

## References
- [26 USC §563](https://www.law.cornell.edu/uscode/text/26/563)
...
## Summary
   ...
   2015—
   Pub. L. 114–41
   substituted “fourth month” for “third month” wherever appearing.
   2004—Subsecs. (c), (d).
   Pub. L. 108–357
   redesignated subsec. (d) as (c), substituted “subsection (a) or (b)” for “subsection (a), (b), or (c)”, and struck out former subsec. (c) which related to foreign personal holding company tax.
   1989—Subsec. (c).
   Pub. L. 101–239, § 7401(b)(1)
   , added subsec. (c). Former subsec. (c) redesignated (d).
   Subsec. (d).
   Pub. L. 101–239, § 7401(b)(2)
   , substituted “subsection (a), (b), or (c)” for “subsection (a) or (b)”.
   Pub. L. 101–239, § 7401(b)(1)
   ...
   applicable to taxable years of foreign corporations beginning after
   July 10, 1989
   , with special rules for any foreign corporation required by the amendments made by
   section 7401 of Pub. L. 101–239
   to change its taxable year for its first taxable year beginning after
   July 10, 1989
   , see
