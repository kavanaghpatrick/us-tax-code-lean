...
## Summary
   ...
   1990—Subsec. (c).
   Pub. L. 101–508, § 11322(a)
   , inserted sentence at end specifying the contents of regulations.
   Subsec. (d)(1).
   Pub. L. 101–508, § 11801(c)(7)(A)
   , struck out “(other than subsection (e))” after “this section”.
   Subsecs. (e), (f).
   Pub. L. 101–508, § 11801(a)(17)
   , (c)(7)(B), redesignated subsec. (f) as (e) and struck out former subsec. (e) relating to dividend reinvestment in
   stock
   of public utilities.
   1983—Subsec. (e)(3)(A).
   Pub. L. 97–448, § 103(f)(1)
   , substituted “placed in service qualified long-life public utility
   property
   having a cost equal to at least 60 percent of the aggregate cost of all tangible
   property
   described in subparagraph (A) or (B) of section 1245(a)(3) placed in service by the corporation during such period” for “acquired public utility recovery
   property
   having a cost equal to at least 60 percent of the aggregate cost of all tangible
   property
   described in section 1245(a)(3) (other than subparagraphs (C) and (D) thereof) acquired by the corporation during such period”.
   Subsec. (e)(3)(C)(ii).
   Pub. L. 97–448, § 103(f)(2)
   , substituted definition of “qualified long-life public utility
   property”
   for definition of “public utility recovery
   property”
   which had been defined as public utility
   property
   (within the meaning of section 167(l)(3)(A)) which was recovery
   property
   which was 10-year
   property
   or 15-year public utility
   property
   (within the meaning of section 168), except that any requirement that the
   property
   be placed in service after
   December 31, 1980
   , did not apply.
   1981—Subsec. (d)(1).
   Pub. L. 97–34, § 321(b)
   , inserted “(other than subsection (e))” after “this section”.
   Subsecs. (e), (f).
   Pub. L. 97–34, § 321(a)
   , added subsec. (e) and redesignated former subsec. (e) as (f).
   1976—Subsecs. (b)(5), (c).
   ...
   1969—Subsec. (a).
   Pub. L. 91–172
   substituted reference to this section for reference to subsec. (b), and omitted reference to rights to acquire its
   stock.
   Subsec. (b).
   Pub. L. 91–172
   omitted reference to rights to acquire its
   stock,
   in text preceding par. (1), redesignated former par. (2) as par. (1) and added pars. (2) to (5). Former par. (1), providing for the extent to which distribution of preference dividends were to be treated as distribution of
   property
   to which section 301 applied, was struck out.
   Subsecs. (c) to (e).
   Pub. L. 91–172
   added subsecs. (c) and (d) and redesignated former subsec. (c) as (e).
   Statutory Notes and Related Subsidiaries
   Effective Date of 2018 Amendment
   Pub. L. 115–141, div. U, title IV, § 401(c)(2)(E)
   ,
   Mar. 23, 2018
   ,
   132 Stat. 1206
   ...
   ] shall apply to bonds purchased on or after
   July 2, 1982
   .”
   Effective Date of 2004 Amendment
   Pub. L. 108–357, title VIII, § 831(c)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1587
   ...
   Apr. 30, 1993
   , see
   section 13206(c)(3) of Pub. L. 103–66
   set out as a note under
   section 167 of this title
   .
   Effective Date of 1990 Amendment
   Pub. L. 101–508, title XI, § 11322(b)
   ,
   Nov. 5, 1990
   ,
   104 Stat. 1388–464
   ...
   such
   stock
   is issued pursuant to a written binding contract in effect on
   October 9, 1990
   , and at all times thereafter before such issuance,
   “(B)
   such
   stock
   is issued pursuant to a registration or offering statement filed on or before
   October 9, 1990
   , with a Federal or State agency regulating the offering or sale of
   securities
   and such
   stock
   is issued before the date 90 days after the date of such filing, or
   “(C)
   such
   stock
   is issued pursuant to a plan filed on or before
   October 9, 1990
   , in a title 11 or similar case (as defined in section 368(a)(3)(A) of the
   ...
   , provided that:
   “(1)
   Except as otherwise provided in this subsection, the amendment made by subsection (a) [amending this section] shall apply with respect to distributions (or deemed distributions) made after
   January 10, 1969
   , in taxable years ending after such date.
   “(2)
   (A)
   ...
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] (as added by subsection (a)) shall not apply to a distribution (or deemed distribution) of
   stock
   made before
   January 1, 1991
   , with respect to
   ...
   (i) outstanding on
   January 10, 1969
   , (ii) issued pursuant to a contract binding on
   January 10, 1969
   , on the distributing corporation, (iii) which is additional
   stock
   of that class of
   stock
   which (as of
   January 10, 1969
   ) had the largest fair market value of all classes of
   stock
   of the corporation (taking into account only
   stock
   outstanding on
   January 10, 1969
   , or issued pursuant to a contract binding on
   January 10, 1969
   ), (iv) described in subparagraph (C)(iii), or (v) issued in a prior distribution described in clause (i), (ii), (iii), or (iv).
   “(B)
   Subparagraph (A) shall apply only if—
   “(i)
   the
   stock
   as to which there is a receipt of
   property
   was outstanding on
   January 10, 1969
   (or was issued pursuant to a contract binding on
   January 10, 1969
   ...
   and any
   stock
   described in subparagraph (A)(i) were also outstanding on
   January 10, 1968
   , a distribution of
   property
   ...
   “(C)
   Subparagraph (A) shall cease to apply when at any time after
   October 9, 1969
   , the distributing corporation issues any of its
   stock
   (other than in a distribution of
   stock
   with respect to
   stock
   ...
   of that class of
   stock
   which meets the requirements of subparagraph (A)(iii), or
   “(iii)
   preferred
   stock
   which is convertible into
   stock
   which meets the requirements of subparagraph (A)(iii) at a fixed conversion ratio which takes account of all
   stock
   dividends and
   stock
   splits with respect to the
   stock
   into which such convertible
   stock
   is convertible.
   ...
   .
   “(3)
   In cases to which Treasury Decision 6990 (promulgated
   January 10, 1969
   ) would not have applied, in applying paragraphs (1) and (2)
   April 22, 1969
   , shall be substituted for
   January 10, 1969
   .
   “(4)
   Section 305(b)(4) of the
   Internal Revenue Code of 1986
   (as added by subsection (a)) shall not apply to any distribution (or deemed distribution) with respect to preferred
   stock
   (including any increase in the conversion ratio of convertible
   stock)
   made before
   January 1, 1991
   , pursuant to the terms relating to the issuance of such
   stock
   which were in effect on
   January 10, 1969
   .
   “(5)
   With respect to distributions made or considered as made after
   January 10, 1969
   , in taxable years ending after such date, to the extent that the amendment made by subsection (a) [amending this section] does not apply by reason of paragraph (2), (3), or (4) of this subsection, section 305 of the
   Internal Revenue Code of 1986
   (as in effect before the amendment made by subsection (a)) shall continue to apply.”
   Savings Provision
