...
This project request had uuid: 7f8b4db7-1496-4540-bdb4-4472a04e2ead
-/
...
/-!
# IRC Section 474 - Simplified dollar-value LIFO method for certain small businesses

This file formalizes IRC §474 (Simplified dollar-value LIFO method for certain small businesses).

## References
- [26 USC §474](https://www.law.cornell.edu/uscode/text/26/474)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 474 - Simplified dollar-value LIFO method for certain small businesses
   U.S. Code
   Notes
   Authorities (CFR)
   prev
   ...
   (a)
   General rule
   An eligible small business may elect to use the simplified dollar-value method of pricing inventories for purposes of the
   LIFO method
   .
   (b)
   ...
   (A)
   the taxpayer maintains a separate inventory pool for items in each
   major category
   in the
   applicable Government price index
   , and
   (B)
   the adjustment for each such separate pool is based on the change from the preceding taxable year in the component of such index for the
   major category
   .
   (2)
   Applicable Government price index
   ...
   ” means—
   (A)
   except as provided in subparagraph (B), the Producer Price Index published by the
   Bureau of Labor Statistics
   , or
   (B)
   in the case of a retailer using the retail method, the Consumer Price Index published by the
   Bureau of Labor Statistics
   .
   (3)
   Major category
   ...
   For purposes of this section, a taxpayer is an eligible small business for any taxable year if the average annual gross receipts of the taxpayer for the 3 preceding taxable years do not exceed $5,000,000. For purposes of the preceding sentence, rules similar to the rules of
   section 448(c)(3)
   shall apply.
   (d)
   Special rules
   ...
   The term “
   LIFO method
   ” means the method provided by section 472(b).
   (4)
   Transitional rules
   (A)
   In general
   ...
   (I)
   in the case of the 1st taxable year to which such an election applies, be established in accordance with the major categories in the
   applicable Government price index
   , or
   (II)
   ...
   (Added
   Pub. L. 97–34, title II, § 237(a)
   ,
   Aug. 13, 1981
   ,
   95 Stat. 252
   ; amended
   Pub. L. 99–514, title VIII, § 802(a)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2348
   ...
   1986—
   Pub. L. 99–514
   amended section generally, substituting provisions relating to election by eligible small business to use simplified dollar-value method of pricing inventories for purposes of
   LIFO method
   for provisions relating to election by eligible small business which uses dollar-value method of pricing inventories under method provided by
   section 472(b) of this title
   to use one inventory pool for any trade or business of such eligible small business.
   Statutory Notes and Related Subsidiaries
   Effective Date of 1986 Amendment
   Pub. L. 99–514, title VIII, § 802(c)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2350
   ...
   .
   “(2)
   Treatment of taxpayers who made elections under existing section 474.—
   The amendments made by this section shall not apply to any taxpayer who made an election under section 474 of the
   Internal Revenue Code of 1954
   (as in effect on the day before the date of the enactment of this Act [
   Oct. 22, 1986
   ]) for any period during which such election is in effect. Notwithstanding any provision of such section 474 (as so in effect), an election under such section may be revoked without the consent of the Secretary.”
   Effective Date
   Pub. L. 97–34, title II, § 237(c)
   ,
   Aug. 13, 1981
   ,
   95 Stat. 253
