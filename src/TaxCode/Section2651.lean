...
This project request had uuid: 462fd029-ea2b-49bd-ac00-234bc93fd90a
-/
...
/-!
# IRC Section 2651 - Generation assignment

This file formalizes IRC §2651 (Generation assignment).

## References
- [26 USC §2651](https://www.law.cornell.edu/uscode/text/26/2651)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 2651 - Generation assignment
   U.S. Code
   Notes
   prev |
   next
   ...
   (B)
   such individual’s parent who is a lineal descendant of the parent of the transferor (or the transferor’s spouse or former spouse) is dead at the time the transfer (from which an interest of such individual is established or derived) is subject to a tax imposed by chapter
   11
   or
   12
   upon the transferor (and if there shall be more than 1 such time, then at the earliest such time),
   ...
   Except as provided in paragraph (3), if an estate,
   trust
   , partnership, corporation, or other entity has an interest in property, each individual having a beneficial interest in such entity shall be treated as having an interest in such property and shall be assigned to a generation under the foregoing provisions of this subsection.
   (3)
   ...
   charitable
   trust
   described in section 511(b)(2), and
   (C)
   governmental entity,
   ...
   100 Stat. 2725
   ; amended
   Pub. L. 100–647, title I, § 1014(g)(11)
   , (19),
   Nov. 10, 1988
   ,
   102 Stat. 3565
   , 3567;
   Pub. L. 105–34, title V, § 511(a)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 860
   ...
   1988—Subsec. (b)(2).
   Pub. L. 100–647, § 1014(g)(19)
   , inserted “(or former spouse)” after “a spouse”.
   Subsec. (e)(3).
   Pub. L. 100–647, § 1014(g)(11)
   , amended par. (3) generally, including governmental entities among the organizations to be assigned to transferor’s generation.
   Statutory Notes and Related Subsidiaries
   Effective Date of 1997 Amendment
   Amendment by
   Pub. L. 105–34
   applicable to terminations, distributions, and transfers occurring after
   Dec. 31, 1997
   , see
   section 511(c) of Pub. L. 105–34
