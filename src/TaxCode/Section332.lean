...
This project request had uuid: 3e66478a-b268-43bb-a928-f81af627245a
-/
...
This file formalizes IRC §332 (Complete liquidations of subsidiaries).

## References
- [26 USC §332](https://www.law.cornell.edu/uscode/text/26/332)
...
## Summary
   ...
   (b)
   Liquidations to which section applies
   ...
   (c)
   Deductible liquidating distributions of regulated investment companies and real estate investment trusts
   ...
   (1)
   In general
   In the case of any distribution to a foreign corporation in complete liquidation of an
   applicable holding company
   —
   (A)
   subsection (a) and
   section 331
   shall not apply to such distribution, and
   (B)
   such distribution shall be treated as a distribution of property to which
   section 301
   applies.
   (2)
   Applicable holding company
   ...
   (i)
   which is a common parent of an
   affiliated group
   ,
   (ii)
   stock of which is directly owned by the distributee foreign corporation,
   (iii)
   substantially all of the assets of which consist of stock in other members of such
   affiliated group
   , and
   (iv)
   ...
   section 1504(a)
   (without regard to paragraph (2) of section 1504(b)).
   (3)
   Coordination with subpart F
   If the distributee of a distribution described in paragraph (1) is a
   controlled foreign corporation
   (as defined in
   section 957
   ), then notwithstanding paragraph (1) or subsection (a), such distribution shall be treated as a distribution to which section 331 applies.
   (4)
   Regulations
   ...
   119 Stat. 2638
   ;
   Pub. L. 115–141, div. U, title IV, § 401(d)(1)(D)(xvii)(III)
   ,
   Mar. 23, 2018
   ,
   132 Stat. 1208
   ...
   2005—Subsec. (d)(1)(B).
   Pub. L. 109–135
   substituted “distribution of property to which section 301 applies” for “distribution to which section 301 applies”.
   2004—Subsec. (d).
   Pub. L. 108–357
   added subsec. (d).
   1998—Subsec. (b).
   ...
   , amended par. (1) generally. Prior to amendment, par. (1) read as follows: “the corporation receiving such property was, on the date of the adoption of the plan of liquidation, and has continued to be at all times until the receipt of the property, the owner of stock (in such other corporation) possessing at least 80 percent of the total combined voting power of all classes of stock entitled to vote and the owner of at least 80 percent of the total number of shares of all other classes of stock (except nonvoting stock which is limited and preferred as to dividends); and either”.
   Subsec. (c).
   Pub. L. 99–514, § 631(e)(2)
   , struck out subsec. (c) containing special rule for indebtedness of subsidiary to parent in relation to complete liquidations of subsidiaries.
   1976—Subsec. (b).
   Pub. L. 94–455
   ...
   “(i)
   In general.—
   Except as provided in clause (iii), the amendment made by subparagraph (A) [amending this section] shall apply with respect to plans of complete liquidation adopted after
   March 28, 1985
   .
   “(ii)
   Certain distributions made after december 31, 1984.—
   Except as provided in clause (iii), the amendment made by subparagraph (A) shall also apply with respect to plans of complete liquidations adopted on or before
   March 28, 1985
   , pursuant to which any distribution is made in a taxable year beginning after
   December 31, 1984
   (
   December 31, 1983
   , in the case of an
   affiliated group
   to which an election under section 60(b)(7) of the
   Tax Reform Act of 1984
   [
   Pub. L. 98–369
   , set out as a note under
   section 1504 of this title
   ] applies), but only if the liquidating corporation and any corporation which receives a distribution in complete liquidation of such corporation are members of an
   affiliated group
   of corporations filing a consolidated return for the taxable year which includes the date of the distribution.
   “(iii)
   Transitional rule for affiliated groups.—
   The amendment made by subparagraph (A) shall not apply with respect to plans of complete liquidation if the liquidating corporation is a member of an
   affiliated group
   of corporations under section 60(b) (2), (5), (6), or (8) of the
   Tax Reform Act of 1984
   [
   Pub. L. 98–369
   , set out as a note under
   section 1504 of this title
   ], for all taxable years which include the date of any distribution pursuant to such plan.”
   Savings Provision
