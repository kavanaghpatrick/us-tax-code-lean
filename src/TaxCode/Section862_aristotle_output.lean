...
This project request had uuid: 719d9699-d54c-44c0-9d43-f9485647ae2a
-/
...
This file formalizes IRC §862 (Income from sources without the United States).

## References
- [26 USC §862](https://www.law.cornell.edu/uscode/text/26/862)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 862 - Income from sources without the United States
   U.S. Code
   Notes
   prev
   |
   ...
   (6)
   gains, profits, and income derived from the purchase of inventory property (within the meaning of
   section 865(i)(1)
   ) within the United States and its sale or exchange without the United States;
   (7)
   ...
   section 897(c)
   ) when the real property is located in the Virgin Islands; and
   (9)
   ...
   1988—Subsec. (c).
   Pub. L. 100–647
   repealed subsec. (c) which read as follows:
   “(c)
   Cross reference
   .—For source of amounts attributable to certain aircraft and vessels, see section 861(e).”
   1986—Subsec. (a)(6).
   ...
   .
   Amendment by
   section 1901(b)(26)(C) of Pub. L. 94–455
   ...
   Aug. 15, 1971
   , but only with respect to leases entered into after such date, see
   section 314(c) of Pub. L. 92–178
   , set out as a note under
   section 861 of this title
   .
