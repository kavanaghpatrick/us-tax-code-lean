...
This project request had uuid: 504d3c2d-142f-48d5-9ba2-b5d99036fa84
-/
...
This file formalizes IRC §472 (Last-in, first-out inventories).

## References
- [26 USC §472](https://www.law.cornell.edu/uscode/text/26/472)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 472 - Last-in, first-out inventories
   U.S. Code
   Notes
   Authorities (CFR)
   prev
   ...
   (a)
   Authorization
   A taxpayer may use the method provided in subsection (b) (whether or not such method has been prescribed under
   section 471
   ...
   (1)
   In general
   Except as otherwise provided in regulations, all members of the same
   group of financially related corporations
   shall be treated as 1 taxpayer for purposes of subsections (c) and (e)(2).
   (2)
   Group of financially related corporations
   ...
   section 1504
   determined by substituting “50 percent” for “80 percent” each place it appears in section 1504(a) and without regard to section 1504(b), and
   (B)
   ...
   Subsec. (f).
   Pub. L. 94–455, § 1901(b)(36)(A)
   , struck out subsec. (f) which provided for a cross reference relating to involuntary liquidation and replacement of LIFO inventories.
   ...
   Amendment by
   section 1901(b)(36)(A) of Pub. L. 94–455
