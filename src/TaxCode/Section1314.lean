...
This project request had uuid: 4b059eda-3f80-4bff-a325-42b4cc28b72e
-/
...
/-!
# IRC Section 1314 - Amount and method of adjustment

This file formalizes IRC §1314 (Amount and method of adjustment).

## References
- [26 USC §1314](https://www.law.cornell.edu/uscode/text/26/1314)
...
## Summary
   ...
   taxpayer
   on his return (determined as provided in section 6211(b)(1), (3), and (4), relating to the definition of deficiency), if a return was made by the
   taxpayer
   and an amount was shown as the tax by the
   taxpayer
   thereon, plus
   (B)
   ...
   The adjustment authorized in section 1311(a) shall be made by assessing and collecting, or refunding or crediting, the amount thereof in the same manner as if it were a deficiency determined by the Secretary with respect to the
   taxpayer
   as to whom the error was made or an overpayment claimed by such
   taxpayer
   , as the case may be, for the taxable year or years with respect to which an amount is ascertained under subsection (a), and as if on the date of the
   determination
   one year remained before the expiration of the periods of limitation upon assessment or filing claim for refund for such taxable year or years. If, as a result of a
   determination
   described in section 1313(a)(4), an adjustment has been made by the assessment and collection of a deficiency or the refund or credit of an overpayment, and subsequently such
   determination
   is altered or revoked, the amount of the adjustment ascertained under subsection (a) of this section shall be redetermined on the basis of such alteration or revocation and any overpayment or deficiency resulting from such redetermination shall be refunded or credited, or assessed and collected, as the case may be, as an adjustment under this part. In the case of an adjustment resulting from an increase or decrease in a net operating loss or net capital loss which is carried back to the year of adjustment, interest shall not be collected or paid for any period prior to the close of the taxable year in which the net operating loss or net capital loss arises.
   (c)
   ...
   68A Stat. 340
   ;
   Pub. L. 85–866, title I, § 59(b)
   ,
   Sept. 2, 1958
   ,
   72 Stat. 1647
   ;
   Pub. L. 89–44, title VIII, § 809(d)(5)(B)
   ,
   June 21, 1965
   ,
   79 Stat. 168
   ;
   Pub. L. 91–172, title V, § 512(f)(7)
   , (8),
   Dec. 30, 1969
   ,
   83 Stat. 641
   ...
   90 Stat. 1834
   ;
   Pub. L. 113–295, div. A, title II, § 221(a)(87)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4050
   ...
   2014—Subsecs. (d), (e).
   Pub. L. 113–295
   redesignated subsec. (e) as (d) and struck out former subsec. (d). Prior to amendment, text of subsec. (d) read as follows: “No adjustment shall be made under this part in respect of any taxable year beginning prior to
   January 1, 1932
   .”
   1976—Subsec. (b).
   Pub. L. 94–455
   ...
   1969—Subsec. (a).
   Pub. L. 91–172, § 512(f)(7)
   , substituted “capital loss carryback or carryover” for “capital loss carryover”.
   Subsec. (b).
   Pub. L. 91–172, § 512(f)(8)
   , inserted reference to net capital loss.
   1965—Subsec. (a)(1)(A).
   Pub. L. 89–44
   struck out “(b)(1) and (3)” and inserted in lieu thereof “(b)(1), (3), and (4)”.
   1958—Subsec. (c).
   Pub. L. 85–866
   substituted in second sentence “The” for “Other than in the case of an adjustment resulting from a
   determination
   under section 1313(a)(4), the”.
