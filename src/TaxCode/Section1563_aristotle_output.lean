...
This project request had uuid: f1ad9a27-aacd-4d20-a5de-ffe2f0e43111
-/
...
/-!
# IRC Section 1563 - Definitions and special rules

This file formalizes IRC §1563 (Definitions and special rules).

## References
- [26 USC §1563](https://www.law.cornell.edu/uscode/text/26/1563)
...
## Summary
   ...
   if—
   (A)
   stock possessing at least 80 percent of the total combined voting power of all classes of stock entitled to vote or at least 80 percent of the total value of shares of all classes of stock of each of the corporations, except the common
   parent corporation
   , is owned (within the meaning of subsection (d)(1)) by one or more of the other corporations; and
   (B)
   the common
   parent corporation
   owns (within the meaning of subsection (d)(1)) stock possessing at least 80 percent of the total combined voting power of all classes of stock entitled to vote or at least 80 percent of the total value of shares of all classes of stock of at least one of the other corporations, excluding, in computing such voting power or value, stock owned directly by such other corporations.
   (2)
   ...
   is a common
   parent corporation
   included in a group of corporations described in paragraph (1), and also
   (B)
   is included in a group of corporations described in paragraph (2).
   (4)
   Certain insurance companies
   Two or more insurance companies subject to taxation under section 801 which are members of a
   controlled group of corporations
   described in paragraph (1), (2), or (3). Such insurance companies shall be treated as a
   controlled group of corporations
   separate from any other corporations which are members of the
   controlled group of corporations
   ...
   (1)
   General rule
   For purposes of this part, a corporation is a component member of a
   controlled group of corporations
   on a December 31 of any taxable year (and with respect to the taxable year which includes such December 31) if such corporation—
   (A)
   is a member of such
   controlled group of corporations
   on the December 31 included in such year and is not treated as an excluded member under paragraph (2), or
   (B)
   is not a member of such
   controlled group of corporations
   on the December 31 included in such year but is treated as an additional member under paragraph (3).
   (2)
   Excluded members
   A corporation which is a member of a
   controlled group of corporations
   on December 31 of any taxable year shall be treated as an excluded member of such group for the taxable year including such December 31 if such corporation—
   (A)
   is a member of such group for less than one-half the number of days in such taxable year which precede such December 31,
   (B)
   is exempt from taxation under
   section 501(a)
   (except a corporation which is subject to tax on its unrelated business taxable income under section 511) for such taxable year,
   (C)
   is a foreign corporation subject to tax under
   section 881
   for such taxable year,
   (D)
   is an insurance company subject to taxation under
   section 801
   (other than an insurance company which is a member of a controlled group described in subsection (a)(4)), or
   (E)
   is a franchised corporation, as defined in subsection (f)(4).
   (3)
   Additional members
   A corporation which—
   (A)
   ...
   (B)
   is not a member of such group on December 31 of such calendar year, and
   (C)
   is not described, with respect to such group, in subparagraph (B), (C), (D), or (E) of paragraph (2),
   ...
   controlled group of corporations
   with respect to any taxable year, such corporation shall be treated as a component member of only one controlled group. The determination as to the group of which such corporation is a component member shall be made under regulations prescribed by the Secretary which are consistent with the purposes of this part.
   (c)
   ...
   treasury stock, and
   (C)
   stock which is treated as “excluded stock” under paragraph (2).
   (2)
   Stock treated as “excluded stock”
   (A)
   Parent-subsidiary controlled group
   For purposes of subsection (a)(1), if a corporation (referred to in this paragraph as “
   parent corporation
   ”) owns (within the meaning of subsections (d)(1) and (e)(4)), 50 percent or more of the total combined voting power of all classes of stock entitled to vote or 50 percent or more of the total value of shares of all classes of stock in another corporation (referred to in this paragraph as “subsidiary corporation”), the following stock of the subsidiary corporation shall be treated as excluded stock—
   (i)
   stock in the subsidiary corporation held by a trust which is part of a plan of deferred compensation for the benefit of the
   employees
   of the
   parent corporation
   or the subsidiary corporation,
   (ii)
   stock in the subsidiary corporation owned by an individual (within the meaning of subsection (d)(2)) who is a
   principal stockholder
   or officer of the
   parent corporation.
   For purposes of this clause, the term “
   principal stockholder
   ” of a corporation means an individual who owns (within the meaning of subsection (d)(2)) 5 percent or more of the total combined voting power of all classes of stock entitled to vote or 5 percent or more of the total value of shares of all classes of stock in such corporation,
   (iii)
   stock in the subsidiary corporation owned (within the meaning of subsection (d)(2)) by an
   employee
   of the subsidiary corporation if such stock is subject to conditions which run in favor of such parent (or subsidiary) corporation and which substantially restrict or limit the
   employee
   ’s right (or if the
   employee
   constructively owns such stock, the direct owner’s right) to dispose of such stock, or
   (iv)
   stock in the subsidiary corporation owned (within the meaning of subsection (d)(2)) by an organization (other than the
   parent corporation
   ) to which section 501 (relating to certain educational and charitable organizations which are exempt from tax) applies and which is controlled directly or indirectly by the
   parent corporation
   or subsidiary corporation, by an individual, estate, or trust that is a
   principal stockholder
   (within the meaning of clause (ii)) of the
   parent corporation,
   ...
   (B)
   Brother-sister controlled group
   For purposes of subsection (a)(2), if 5 or fewer persons who are individuals, estates, or trusts (referred to in this subparagraph as “
   common owners
   ”) own (within the meaning of subsection (d)(2)), 50 percent or more of the total combined voting power of all classes of stock entitled to vote or 50 percent or more of the total value of shares of all classes of stock in a corporation, the following stock of such corporation shall be treated as excluded stock—
   (i)
   stock in such corporation held by an
   employees
   ’ trust described in section 401(a) which is exempt from tax under section 501(a), if such trust is for the benefit of the
   employees
   of such corporation,
   (ii)
   stock in such corporation owned (within the meaning of subsection (d)(2)) by an
   employee
   of the corporation if such stock is subject to conditions which run in favor of any of such
   common owners
   (or such corporation) and which substantially restrict or limit the
   employee’
   s right (or if the
   employee
   constructively owns such stock, the direct owner’s right) to dispose of such stock. If a condition which limits or restricts the
   employee’
   s right (or the direct owner’s right) to dispose of such stock also applies to the stock held by any of the
   common owners
   pursuant to a bona fide reciprocal stock purchase arrangement, such condition shall not be treated as one which restricts or limits the
   employee’
   s right to dispose of such stock, or
   (iii)
   stock in such corporation owned (within the meaning of subsection (d)(2)) by an organization to which section 501 (relating to certain educational and charitable organizations which are exempt from tax) applies and which is controlled directly or indirectly by such corporation, by an individual, estate, or trust that is a
   principal stockholder
   (within the meaning of subparagraph (A)(ii)) of such corporation, by an officer of such corporation, or by any combination thereof.
   (d)
   Rules for determining stock ownership
   (1)
   Parent-subsidiary controlled group
   For purposes of determining whether a corporation is a member of a parent-subsidiary
   controlled group of corporations
   ...
   (2)
   Brother-sister controlled group
   For purposes of determining whether a corporation is a member of a brother-sister
   controlled group of corporations
   (within the meaning of subsection (a)(2)), stock owned by a person who is an individual, estate, or trust means—
   (A)
   ...
   (C)
   This paragraph shall not apply to stock owned by any
   employees
   ’ trust described in
   section 401(a)
   ...
   (B)
   The individual is not a director or
   employee
   and does not participate in the management of such corporation at any time during such taxable year;
   (C)
   ...
   employee
   ” has the same meaning such term is given by paragraphs (1) and (2) of section 3121(d).
   (2)
   Operating rules
   (A)
   In general
   ...
   (C)
   If stock is owned by a person within the meaning of subsection (d) and such ownership results in the corporation being a component member of a controlled group, such stock shall not be treated as excluded stock under subsection (c)(2), if by reason of treating such stock as excluded stock the result is that such corporation is not a component member of a
   controlled group of corporations
   .
   (4)
   ...
   a
   parent corporation
   (as defined in subsection (c)(2)(A)), or a common owner (as defined in subsection (c)(2)(B)), of a corporation which is a member of a
   controlled group of corporations
   is under a duty (arising out of a written agreement) to sell stock of such corporation (referred to in this paragraph as “franchised corporation”) which is franchised to sell the products of another member, or the common owner, of such controlled group;
   (B)
   such stock is to be sold to an
   employee
   (or
   employees
   ) of such franchised corporation pursuant to a bona fide plan designed to eliminate the stock ownership of the
   parent corporation
   or of the common owner in the franchised corporation;
   (C)
   such plan—
   (i)
   ...
   employee
   ’s share of the profits of such corporation (whether received as compensation or as a dividend) be applied to the purchase of such stock (or the purchase of notes, bonds, debentures or other similar evidence of indebtedness of such franchised corporation held by such
   parent corporation
   or common owner);
   (D)
   such
   ...
   (or
   employees
   ) owns directly more than 20 percent of the total value of shares of all classes of stock in such franchised corporation;
   (E)
   ...
   For purposes of this paragraph, an applicable provision is any provision of law (other than this part) which incorporates the definition of
   controlled group of corporations
   under subsection (a).
   (Added
   ...
   78 Stat. 120
   ; amended
   Pub. L. 91–172, title IV, § 401(c)
   , (d),
   Dec. 30, 1969
   ,
   83 Stat. 602
   ;
   Pub. L. 91–373, title I, § 102(b)
   ,
   Aug. 10, 1970
   ,
   84 Stat. 696
   ...
   90 Stat. 1834
   ;
   Pub. L. 98–369, div. A, title II, § 211(b)(22)
   ,
   July 18, 1984
   ,
   98 Stat. 757
   ;
   Pub. L. 99–514, title X, § 1024(c)(17)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2408
   ;
   Pub. L. 100–647, title I, § 1018(s)(3)(A)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3587
   ;
   Pub. L. 108–357, title VIII, § 900(a)
   , (b),
   Oct. 22, 2004
   ,
   118 Stat. 1650
   ...
   1970—Subsec. (f)(1).
   Pub. L. 91–373
   substituted “by paragraphs (1) and (2) of section 2131(d)” for “in section 3306(i)”.
   1969—Subsec. (a)(2).
   Pub. L. 91–172, § 401(c)
   , redesignated existing provisions with minor changes as par. (A) and added par. (B).
   Subsec. (c)(2)(A)(iv).
   Pub. L. 91–172, § 401(d)(1)
   , added cl. (iv).
   Subsec. (c)(2)(B).
   Pub. L. 91–172, § 401(d)(2)
   , substituted “5 or fewer persons who are individuals, estates, or trusts (referred to in this subparagraph as
   ‘common owners’
   ) own” for “a person who is an individual, estate, or trust (referred to in this paragraph as ‘common owner’) owns” and in cl. (ii), substituted “any of such
   common owners”
   , “any of the
   common owners”
   for “such common owner” and “the common owner”, respectively and added cl. (iii).
   Statutory Notes and Related Subsidiaries
   Effective Date of 2004 Amendment
   Pub. L. 108–357, title VIII, § 900(c)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1650
   ...
   Pub. L. 100–647, title I, § 1018(s)(3)(B)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3587
   , provided that:
   “The amendment made by subparagraph (A) [amending this section] shall apply to taxable years beginning after the date of the enactment of this Act [
   Nov. 10, 1988
   ].”
   ...
   Dec. 31, 1963
   , see
   section 235(d) of Pub. L. 88–272
   , set out as an Effective Date of 1964 Amendment note under
