...
## Summary
   ...
   The term “
   acquisition cost
   ” means the cost of acquiring the residence as a completed residential unit.
   (B)
   Exceptions
   The term “
   acquisition cost
   ...
   , for purposes of subsection (e), the term
   “acquisition cost”
   includes the cost of the rehabilitation.
   (4)
   Qualified home improvement loan
   The term “
   qualified home improvement loan
   ” means the financing (in an amount which does not exceed $15,000)—
   (A)
   ...
   The term “
   qualified rehabilitation loan
   ” means any owner-financing provided in connection with—
   (i)
   a
   qualified rehabilitation
   , or
   (ii)
   the acquisition of a residence with respect to which there has been a
   qualified rehabilitation
   ,
   ...
   qualified rehabilitation
   ” means any rehabilitation of a building if—
   (i)
   ...
   (B)
   which were first occupied at least 5 years before the
   mortgage
   is executed.
   Subparagraph (B) shall not apply to any 2-family residence if the residence is a
   targeted area residence
   and the family income of the mortgagor meets the requirement of subsection (f)(3)(B).
   (8)
   ...
   cooperative housing corporation
   with respect to cooperative housing not located in a targeted area, to the extent provided in regulations, such issue may be combined with 1 or more other issues for purposes of determining whether the requirements of subsection (h) are met.
   (C)
   Cooperative housing corporation
   The term “
   cooperative housing corporation
   ” has the meaning given to such term by section 216(b)(1).
   (9)
   ...
   shall be treated as residential rental property and not as owner-occupied housing, and
   (ii)
   bonds
   issued to provide such housing shall be subject to the same requirements and limitations as
   bonds
   the proceeds of which are to be used to provide qualified residential rental projects (as defined in
   section 142(d)
   ).
   (B)
   ...
   bond
   issued after the date specified in subsection (a)(1)(B).
   (C)
   Limited equity cooperative housing
   For purposes of this paragraph, the term “
   limited equity cooperative housing
   ” means any dwelling unit which a person is entitled to occupy by reason of his ownership of stock in a qualified
   cooperative housing corporation
   .
   (D)
   ...
   section 216
   shall not apply with respect to such corporation (or any successor thereof) during the qualified project period (as defined in section 142(d)(2)).
   (F)
   ...
   unless the
   cooperative housing corporation
   continues to be a qualified
   cooperative housing corporation
   at all times during the qualified project period (as defined in
   section 142(d)(2)
   ).
   (G)
   ...
   (A)
   In general
   In the case of a residence which is located in a
   high housing cost area
   (as defined in section 143(f)(5)), the interest of a governmental unit in such residence by reason of financing provided under any
   qualified program
   shall not be taken into account under this section (other than subsection (m)), and the
   acquisition cost
   of the residence which is taken into account under subsection (e) shall be such cost reduced by the amount of such financing.
   (B)
   Qualified program
   For purposes of subparagraph (A), the term “
   qualified program
   ” means any governmental program providing
   mortgage
   loans (other than 1st
   mortgage
   loans) or grants—
   (i)
   ...
   but only if such financing is not provided directly or indirectly through the use of any
   tax-exempt
   private activity bond
   .
   (11)
   Special rules for residences located in disaster areas
   In the case of a residence located in an area determined by the President to warrant assistance from the Federal Government under the
   Robert T. Stafford Disaster Relief and Emergency Assistance Act
   (as in effect on the date of the enactment of the
   Taxpayer Relief Act of 1997
   ), this section shall be applied with the following modifications to financing provided with respect to such residence within 2 years after the date of the disaster declaration:
   (A)
   Subsection (d) (relating to 3-year requirement) shall not apply.
   (B)
   Subsections (e) and (f) (relating to purchase price requirement and income requirement) shall be applied as if such residence were a
   targeted area residence
   .
   ...
   (A)
   In general
   Notwithstanding the requirements of subsection (i)(1), the proceeds of a
   qualified mortgage issue
   may be used to refinance a
   mortgage
   ...
   (iii)
   subsection (e) (relating to purchase price requirement) shall be applied by using the market value of the residence at the time of refinancing in lieu of the
   acquisition cost
   .
   (C)
   Qualified subprime loan
   The term “
   qualified subprime loan
   ” means an adjustable rate single-family residential
   mortgage
   loan made after
   December 31, 2001
   , and before
   ...
   , that the
   bond
   issuer determines would be reasonably likely to cause financial hardship to the borrower if not refinanced.
   (D)
   Termination
   ...
   (i)
   rendered unsafe for use as a residence by reason of a
   federally declared disaster
   occurring before
   January 1, 2010
   , or
   (ii)
   demolished or relocated by reason of an order of the government of a State or political subdivision thereof on account of a
   federally declared disaster
   ...
   (i)
   In general
   At the election of the taxpayer, if the principal residence (within the meaning of section 121) of such taxpayer was damaged as the result of a
   federally declared disaster
   occurring before
   January 1, 2010
   , any owner-financing provided in connection with the repair or reconstruction of such residence shall be treated as a
   qualified rehabilitation loan.
   (ii)
   Limitation
   ...
   For purposes of this paragraph, the term “
   federally declared disaster
   ” has the meaning given such term by section 165(h)(3)(C)(i).
   [1]
   (D)
   ...
   An issue meets the requirements of this paragraph only if each mortgagor to whom financing is provided under the issue is a
   qualified veteran
   .
   (2)
   Requirement that State program be in effect before
   June 22, 1984
   An issue meets the requirements of this paragraph only if it is a general obligation of a State which issued
   qualified veterans
   ’
   mortgage
   bonds before
   ...
   bonds
   issued pursuant thereto (when added to the aggregate amount of
   qualified veterans
   ’
   mortgage
   bonds previously issued by the State during the calendar year) does not exceed the State veterans limit for such calendar year.
   (B)
   ...
   qualified veterans
   bonds
   issued by such State during the period beginning on
   January 1, 1979
   , and ending on
   June 22, 1984
   (not including the amount of any
   qualified veterans
   bond issued by such State during the calendar year (or portion thereof) in such period for which the amount of such
   bonds
   so issued was the lowest), divided by
   (II)
   the number (not to exceed 5) of calendar years after 1979 and before 1985 during which the State issued
   qualified veterans
   bonds
   ...
   (iii)
   Phasein
   In the case of calendar years beginning before 2010, clause (ii) shall be applied by substituting for each of the dollar amounts therein an amount equal to the
   applicable percentage
   of such dollar amount. For purposes of the preceding sentence, the
   applicable percentage
   ...
   ’
   mortgage
   bond” shall not include any
   bond
   issued to refund another
   bond
   but only if the maturity date of the refunding
   bond
   is not later than the later of—
   (I)
   the maturity date of the
   bond
   to be refunded, or
   (II)
   the date 32 years after the date on which the refunded
   bond
   was issued (or in the case of a series of refundings, the date on which the original
   bond
   was issued).
   The preceding sentence shall apply only to the extent that the amount of the refunding
   bond
   ...
   bond
   issued to advance refund another
   bond
   .
   (4)
   Qualified veteran
   ...
   the amount taken into account under this subsection with respect to such
   bond
   shall be
   1
   ⁄
   ...
   (1)
   In general
   If, during the taxable year, any taxpayer disposes of an interest in a residence with respect to which there is or was any
   federally-subsidized indebtedness
   for the payment of which the taxpayer was liable in whole or part, then the taxpayer’s tax imposed by this chapter for such taxable year shall be increased by the lesser of—
   (A)
   the recapture amount with respect to such indebtedness, or
   (B)
   50 percent of the gain (if any) on the
   disposition
   of such interest.
   (2)
   Exceptions
   ...
   any
   disposition
   which is more than 9 years after the
   testing date
   .
   (3)
   Federally-subsidized indebtedness
   ...
   The term “
   federally-subsidized indebtedness
   ” means any indebtedness if—
   (i)
   financing for the indebtedness was provided in whole or part from the proceeds of any
   tax-exempt
   qualified
   mortgage
   bond,
   ...
   mortgages
   ) to the taxpayer for interest paid or incurred on such indebtedness.
   (B)
   ...
   If the
   disposition
   occurs during a year after the
   testing date
   which is:
   The
   holding period percentage
   ...
   If the
   federally-subsidized indebtedness
   is completely repaid during any year of the 4-year period beginning on the
   testing date,
   the
   holding period percentage
   for succeeding years shall be determined by reducing ratably to zero over the succeeding 5 years the
   holding period percentage
   which would have been determined under this subparagraph had the taxpayer disposed of his interest in the residence on the date of the repayment.
   (D)
   Testing date
   The term “
   testing date
   ” means the earliest date on which all of the following requirements are met:
   (i)
   The indebtedness is
   federally-subsidized indebtedness
   .
   ...
   The term “
   income percentage
   ” means the percentage (but not greater than 100 percent) which—
   (i)
   the excess of—
   (I)
   the
   ...
   (ii)
   1.05 to the nth power where “n” equals the number of full years during the period beginning on the date the financing was provided and ending on the date of the
   disposition
   .
   For purposes of clause (i), highest family income shall be determined without regard to subsection (f)(3)(A) and on the basis of the number of members of the taxpayer’s family as of the date of the
   disposition
   .
   (B)
   Modified adjusted gross income
   ...
   (ii)
   decreased by the amount of gain (if any) included in gross income of the taxpayer by reason of the
   disposition
   ...
   (A)
   In general
   For purposes of paragraph (1), gain shall be taken into account whether or not recognized, and the adjusted basis of the taxpayer’s interest in the residence shall be determined without regard to sections 1033(b) and 1034(e) (as in effect on the day before the date of the enactment of the
   Taxpayer Relief Act of 1997
   ...
   In the case of a
   disposition
   other than a sale, exchange, or involuntary conversion, gain shall be determined as if the interest had been sold for its fair market value.
   (C)
   ...
   The issuer of the issue which provided the
   federally-subsidized indebtedness
   to the mortgagor shall—
   (A)
   ...
   the
   adjusted qualifying income
   (as defined in paragraph (5)) for each category of family size for each year of the 9-year period beginning on the date the financing was provided.
   (8)
   Special rules
   (A)
   No basis adjustment
   ...
   Except as provided in subparagraph (C) and in regulations prescribed by the Secretary, if 2 or more persons hold interests in any residence and are jointly liable for the
   federally-subsidized indebtedness
   , the recapture amount shall be determined separately with respect to their respective interests in the residence.
   (C)
   Transfers to spouses and former spouses
   Paragraph (1) shall not apply to any transfer on which no gain or loss is recognized under
   section 1041.
   In any such case, the transferee shall be treated under this subsection in the same manner as the transferor would have been treated had such transfer not occurred.
   (D)
   Regulations
   The Secretary shall prescribe such regulations as may be necessary or appropriate to carry out this subsection, including regulations dealing with
   dispositions
   of partial interests in a residence.
   (Added
   ...
   100 Stat. 2610
   ; amended
   Pub. L. 100–647, title I, § 1013(a)(2)
   , (3), title IV, § 4005(a)(1), (b)–(d)(1), (e)–(g)(2), (6),
   Nov. 10, 1988
   ,
   102 Stat. 3537
   , 3645–3651;
   Pub. L. 101–239, title VII, § 7104(a)
   ,
   Dec. 19, 1989
   ,
   103 Stat. 2305
   ;
   Pub. L. 101–508, title XI, § 11408(a)
   , (c),
   Nov. 5, 1990
   ,
   104 Stat. 1388–477
   ;
   Pub. L. 102–227, title I, § 108(a)
   ,
   Dec. 11, 1991
   ,
   105 Stat. 1688
   ;
   Pub. L. 103–66, title XIII, § 13141(a)
   , (c)–(e),
   Aug. 10, 1993
   ,
   107 Stat. 436
   ...
   111 Stat. 839
   , 840, 878;
   Pub. L. 109–222, title II, § 203(a)(1)
   , (b)(1),
   May 17, 2006
   ,
   120 Stat. 348
   , 349;
   Pub. L. 109–432, div. A, title IV
   , §§ 411(a), 416(a),
   Dec. 20, 2006
   ,
   120 Stat. 2963
   , 2965;
   Pub. L. 110–245, title I, § 103(a)
   –(c),
   June 17, 2008
   ,
   122 Stat. 1625
   ...
   122 Stat. 2893
   , 2897;
   Pub. L. 110–343, div. C, title VII, § 709(a)
   ,
   Oct. 3, 2008
   ,
   122 Stat. 3925
   ;
   Pub. L. 113–295, div. A, title II, § 211(c)(2)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4033
   ...
   Editorial Notes
   References in Text
   The date of the enactment of this subparagraph, referred to in subsec. (d)(2)(D), is the date of enactment of
   Pub. L. 109–432
   , which was approved
   Dec. 20, 2006
   .
   Section 8 of the
   United States Housing Act of 1937
   , referred to in subsec. (f)(2), is classified to
   section 1437f of Title 42
   , The Public Health and Welfare.
   The
   Robert T. Stafford Disaster Relief and Emergency Assistance Act
   , referred to in subsec. (k)(11), is
   Pub. L. 93–288
   ,
   May 22, 1974
   ,
   ...
   , which was approved
   Aug. 5, 1997
   . The Act is classified principally to
   chapter 68
   (§ 5121 et seq.) of Title 42, The Public Health and Welfare. For complete classification of this Act to the Code, see Short Title note set out under
   section 5121 of Title 42
   and Tables.
   Par. (3) of section 165(h), referred to in subsec. (k)(13)(C), was repealed by
   Pub. L. 113–295, div. A, title II, § 221(a)(27)(A)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4040
   ...
   Oct. 22, 1986
   .
   Section 1034(e) (as in effect on the day before the date of the enactment of the
   Taxpayer Relief Act of 1997
   ), referred to in subsec. (m)(6)(A), means
   section 1034(e) of this title
   ...
   Dec. 30, 1969
   ,
   Pub. L. 91–172, title VIII, § 802(b)
   ,
   83 Stat. 677
   ;
   Oct. 4, 1976
   ,
   Pub. L. 94–455, title XIX, § 1901(a)(22)
   ,
   90 Stat. 1767
   ;
   May 23, 1977
   ,
   Pub. L. 95–30, title I, § 101(d)(4)
   ,
   91 Stat. 133
   ;
   July 18, 1984
   ,
   Pub. L. 98–369, div. A, title IV, § 423(c)(1)
   ,
   98 Stat. 800
   , related to determination of marital status, prior to the general revision of this part by
   Pub. L. 99–514
   . See
   ...
   2014—Subsec. (k)(12), (13).
   Pub. L. 113–295
   redesignated par. (12), relating to special rules for residences destroyed in
   ...
   January 1, 2008
   ” after “enactment of this subparagraph”.
   Subsec. (k)(11).
   Pub. L. 110–289, § 3026(a)
   , substituted “
   May 1, 2008
   ” for “
   December 31, 1996
   ...
   Subsec. (k)(12).
   Pub. L. 110–343
   added par. (12) relating to special rules for residences destroyed in
   federally declared disasters.
   Pub. L. 110–289, § 3021(b)(1)
   , added par. (12) relating to special rules for subprime refinancings.
   Subsec. (l)(3)(B)(ii).
   Pub. L. 110–245, § 103(b)
   , substituted “$100,000,000” for “$25,000,000” wherever appearing.
   Subsec. (l)(4).
   Pub. L. 110–245, § 103(c)
   , reenacted heading without change and amended text generally. Prior to amendment, par. (4) defined
   “qualified veteran”
   differently with respect to different States.
   2006—Subsec. (d)(2)(D).
   Pub. L. 109–432, § 416(a)
   , added subpar. (D).
   Subsec. (l)(3)(B).
   Pub. L. 109–222, § 203(b)(1)
   , reenacted heading without change, substituted introductory provisions of cl. (i) for “A State veterans limit for any calendar year is the amount equal to—” and inserted heading, redesignated former cls. (i) and (ii) as subcls. (I) and (II), respectively, of cl. (i) and adjusted margins, and added cls. (ii) to (iv).
   Subsec. (l)(3)(B)(iv).
   Pub. L. 109–432, § 411(a)
   , struck out heading and text of cl. (iv). Text read as follows: “The State veterans limit for the States specified in clause (ii) for any calendar year after 2010 is zero.”
   Subsec. (l)(4).
   Pub. L. 109–222, § 203(a)(1)
   , amended par. (4) generally. Prior to amendment, par. (4) defined the term
   “qualified veteran”
   .
   1997—Subsec. (i)(1)(C)(i)(I).
   ...
   , added par. (11).
   Subsec. (m)(6)(A).
   Pub. L. 105–34, § 312(d)(3)
   , inserted “(as in effect on the day before the date of the enactment of the
   Taxpayer Relief Act of 1997
   )” after “1034(e)”.
   1996—Subsec. (d)(2)(C).
   Pub. L. 104–188, § 1703(n)(3)
   , substituted “thereon,” for “thereon.”
   Subsec. (m)(4)(C)(ii).
   Pub. L. 104–188, § 1702(d)(2)
   , substituted “any year of the 4-year period” for “any month of the 10-year period”, “succeeding years” for “succeeding months”, and “to zero over the succeeding 5 years” for “over the remainder of such period (or, if lesser, over 5 years)”.
   1993—Subsec. (a)(1).
   Pub. L. 103–66, § 13141(a)
   , amended heading and text of par. (1) generally. Prior to amendment, text read as follows:
   “(A)
   In general
   .—For purposes of this title, the term ‘qualified
   mortgage
   ...
   bond.”
   Subsec. (d)(2)(C).
   Pub. L. 103–66, § 13141(d)(1)
   , added subpar. (C).
   Subsec. (i)(1)(C).
   Pub. L. 103–66, § 13141(d)(2)
   , added subpar. (C).
   Subsec. (k)(3)(B)(iii).
   Pub. L. 103–66, § 13141(d)(3)
   , inserted “(other than land described in subsection (i)(1)(C)(i))” after “cost of land”.
   Subsec. (k)(7).
   Pub. L. 103–66, § 13141(e)
   , inserted at end “Subparagraph (B) shall not apply to any 2-family residence if the residence is a
   targeted area residence
   and the family income of the mortgagor meets the requirement of subsection (f)(3)(B).”
   Subsec. (k)(10).
   Pub. L. 103–66, § 13141(c)
   , added par. (10).
   1991—Subsec. (a)(1)(B).
   Pub. L. 102–227
   substituted “
   ...
   ” in heading and text.
   Subsec. (m)(1).
   Pub. L. 101–508, § 11408(c)(3)(A)
   , substituted “increased by the lesser of—” and subpars. (A) and (B) for “increased by the recapture amount with respect to such indebtedness.”
   Subsec. (m)(2)(B).
   Pub. L. 101–508, § 11408(c)(1)(C)
   , substituted “9 years” for “10 years”.
   Subsec. (m)(4)(A)(iii).
   Pub. L. 101–508, § 11408(c)(2)(A)
   , added cl. (iii).
   Subsec. (m)(4)(C)(i).
   Pub. L. 101–508, § 11408(c)(1)(A)
   , substituted heading for one which read:
   “Dispositions
   during 1st 5 years” and amended text generally. Prior to amendment, text read as follows: “If the
   disposition
   of the taxpayer’s interest in the residence occurs during the 5-year period beginning on the
   testing date,
   the
   holding period percentage
   is the percentage determined by dividing the number of full months during which the requirements of subparagraph (D) were met by 60.”
   Subsec. (m)(4)(C)(ii), (iii).
   Pub. L. 101–508, § 11408(c)(1)(B)
   , redesignated cl. (iii) as (ii) and struck out former cl. (ii)
   “Dispositions
   during 2d 5 years” which read as follows: “If the
   disposition
   of the taxpayer’s interest in the residence occurs during the 5-year period following the 5-year period described in clause (i), the
   holding period percentage
   ...
   “(II) 60.”
   Subsec. (m)(4)(E).
   Pub. L. 101–508, § 11408(c)(2)(B)
   , added subpar. (E).
   Subsec. (m)(5).
   Pub. L. 101–508, § 11408(c)(2)(C)(i)
   , added heading and struck out former heading which read: “Reduction of recapture amount if taxpayer meets certain income limitations”.
   Subsec. (m)(5)(A).
   Pub. L. 101–508, § 11408(c)(2)(C)(i)
   , added subpar. (A) and struck out former subpar. (A) “In general” which read as follows: “The recapture amount which would (but for this paragraph) apply with respect to any
   disposition
   during a taxable year shall be reduced (but not below zero) by 2 percent of such amount for each $100 by which
   adjusted qualifying income
   exceeds the
   modified adjusted gross income
   of the taxpayer for such year.”
   Subsec. (m)(5)(B), (C).
   Pub. L. 101–508, § 11408(c)(2)(C)
   , redesignated subpar. (C) as (B), substituted “paragraph (4)” for “this paragraph” in introductory provisions, and struck out former subpar. (B)
   “Adjusted qualifying income”
   ...
   “(II) the percentage equal to the sum of 100 percent plus 5 percent for each full year during the period beginning on such date and ending on the date of the
   disposition
   .
   For purposes of clause (ii)(I), highest family income shall be determined without regard to subsection (f)(3)(A) and on the basis of the number of members of the taxpayer’s family as of the date of the
   disposition
   .”
   Subsec. (m)(6).
   Pub. L. 101–508, § 11408(c)(3)(B)(i)
   , substituted “Special rules relating to limitation” for “Limitation” in heading.
   Subsec. (m)(6)(A).
   Pub. L. 101–508, § 11408(c)(3)(B)(ii)
   , (iii), struck out at beginning “In no event shall the recapture amount of the taxpayer with respect to any indebtedness exceed 50 percent of the gain (if any) on the
   disposition
   of the taxpayer’s interest in the residence.” and substituted “paragraph (1)” for “the preceding sentence”.
   Subsec. (m)(7)(B)(ii).
   Pub. L. 101–508, § 11408(c)(3)(C)
   , amended cl. (ii) generally. Prior to amendment, cl. (ii) read as follows: “the amounts described in paragraph (5)(B)(ii) for each category of family size for each year of the 10-year period beginning on the date the financing was provided.”
   1989—Subsec. (a)(1)(B).
   Pub. L. 101–239
   substituted “
   September 30, 1990
   ” for “
   December 31, 1989
   ” in heading and in text.
   1988—Subsec. (a)(1)(B).
   Pub. L. 100–647, § 4005(a)(1)
   , substituted “1989” for “1988” in heading and in text.
   Subsec. (a)(2)(A).
   Pub. L. 100–647, § 4005(f)
   , inserted sentence at end relating to application of cl. (iv).
   Subsec. (a)(2)(A)(ii).
   Pub. L. 100–647, § 4005(g)(1)
   , substituted “(i), and (m)(7)” for “and (i)”.
   Subsec. (a)(2)(A)(iii).
   Pub. L. 100–647, § 1013(a)(2)
   , substituted “such issue does not meet” for “no
   bond
   which is part of such issue meets”.
   Subsec. (a)(2)(A)(iv).
   Pub. L. 100–647, § 4005(f)
   , added cl. (iv).
   Subsec. (a)(2)(C).
   Pub. L. 100–647, § 4005(g)(2)(B)
   , substituted “, (h), and (m)(7)” for “and (h)” in introductory text.
   Subsec. (a)(2)(D).
   Pub. L. 100–647, § 4005(e)
   , added subpar. (D).
   Subsec. (b)(4).
   Pub. L. 100–647, § 1013(a)(3)
   , inserted “is part of an issue which” after “which”.
   Subsec. (f)(5).
   Pub. L. 100–647, § 4005(b)
   , added par. (5).
   Subsec. (f)(6).
   Pub. L. 100–647, § 4005(c)
   , added par. (6).
   Subsec. (g)(1).
   Pub. L. 100–647, § 4005(d)(1)
   , substituted “paragraph (2) of this subsection and, in the case of an issue described in subsection (b)(1), such issue also meets the requirements of paragraph (3) of this subsection” for “paragraphs (2) and (3) of this subsection” and struck out “(other than subsection (f) thereof)” before period at end.
   Subsec. (g)(2)(B)(iv).
   Pub. L. 100–647, § 4005(g)(6)
   , inserted at end “The Secretary may by regulation adjust the
   mortgage
   prepayment rate otherwise used in determining the effective rate of interest to the extent the Secretary determines that such an adjustment is appropriate by reason of the impact of subsection (m).”
   Subsec. (m).
   Pub. L. 100–647, § 4005(g)(1)
   ...
   120 Stat. 2963
   , provided that:
   “The amendment made by this section [amending this section] shall take effect as if included in section 203 [probably means 203(b)] of the
   ...
   120 Stat. 350
   , provided that:
   “The amendments made by this subsection [amending this section] shall apply to allocations of State volume limit after
   April 5, 2006
   .”
   Effective Date of 1997 Amendment
   Amendment by section 312(d)(1), (3) of
   Pub. L. 105–34
   ...
   Amendment by
   section 1702(d)(2) of Pub. L. 104–188
   ...
   .
   Amendment by
   section 1703(n)(3) of Pub. L. 104–188
   ...
   107 Stat. 437
   , provided that:
   “The amendments made by subsections (c) and (e) [amending this section] shall apply to qualified
   mortgage
   bonds
   issued and
   mortgage
   credit certificates provided on or after the date of enactment of this Act [
   Aug. 10, 1993
   ].”
   ...
   107 Stat. 437
   , provided that:
   “The amendments made by subsection (d) [amending this section] shall apply to loans originated and credit certificates provided after the date of the enactment of this Act [
   Aug. 10, 1993
   ].”
   ...
   ] shall apply to elections for periods after
   September 30, 1990
   .
   “(3)
   Simplification.—
   The amendment made by subsection (c) [amending this section] shall take effect as if included in the amendments made by section 4005 of the
   ...
   —
   “(A)
   the amendments made by subsections (b) and (c) [amending this section] shall apply to financing provided after the date of issuance of the refunding issue, and
   “(B)
   the amendment made by subsection (f) [amending this section] shall apply to payments (including on loans made before such date of issuance) received on or after such date of issuance.
   “(3)
   Subsection (g).—
   “(A)
   In general.—
   Except as provided in subparagraph (B), the amendments made by subsection (g) [amending this section and sections
   25
   ,
   26
   ,
   ...
   , and
   6654
   of this title] shall apply to financing provided, and
   mortgage
   credit certificates issued, after
   December 31, 1990
   .
   “(B)
   Exception.—
   The amendments made by subsection (g) shall not apply to financing provided pursuant to a binding contract (entered into before
   June 23, 1988
   ) with a homebuilder, lender, or mortgagor if the
   bonds
   (the proceeds of which are used to provide such financing) are issued—
   “(i)
   before
   June 23, 1988
   , or
   ...
   before
   August 1, 1988
   , pursuant to a written application (made before
   July 1, 1988
   ) for State
   bond
   volume authority.”
   ...
   June 17, 2008
   ], subparagraph (B) of section 143(
   l
   )(4) of the
   Internal Revenue Code of 1986
   , as amended by this section, shall be applied by substituting ‘30 years’ for ‘25 years’.”
   ...
   102 Stat. 3543
   , provided that:
   “The date contained in [former] section 143(a)(1)(B) of the 1986 Code shall be treated as contained in section 103A(c)(1)(B) of the
   Internal Revenue Code of 1954
   , as in effect on the day before the date of the enactment of the Reform Act [
   Oct. 22, 1986
   ], for purposes of any
   bond
   issued to refund a
   bond
   to which such [section] 103A(c)(1) applies.”
   ...
   ,
   102 Stat. 3651
   , required the Comptroller General of the United States to conduct a study of subsec. (m) of this section and alternatives to accomplish the purposes of such subsection, and submit a report to
   Congress
   by
   July 1, 1990
   .
