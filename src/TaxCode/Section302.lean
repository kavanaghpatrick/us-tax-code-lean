...
## Summary
   ...
   (B)
   Limitation
   This paragraph shall not apply unless immediately after the redemption the
   shareholder
   owns less than 50 percent of the total combined voting power of all classes of stock entitled to vote.
   (C)
   Definitions
   For purposes of this paragraph, the distribution is substantially disproportionate if—
   (i)
   the ratio which the voting stock of the corporation owned by the
   shareholder
   ...
   shareholder
   ’s ownership of the common stock of the corporation (whether voting or nonvoting) after and before redemption also meets the 80 percent requirement of the preceding sentence. For purposes of the preceding sentence, if there is more than one class of common stock, the determinations shall be made by reference to fair market value.
   (D)
   Series of redemptions
   This paragraph shall not apply to any redemption made pursuant to a plan the purpose or effect of which is a series of redemptions resulting in a distribution which (in the aggregate) is not substantially disproportionate with respect to the
   shareholder
   .
   (3)
   Termination of shareholder’s interest
   Subsection (a) shall apply if the redemption is in complete redemption of all of the stock of the corporation owned by the
   shareholder
   .
   (4)
   ...
   (A)
   in redemption of stock held by a
   shareholder
   ...
   Except to the extent provided in regulations prescribed by the Secretary, subsection (a) shall apply to any distribution in redemption of stock of a publicly offered regulated
   investment company
   ...
   (A)
   In the case of a distribution described in subsection (b)(3),
   section 318(a)(1)
   shall not apply if—
   (i)
   ...
   The preceding sentence shall not apply if the acquisition (or, in the case of clause (ii), the
   disposition
   ...
   and each
   related person
   meet the requirements of clauses (i), (ii), and (iii) of subparagraph (A), and
   (II)
   each
   related person
   agrees to be jointly and severally liable for any deficiency (including interest and additions to tax) resulting from an acquisition described in clause (ii) of subparagraph (A).
   In any case to which the preceding sentence applies, the second sentence of subparagraph (A) and subparagraph (B)(ii) shall be applied by substituting “distributee or any
   related person
   ” for “distributee” each place it appears.
   (ii)
   Definitions
   ...
   the term “
   entity
   ” means a partnership, estate, trust, or corporation; and
   (II)
   the term “
   related person
   ” means any person to whom ownership of stock in the corporation is (at the time of the distribution) attributable under
   section 318(a)(1)
   if such stock is further attributable to the
   entity
   under section 318(a)(3).
   (d)
   Redemptions treated as distributions of property
   Except as otherwise provided in this subchapter, if a corporation redeems its stock (within the meaning of
   section 317(b)
   ), and if subsection (a) of this section does not apply, such redemption shall be treated as a distribution of
   property
   ...
   (A)
   the distribution is not essentially equivalent to a dividend (determined at the corporate level rather than at the
   shareholder
   level), and
   (B)
   ...
   (A)
   The distribution is attributable to the distributing corporation’s ceasing to conduct, or consists of the assets of, a
   ...
   qualified trade or business
   ” means any trade or business which—
   (A)
   ...
   Whether or not a redemption meets the requirements of subparagraphs (A) and (B) of paragraph (2) shall be determined without regard to whether or not the redemption is pro rata with respect to all of the
   shareholders
   of the corporation.
   (5)
   Treatment of certain pass-thru entities
   For purposes of determining under subsection (b)(4) whether any stock is held by a
   shareholder
   who is not a corporation, any stock held by a partnership, estate, or trust shall be treated as if it were actually held proportionately by its partners or beneficiaries.
   (f)
   Cross references
   ...
   96 Stat. 478
   , 493;
   Pub. L. 98–369, div. A, title VII, § 712(i)(1)
   ,
   July 18, 1984
   ,
   98 Stat. 948
   ;
   Pub. L. 111–325, title III, § 306(a)
   ,
   Dec. 22, 2010
   ,
   124 Stat. 3549
   ...
   Amendments
   2010—Subsec. (a).
   Pub. L. 111–325, § 306(a)(2)
   , substituted “(4), or (5)” for “or (4)”.
   Subsec. (b)(5), (6).
   Pub. L. 111–325, § 306(a)(1)
   , added par. (5) and redesignated former par. (5) as (6).
   1984—Subsec. (f)(3).
   Pub. L. 98–369
   substituted “complete liquidation” for “partial or complete liquidation”.
   1982—Subsec. (a).
   Pub. L. 97–248, § 222(c)(3)
   , substituted “paragraph (1), (2), (3), or (4)” for “paragraph (1), (2), or (3)”.
   Subsec. (b)(4), (5).
   Pub. L. 97–248, § 222(c)(1)
   , (4), added par. (4), redesignated former par. (4) as (5) and substituted “paragraph (2), (3), or (4)” for “paragraph (2) or (3)” after “to meet the requirements of”, and “paragraph (1), (2), or (4)” for “paragraph (1) or (2)” after “and also the requirements of”.
   Subsec. (c)(2)(C).
   Pub. L. 97–248, § 228(a)
   , added subpar. (C).
   Subsecs. (e), (f).
   Pub. L. 97–248, § 222(c)(2)
   , added subsec. (e) and redesignated former subsec. (e) as (f).
   1980—Subsec. (a).
   Pub. L. 96–589, § 5(b)(2)(A)
   , struck out reference to par. (4) of subsec. (b).
   Subsec. (b)(4), (5).
   Pub. L. 96–589, § 5(b)(1)
   , (2)(B), redesignated par. (5) as (4) and struck out reference to par. (4) in two places. Former par. (4) was struck out.
   1976—Subsec. (c)(2).
   Pub. L. 94–455
   ...
   Dec. 22, 2010
   , see
   section 306(c) of Pub. L. 111–325
   ...
   Pub. L. 97–248, title II, § 222(f)
   ,
   Sept. 3, 1982
   ,
   96 Stat. 481
   , as amended by
   Pub. L. 97–448, title III, § 306(a)(6)(A)
   ,
   Jan. 12, 1983
   ,
   96 Stat. 2402
   ...
   on
   July 22, 1982
   , there was a ruling request by such corporation pending with the
   Internal Revenue Service
   as to whether such distributions would qualify as a partial liquidation, or
   “(II)
   ...
   , the
   Internal Revenue Service
   granted a ruling to such corporation that the distributions would qualify as a partial liquidation, and
   “(ii)
   ...
   Internal Revenue Service
   granted a ruling pursuant to the request described in clause (i)(I)).
   “(B)
   ...
   , where
   control
   of the corporation making the distributions was acquired after
   December 31, 1981
   , and before
   July 23, 1982
   .
   ...
   “(II)
   control
   of such corporation was acquired after
   July 22, 1982
   , pursuant to a tender offer or binding contract outstanding on such date.
   “(ii)
   ...
   October 1, 1982
   ’ the date which is 90 days after the date on which approval by the Federal regulatory agency of such acquisition becomes final.
   “(iii)
   ...
   October 1, 1982
   ’ the date which is 90 days after the date on which such regulatory body approves a public offer to acquire stock in such corporation.
   “(iv)
   ...
   notification of its intent to acquire
   control
   ...
   , where
   control
   was acquired by the distributee or its parent after
   December 31, 1980
   , and before
   July 23, 1982
   , and the conduct of the insurance business by the distributee is conditioned on approval by a State regulatory authority.
   For purposes of this paragraph, the term ‘
   control
   ’ has the meaning given to such term by section 368(c) of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954], except that in applying such section both direct and indirect ownership of stock shall be taken into account.
   “(3)
   ...
   Sept. 3, 1982
   ] to distributions to which (but for paragraph (2)) the amendments made by this section would apply,
   ...
   Internal Revenue Code of 1986
   (as added by section 224), any
   property
   acquired in a distribution to which the amendments made by this section do not apply by reason of paragraph (2) shall be treated as acquired before
   September 1, 1982
   .”
   Effective Date of 1980 Amendment
   Amendment by
   Pub. L. 96–589
   applicable to stock which is issued after
   Dec. 31, 1980
   , except as otherwise provided, see section 7(d)(2), (f) of
   Pub. L. 96–589
   , set out as a note under
   section 108 of this title
   .
   Savings Provisions
   Applicability of subsec. (b)(1) to the determination of gross investment income under sections
   4940
   and
   4948(a)
   of this title, see section 101(l)(8) of
   Pub. L. 91–172
   , set out as a note under
