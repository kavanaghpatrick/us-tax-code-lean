...
This project request had uuid: 453a9478-c940-4114-bd8b-4b3b5f09c6ca
-/
...
/-!
# IRC Section 562 - Rules applicable in determining dividends eligible for dividends paid deduction

This file formalizes IRC §562 (Rules applicable in determining dividends eligible for dividends paid deduction).

## References
- [26 USC §562](https://www.law.cornell.edu/uscode/text/26/562)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 562 - Rules applicable in determining dividends eligible for dividends paid deduction
   U.S. Code
   Notes
   prev
   |
   ...
   (1)
   Except in the case of a personal holding company described in
   section 542
   —
   (A)
   in the case of amounts distributed in liquidation, the part of such distribution which is properly chargeable to earnings and profits accumulated after
   February 28, 1913
   , shall be treated as a dividend for purposes of computing the dividends paid deduction, and
   (B)
   in the case of a complete liquidation occurring within 24 months after the adoption of a plan of liquidation, any distribution within such period pursuant to such plan shall, to the extent of the earnings and profits (computed without regard to capital losses) of the corporation for the taxable year in which such distribution is made, be treated as a dividend for purposes of computing the dividends paid deduction.
   For purposes of subparagraph (A), a liquidation includes a redemption of stock to which
   section 302
   applies. Except to the extent provided in regulations, the preceding sentence shall not apply in the case of any mere holding or investment company which is not a regulated investment company.
   (2)
   In the case of a complete liquidation of a personal holding company, occurring within 24 months after the adoption of a plan of liquidation, the amount of any distribution within such period pursuant to such plan shall be treated as a dividend for purposes of computing the dividends paid deduction, to the extent that such amount is distributed to corporate distributees and represents such corporate distributees’ allocable share of the undistributed personal holding company income for the taxable year of such distribution computed without regard to this paragraph and without regard to subparagraph (B) of section 316(b)(2).
   (c)
   Preferential dividends
   (1)
   In general
   Except in the case of a publicly offered regulated investment company (as defined in section 67(c)(2)(B)) or a
   ...
   publicly offered REIT
   ” means a real estate investment trust which is required to file annual and periodic reports with the
   ...
   In the case of a real estate investment trust, in determining the amount of dividends under
   section 316
   for purposes of computing the dividends paid deduction—
   (A)
   ...
   The
   Securities Exchange Act of 1934
   , referred to in subsec. (c)(2), is act June 6, 1934, ch. 404,
   48 Stat. 881
   ...
   2015—Subsec. (c).
   Pub. L. 114–113, § 314(a)
   , (b), designated existing provisions as par. (1), inserted heading and “or a
   publicly offered REIT”
   after “a publicly offered regulated investment company (as defined in section 67(c)(2)(B))” in text, and added par. (2).
   Subsec. (e).
   Pub. L. 114–113, § 315(a)
   , designated existing provisions as par. (1), inserted heading, and added par. (2).
   Subsec. (e)(1).
   Pub. L. 114–113, § 320(b)
   , substituted “deduction—” for “deduction, the earnings and profits of such trust for any taxable year beginning after
   December 31, 1980
   , shall be increased by the total amount of gain (if any) on the sale or exchange of real property by such trust during such taxable year.” and added subpars. (A) and (B).
   2010—Subsec. (c).
   Pub. L. 111–325
   substituted “Except in the case of a publicly offered regulated investment company (as defined in section 67(c)(2)(B)), the amount” for “The amount” in first sentence and inserted “(other than a publicly offered regulated investment company (as so defined))” after “regulated investment company” in second sentence.
   2004—Subsec. (b)(1).
   Pub. L. 108–357
   struck out “or a foreign personal holding company described in section 552” after “section 542” in introductory provisions.
   1986—Subsec. (b)(1).
   Pub. L. 99–514, § 1804(d)(1)
   , inserted at end “Except to the extent provided in regulations, the preceding sentence shall not apply in the case of any mere holding or investment company which is not a regulated investment company.”
   Subsec. (c).
   Pub. L. 99–514, § 657(a)
   , inserted at end “In the case of a distribution by a regulated investment company to a shareholder who made an initial investment of at least $10,000,000 in such company, such distribution shall not be treated as not being pro rata or as being preferential solely by reason of an increase in the distribution by reason of reductions in administrative expenses of the company.”
   1983—Subsec. (e).
   Pub. L. 97–448
   added subsec. (e).
   1982—Subsec. (b)(1).
   Pub. L. 97–248
   inserted sentence at end providing that, for purposes of subpar. (A), a liquidation includes a redemption of stock to which section 302 applies.
   1964—Subsec. (b).
   Pub. L. 88–272
   designated existing provisions as subpars. (A) and (B) of par. (1), excepted personal holding companies in section 542, and foreign personal holding companies in section 552 therefrom, and added par. (2).
   ...
   Amendment
   Pub. L. 88–272
   applicable to distributions made in any taxable year of the distributing corporation beginning after
   Dec. 31, 1963
