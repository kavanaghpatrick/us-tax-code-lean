...
## Summary
   ...
   qualifying partnership’
   s gain or loss from the sale, exchange, or other
   disposition
   of such property.
   (ii)
   Qualifying partnership.—
   The term “
   qualifying partnership
   ” means a partnership which—
   (I)
   has a partnership agreement which satisfies the requirements of section 514(c)(9)(B)(vi) at all times beginning on the date of the first certification received by the partnership under subparagraph (C)(i),
   (II)
   satisfies the requirements of subparagraphs (B)(i), (C), (D), and (E), if “qualified partnership” is substituted for “
   eligible taxpayer
   ” each place it appears therein (except subparagraph (D)(iii)), and
   (III)
   is not an organization which would be prevented from constituting an
   eligible taxpayer
   ...
   eligible taxpayer
   which is a partner of a partnership which acquires, remediates, and sells, exchanges, or otherwise disposes of a
   qualifying brownfield property
   only if such
   eligible taxpayer
   was a partner of the
   qualifying partnership
   at all times beginning on the date of the first certification received by the partnership under subparagraph (C)(i) and ending on the date of the sale, exchange, or other
   disposition
   ...
   (I)
   the use of special allocations of gains or losses, or
   (II)
   changes in ownership of partnership interests held by
   eligible taxpayers
   .
   (H)
   ...
   of which the
   eligible taxpayer
   is a partner may make a 1-time election to apply this paragraph to more than 1
   qualifying brownfield property
   by averaging the
   eligible remediation expenditures
   for all such properties acquired during the election period. If the
   eligible taxpayer
   or
   qualifying partnership
   makes such an election, the election shall apply to all qualified sales, exchanges, or other
   dispositions
   of qualifying brownfield properties the acquisition and transfer of which occur during the period for which the election remains in effect.
   (ii)
   Election.—
   An election under clause (i) shall be made with the
   eligible taxpayer
   ’s or
   qualifying partnership
   ’s timely filed tax return (including extensions) for the first taxable year for which the taxpayer or
   qualifying partnership
   intends to have the election apply. An election under clause (i) is effective for the period—
   (I)
   beginning on the date which is the first day of the taxable year of the return in which the election is included or a later day in such taxable year selected by the
   eligible taxpayer
   or
   qualifying partnership
   , and
   (II)
   ending on the date which is the earliest of a date of revocation selected by the
   eligible taxpayer
   or
   qualifying partnership
   , the date which is 8 years after the date described in subclause (I), or, in the case of an election by a
   qualifying partnership
   of which the
   eligible taxpayer
   is a partner, the date of the termination of the
   qualifying partnership
   .
   (iii)
   Revocation.—
   ...
   or
   qualifying partnership
   may revoke an election under clause (i) by filing a statement of revocation with a timely filed tax return (including extensions). A revocation is effective as of the first day of the taxable year of the return in which the revocation is included or a later day in such taxable year selected by the
   eligible taxpayer
   or
   qualifying partnership
   . Once an
   ...
   or
   qualifying partnership
   revokes the election, the
   eligible taxpayer
   or
   qualifying partnership
   is ineligible to make another election under clause (i) with respect to any
   qualifying brownfield property
   subject to the revoked election.
   (I)
   Recapture.—
   If an
   eligible taxpayer
   excludes gain or loss from a sale, exchange, or other
   disposition
   of property to which an election under subparagraph (H) applies, and such property fails to satisfy the requirements of this paragraph, the
   unrelated business taxable income
   of the
   eligible taxpayer
   for the taxable year in which such failure occurs shall be determined by including any previously excluded gain or loss from such sale, exchange, or other
   disposition
   allocable to such taxpayer, and interest shall be determined at the overpayment rate established under section 6621 on any resulting tax for the period beginning with the due date of the return for the taxable year during which such sale, exchange, or other
   disposition
   ...
   section 267(b)
   (determined without regard to paragraph (9) thereof), or section 707(b)(1), determined by substituting “25 percent” for “50 percent” each place it appears therein, and
   (ii)
   in the case such other person is a nonprofit organization, if such person
   controls
   directly or indirectly more than 25 percent of the governing body of such organization.
   (K)
   Termination.—
   Except for purposes of determining the average
   eligible remediation expenditures
   for properties acquired during the election period under subparagraph (H), this paragraph shall not apply to any property acquired by the
   eligible taxpayer
   or
   qualifying partnership
   after
   ...
   (1)
   In general
   If a trade or business regularly carried on by a partnership of which an organization is a member is an
   unrelated trade or business
   with respect to such organization, such organization in computing its
   unrelated business taxable income
   shall, subject to the exceptions, additions, and limitations contained in subsection (b), include its share (whether or not distributed) of the gross income of the partnership from such
   unrelated trade or business
   ...
   If the taxable year of the organization is different from that of the partnership, the amounts to be included or deducted in computing the
   unrelated business taxable income
   under paragraph (1) shall be based upon the income and deductions of the partnership for any taxable year of the partnership ending within or with the taxable year of the organization.
   (d)
   ...
   requires annual
   dues
   to be paid in order to be a member of such organization, and
   (B)
   the amount of such required annual
   dues
   does not exceed $100,
   in no event shall any portion of such
   dues
   be treated as derived by such organization from an
   unrelated trade or business
   by reason of any benefits or privileges to which members of such organization are entitled.
   (2)
   ...
   $100, multiplied by
   (B)
   the cost-of-living adjustment determined under section 1(f)(3) for the calendar year in which the taxable year begins, by substituting “calendar year 1994” for “calendar year 2016” in subparagraph (A)(ii) thereof.
   (3)
   Dues
   For purposes of this subsection, the term “
   dues
   ” means any payment (whether or not designated as
   dues
   ) which is required to be made in order to be recognized by the organization as a member of the organization.
   (e)
   ...
   or
   1361(c)(6)
   holds stock in an S corporation—
   (A)
   such interest shall be treated as an interest in an
   unrelated trade or business
   , and
   (B)
   notwithstanding any other provision of this part—
   (i)
   all items of income, loss, or deduction taken into account under section 1366(a), and
   (ii)
   ...
   (2)
   Basis reduction
   Except as provided in regulations, for purposes of paragraph (1), the basis of any stock acquired by purchase (as defined in
   section 1361(e)(1)(C)
   ) shall be reduced by the amount of any dividends received by the organization with respect to the stock.
   (3)
   Exception for ESOPs
   This subsection shall not apply to employer securities (within the meaning of
   section 409(l)
   ) held by an employee stock ownership plan described in section 4975(e)(7).
   (Aug. 16, 1954, ch. 736,
   68A Stat. 170
   ;
   Pub. L. 85–367, § 1(a)
   ...
   78 Stat. 333
   ;
   Pub. L. 89–809, title I, § 104(g)
   ,
   Nov. 13, 1966
   ,
   80 Stat. 1559
   ;
   Pub. L. 91–172, title I, § 121(b)(1)
   , (2),
   Dec. 30, 1969
   ,
   83 Stat. 537
   ...
   , §§ 1901(b)(8)(F), 1906(b)(13)(A), 1951(b)(8)(A),
   Oct. 4, 1976
   ,
   90 Stat. 1794
   , 1834, 1839;
   ...
   92 Stat. 481
   ;
   Pub. L. 97–448, title I, § 102(m)(3)
   ,
   Jan. 12, 1983
   ,
   96 Stat. 2374
   ;
   Pub. L. 98–369, div. A, title V, § 511(b)
   ,
   July 18, 1984
   ,
   98 Stat. 860
   ;
   Pub. L. 99–514, title XVIII, § 1851(a)(10)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2861
   ;
   Pub. L. 100–203, title X, § 10213(a)
   ,
   Dec. 22, 1987
   ,
   101 Stat. 1330–406
   ;
   Pub. L. 100–647, title I, § 1018(t)(2)(B)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3587
   ...
   , §§ 13145(a), 13147(a), 13148(a), (b),
   Aug. 10, 1993
   ,
   107 Stat. 443
   , 444;
   Pub. L. 104–188, title I
   , §§ 1115(a), 1316(c), 1603(a),
   Aug. 20, 1996
   ,
   110 Stat. 1761
   , 1786, 1835;
   Pub. L. 105–34, title III, § 312(d)(5)
   , title X, § 1041(a), title XV, § 1523(a), title XVI, § 1601(c)(4)(A), (D),
   Aug. 5, 1997
   ,
   111 Stat. 840
   , 938, 1070, 1087;
   ...
   112 Stat. 815
   , 825;
   Pub. L. 108–357, title II, § 233(d)
   , title III, § 319(c), title VII, § 702(a),
   Oct. 22, 2004
   ,
   118 Stat. 1434
   , 1472, 1540;
   Pub. L. 109–135, title IV, § 412(dd)
   , (ee)(1),
   Dec. 21, 2005
   ,
   119 Stat. 2639
   ;
   Pub. L. 109–280, title XII, § 1205(a)
   ,
   Aug. 17, 2006
   ,
   120 Stat. 1066
   ;
   Pub. L. 110–343, div. C, title III, § 306(a)
   ,
   Oct. 3, 2008
   ,
   122 Stat. 3868
   ;
   Pub. L. 111–312, title VII, § 747(a)
   ,
   Dec. 17, 2010
   ,
   124 Stat. 3320
   ;
   Pub. L. 112–240, title III, § 319(a)
   ,
   Jan. 2, 2013
   ,
   126 Stat. 2331
   ;
   Pub. L. 113–295, div. A, title I, § 131(a)
   , title II, § 221(a)(41)(G),
   Dec. 19, 2014
   ,
   128 Stat. 4018
   , 4044;
   Pub. L. 114–113, div. Q, title I, § 114(a)
   ,
   Dec. 18, 2015
   ,
   129 Stat. 3049
   ...
   , §§ 11002(d)(1)(Y), 13702(a), 13703(a),
   Dec. 22, 2017
   ,
   131 Stat. 2060
   , 2168, 2169;
   Pub. L. 115–141, div. U, title IV, § 401(a)(126)
   , (b)(21)(E)–(H),
   Mar. 23, 2018
   ,
   132 Stat. 1190
   , 1203;
   Pub. L. 116–94, div. Q, title III, § 302(a)
   ,
   Dec. 20, 2019
   ,
   133 Stat. 3248
   ...
   Taxpayer Relief Act of 1997
   , referred to in subsec. (a)(3)(D), is the date of enactment of
   Pub. L. 105–34
   , which was approved
   Aug. 5, 1997
   .
   The date of the enactment of the
   Tax Reform Act of 1984
   , referred to in subsec. (a)(3)(E)(ii)(II), (III), is the date of enactment of division A of
   Pub. L. 98–369
   , which was approved
   July 18, 1984
   .
   ...
   2019—Subsec. (a)(7).
   Pub. L. 116–94
   struck out par. (7) which related to increases in
   unrelated business taxable income
   for certain fringe benefit expenses.
   2018—Subsec. (a)(3).
   Pub. L. 115–141, § 401(b)(21)(G)
   , substituted “or (17)” for “(17), or (20)” in heading.
   Subsec. (a)(3)(A).
   Pub. L. 115–141, § 401(b)(21)(E)
   , substituted “or (17)” for “(17), or (20)”.
   Subsec. (a)(3)(B)(ii).
   Pub. L. 115–141, § 401(b)(21)(F)
   , substituted “or (17)” for “, (17), or (20)”.
   Subsec. (a)(3)(C), (D).
   Pub. L. 115–141, § 401(b)(21)(E)
   , substituted “or (17)” for “(17), or (20)”.
   Subsec. (a)(3)(E).
   Pub. L. 115–141, § 401(b)(21)(F)
   , (H), substituted “or (17)” for “, (17), or (20)” in subpar. heading and text of cl. (i).
   Subsec. (b)(19)(H)(iii).
   Pub. L. 115–141, § 401(a)(126)
   , substituted “clause (i)” for “clause (i)(II)”.
   2017—Subsec. (a)(6).
   Pub. L. 115–97, § 13702(a)
   , added par. (6).
   Subsec. (a)(7).
   Pub. L. 115–97, § 13703(a)
   , added par. (7).
   Subsec. (d)(2)(B).
   Pub. L. 115–97, § 11002(d)(1)(Y)
   ...
   Pub. L. 114–113
   struck out cl. (iv). Text read as follows: “This subparagraph shall not apply to payments received or accrued after
   December 31, 2014
   .”
   2014—Subsec. (a)(3)(A).
   ...
   Pub. L. 109–280
   , which directed the amendment of section 512(b)(13) by adding subpar. (E) and redesignating former subpar. (E) as (F), without specifying the act to be amended, was executed by making the amendments to this section, which is section 512 of the
   Internal Revenue Code of 1986
   , to reflect the probable intent of
   Congress
   .
   2005—Subsec. (b)(1).
   Pub. L. 109–135, § 412(dd)
   , substituted “subsection (a)(5)” for “section 512(a)(5)”.
   Subsec. (b)(18), (19).
   Pub. L. 109–135, § 412(ee)(1)
   , redesignated par. (18), relating to treatment of gain or loss on sale or exchange of certain brownfield sites, as (19).
   2004—Subsec. (b)(18).
   Pub. L. 108–357, § 702(a)
   , added par. (18) relating to treatment of gain or loss on sale or exchange of certain brownfield sites.
   Pub. L. 108–357, § 319(c)
   , added par. (18) relating to treatment of mutual or cooperative electric companies.
   Subsec. (e)(1).
   Pub. L. 108–357, § 233(d)
   , inserted “1361(c)(2)(A)(vi) or” before “1361(c)(6)” in introductory provisions.
   1998—Subsec. (b)(13)(A).
   Pub. L. 105–206, § 6010(j)(1)
   , inserted “or accrues” after “receives” in first sentence.
   Subsec. (b)(13)(B)(i)(I).
   Pub. L. 105–206, § 6010(j)(2)
   , struck out “(as defined in section 513A(a)(5)(A))” after “exempt purposes”.
   Subsec. (b)(17)(B)(ii)(II).
   Pub. L. 105–206, § 6023(8)
   , substituted “rule” for “Rule” in subcl. heading.
   1997—Subsec. (a)(3)(D).
   Pub. L. 105–34, § 312(d)(5)
   , inserted “(as in effect on the day before the date of the enactment of the
   Taxpayer Relief Act of 1997
   )” after “1034”.
   Subsec. (b)(13).
   Pub. L. 105–34, § 1041(a)
   , amended par. (13) generally. Prior to amendment, par. (13) related to inclusion in gross income of controlling organization of amounts of interest, annuities, royalties, and rents derived from a controlled organization.
   Subsec. (e)(1).
   Pub. L. 105–34, § 1601(c)(4)(D)
   , substituted “section 1361(c)(6)” for “section 1361(c)(7)”.
   Subsec. (e)(2).
   Pub. L. 105–34, § 1601(c)(4)(A)
   , substituted “as defined in section 1361(e)(1)(C)” for “within the meaning of section 1012”.
   Subsec. (e)(3).
   Pub. L. 105–34, § 1523(a)
   , added par. (3).
   1996—Subsec. (b)(17).
   Pub. L. 104–188, § 1603(a)
   , added par. (17).
   Subsec. (d).
   Pub. L. 104–188, § 1115(a)
   , added subsec. (d).
   Subsec. (e).
   Pub. L. 104–188, § 1316(c)
   , added subsec. (e).
   1993—Subsec. (b)(1).
   Pub. L. 103–66, § 13148(a)
   , inserted “amounts received or accrued as consideration for entering into agreements to make loans,” before “and annuities”.
   Subsec. (b)(5).
   Pub. L. 103–66, § 13148(b)
   , in second sentence, substituted “all gains or losses recognized, in connection with the organization’s investment activities, from” for “all gains on”, struck out “, written by the organization in connection with its investment activities,” after “termination of options”, and inserted before period at end “or real property and all gains or losses from the forfeiture of good-faith deposits (that are consistent with established business practice) for the purchase, sale, or lease of real property in connection with the organization’s investment activities”.
   Subsec. (b)(16).
   Pub. L. 103–66, § 13147(a)
   , added par. (16).
   Subsec. (c)(2), (3).
   Pub. L. 103–66, § 13145(a)
   , redesignated par. (3) as (2), substituted “paragraph (1)” for “paragraph (1) or (2)”, and struck out heading and text of former par. (2). Text read as follows: “Notwithstanding any other provision of this section—
   “(A) any organization’s share (whether or not distributed) of the gross income of a publicly traded partnership (as defined in
   section 469(k)(2)
   ) shall be treated as gross income derived from an
   unrelated trade or business,
   and
   “(B) such organization’s share of the partnership deductions shall be allowed in computing
   unrelated business taxable income
   .”
   1990—Subsec. (b)(14).
   Pub. L. 101–508
   struck out par. (14) which read as follows: “Except as provided in paragraph (4), in the case of a church, or convention or association of churches, for taxable years beginning before
   January 1, 1976
   , there shall be excluded all gross income derived from a trade or business and all deductions directly connected with the carrying on of such trade or business if such trade or business was carried on by such organization or its predecessor before
   May 27, 1969
   .”
   1988—Subsec. (a)(3)(E)(ii)(II).
   Pub. L. 100–647
   substituted “subclause (I)” for “subclause (II)” and a period for comma at end.
   1987—Subsec. (c).
   Pub. L. 100–203
   substituted “for partnerships” for “applicable to partnerships” in heading and amended text generally. Prior to amendment, text read as follows: “If a trade or business regularly carried on by a partnership of which an organization is a member is an
   unrelated trade or business
   with respect to such organization, such organization in computing its
   unrelated business taxable income
   shall, subject to the exceptions, additions, and limitations contained in subsection (b), include its share (whether or not distributed) of the gross income of the partnership from such
   unrelated trade or business
   and its share of the partnership deductions directly connected with such gross income. If the taxable year of the organization is different from that of the partnership, the amounts to be so included or deducted in computing the
   unrelated business taxable income
   shall be based upon the income and deductions of the partnership for any taxable year of the partnership ending within or with the taxable year of the organization.”
   1986—Subsec. (a)(3)(E)(i).
   Pub. L. 99–514, § 1851(a)(10)(A)
   , substituted “determined under section 419A (without regard to subsection (f)(6) thereof)” for “determined under section 419A(c)”.
   Subsec. (a)(3)(E)(ii).
   Pub. L. 99–514, § 1851(a)(10)(B)
   , (C), redesignated cl. (iii) as (ii), in subcl. I substituted “an existing reserve” for “a existing reserve”, and substituted new subcl. (II) for former subcl. (II) which read as follows: “For purposes of subclause (I), the term ‘existing reserve or post-retirement medical or life insurance benefit’ means the amount of assets set aside as of the close of the last plan year ending before the date of the enactment of the
   Tax Reform Act of 1984
   for purposes of post-retirement medical benefits or life insurance benefits to be provided to covered employees.” Former cl. (ii), which provided that no set aside for assets used in the provision of benefits described in cl. (ii) of subpar. (B), could be taken into account, was struck out.
   Subsec. (a)(3)(E)(iii), (iv).
   Pub. L. 99–514, § 1851(a)(10)(B)
   , (D), redesignated former cl. (iv) as (iii) and substituted “subparagraph shall not” for “paragraph shall not”. Former cl. (iii) redesignated (ii).
   1984—Subsec. (a)(3).
   Pub. L. 98–369, § 511(b)(1)(A)
   , substituted “paragraph (7), (9), (17), or (20) of section 501(c)” for “section 501(c)(7) or (9)” wherever appearing in heading and in text.
   Subsec. (a)(3)(B)(ii).
   Pub. L. 98–369, § 511(b)(1)(B)
   , substituted “paragraph (9), (17), or (20) of section 501(c)” for “section 501(c)(9)”.
   Subsec. (a)(3)(C), (D).
   Pub. L. 98–369, § 511(b)(1)(A)
   , substituted in subpars. (C) and (D) “paragraph (7), (9), (17), or (20) of section 501(c)” for “section 501(c)(7) or (9)” wherever appearing.
   Subsec. (a)(3)(E).
   Pub. L. 98–369, § 511(b)(2)
   , added subpar. (E).
   1983—Subsec. (b)(10).
   Pub. L. 97–448
   ...
   Subsec. (b)(1).
   Pub. L. 95–345, § 2(a)(2)
   , inserted provision relating to
   payments with respect to securities loans.
   1976—Subsec. (a)(3)(A).
   Pub. L. 94–568
   provided that for purposes of the general rule, the deductions provided by sections 243, 244, and 245 (relating to dividends received by corporations) shall be treated as not directly connected with the production of gross income.
   Subsec. (b).
   Pub. L. 94–455, § 1906(b)(13)(A)
   , struck out “or his delegate” after “Secretary”.
   Subsec. (b)(5).
   Pub. L. 94–396
   inserted provision relating to exclusion of gains on the lapse or termination of options to buy or sell securities.
   Subsec. (b)(13), (14).
   Pub. L. 94–455, § 1951(b)(8)(A)
   , redesignated pars. (15) and (16) as (13) and (14), respectively. Former pars. (13) and (14), relating to exceptions, additions, and limitations applicable in determining
   unrelated business taxable income,
   were struck out.
   Subsec. (b)(15).
   Pub. L. 94–455
   ...
   added par. (4).
   1969—Subsec. (a).
   Pub. L. 91–172, § 121(b)(1)
   , designated existing provisions as pars. (1) and (2)(B) and added pars. (2)(A) and (3).
   Subsec. (b).
   Pub. L. 91–172, § 121(b)(2)(D)
   , substituted “Modifications” for “Exceptions, additions, and limitations”, in heading, and, in text preceding par. (1) substituted “The modifications referred to in subsection (a)” for “The exceptions, additions, and limitations applicable in determining
   unrelated business taxable income”
   .
   Subsec. (b)(3)(A).
   Pub. L. 91–172, § 121(b)(2)(A)
   , inserted reference to exceptions set out in subsec. (b)(3)(B) in text preceding cl. (i), substituted “property described in section 1245(a)(3)(C)” for “personal property leased with the real property” in parenthetical of cl. (i), and added cl. (ii).
   Subsec. (b)(3)(B).
   Pub. L. 91–172, § 121(b)(2)(A)
   , added subpar. (B).
   Subsec. (b)(3)(C).
   Pub. L. 91–172, § 121(b)(2)(A)
   , substituted “rents excluded under subparagraph (A)” for “such rents”.
   Subsec. (b)(4).
   Pub. L. 91–172, § 121(b)(2)(A)
   , inserted reference to pars. (1), (3) and (5) of this subsec., and substituted “debt financed property” for “a business lease”.
   Subsec. (b)(12).
   Pub. L. 91–172, § 121(b)(2)(B)
   , made the allowance of the specific $1,000 deduction inapplicable for the purposes of computing the net operating loss under
   section 172 of this title
   and par. (6) of this subsec., and provided for the allowance of specific deductions equal to the lower of $1,000 or the gross income derived from any
   unrelated trade or business
   carried on by a parish, individual church, district, or other local unit.
   Subsec. (b)(15) to (17).
   Pub. L. 91–172, § 121(b)(2)(C)
   , added pars. (15) to (17).
   1966—Subsec. (a).
   Pub. L. 89–809
   substituted “, the
   ...
   shall be its
   unrelated business taxable income
   which is effectively connected with the conduct of a trade or business within the United States” for “, the
   unrelated business taxable income
   shall be its
   unrelated business taxable income
   derived from sources within the United States determined under subchapter N (sec. 861 and following), relating to tax based on income from sources within or without the United States”.
   1964—Subsec. (b)(14).
   Pub. L. 88–380
   added par. (14).
   1958—Subsec. (b)(13).
   ...
   Amendment by
   section 11002(d)(1)(Y) of Pub. L. 115–97
   ...
   “(1)
   In general.—
   Except to the extent provided in paragraph (2), the amendment made by this section [amending this section] shall apply to taxable years beginning after
   December 31, 2017
   .
   “(2)
   Carryovers of net operating losses.—
   If any net operating loss arising in a taxable year beginning before
   January 1, 2018
   , is carried over to a taxable year beginning on or after such date—
   “(A)
   subparagraph (A) of section 512(a)(6) of the
   Internal Revenue Code of 1986
   , as added by this Act, shall not apply to such net operating loss, and
   “(B)
   the
   unrelated business taxable income
   of the organization, after the application of subparagraph (B) of such section, shall be reduced by the amount of such net operating loss.”
   ...
   Amendment by
   section 319(c) of Pub. L. 108–357
   applicable to taxable years beginning after
   Oct. 22, 2004
   , see
   ...
   Amendment by
   section 6023(8) of Pub. L. 105–206
   effective
   July 22, 1998
   , see
   ...
   Amendment by
   section 312(d)(5) of Pub. L. 105–34
   applicable to sales and exchanges after
   May 6, 1997
   , with certain exceptions, see section 312(d)[(e)] of
   Pub. L. 105–34
   , set out as a note under
   ...
   111 Stat. 939
   , as amended by
   Pub. L. 105–206, title VI, § 6010(j)(3)
   ,
   July 22, 1998
   ,
   112 Stat. 815
   ...
   “(1)
   In general.—
   Except as provided in paragraph (2), the amendments made by this section [amending this section] shall apply to taxable years beginning after the date of the enactment of this Act [
   Aug. 5, 1997
   ].
   “(2)
   Binding contracts.—
   The amendments made by this section shall not apply to any amount received or accrued during the first 2 taxable years beginning on or after the date of the enactment of this Act if such amount is received or accrued pursuant to a written binding contract in effect on
   June 8, 1997
   , and at all times thereafter before such amount is received or accrued. The preceding sentence shall not apply to any amount which would (but for the exercise of an option to accelerate payment of such amount) be received or accrued after such 2 taxable years.”
   ...
   If—
   “(A)
   for purposes of applying part III of subchapter F of chapter 1 of the
   Internal Revenue Code of 1986
   to any taxable year beginning before
   January 1, 1987
   , an agricultural or horticultural organization did not treat any portion of membership
   dues
   received by it as income derived in an
   unrelated trade or business,
   and
   “(B)
   such organization had a reasonable basis for not treating such
   dues
   as income derived in an
   unrelated trade or business,
   then, for purposes of applying such part III to any such taxable year, in no event shall any portion of such
   dues
   be treated as derived in an
   unrelated trade or business.
   “(3)
   Reasonable basis.—
   For purposes of paragraph (2), an organization shall be treated as having a reasonable basis for not treating membership
   dues
   as income derived in an
   unrelated trade or business
   if the taxpayer’s treatment of such
   dues
   was in reasonable reliance on any of the following:
   “(A)
   Judicial precedent, published rulings, technical advice with respect to the organization, or a letter ruling to the organization.
   “(B)
   A past
   Internal Revenue Service
   audit of the organization in which there was no assessment attributable to the reclassification of membership
   dues
   for purposes of the tax on unrelated business income.
   “(C)
   Long-standing recognized practice of agricultural or horticultural organizations.”
   Amendment by
   section 1316(c) of Pub. L. 104–188
   applicable to taxable years beginning after
   Dec. 31, 1997
   , see
   ...
   Dec. 31, 1985
   , with such amendments treated as a change in the rate of tax imposed by
   chapter 1 of this title
   for purposes of
   section 15 of this title
   , see
   section 511(e)(6) of Pub. L. 98–369
   ...
   , as
   payments with respect to securities loans
   (as defined in subsec. (a)(5) of this section), and transfers of securities, under agreements described in
   ...
   .
   Amendment by
   section 1901(b)(8)(F) of Pub. L. 94–455
   ...
   .
   Amendment by
   section 1951(b)(8)(A) of Pub. L. 94–455
   applicable with respect to taxable years beginning after
   Dec. 31, 1976
   , see
   ...
   section 514 of this title
   ] shall affect any duty, liability, or other requirement imposed under any other Federal or State law. Notwithstanding section 128(b) of the Comprehensive Environmental Response, Compensation, and Liability Act of 1980 [
   42 U.S.C. 9628(b)
   ], a certification provided by the
   Environmental Protection Agency
   or an appropriate State agency (within the meaning of section 198(c)(4) of the
   Internal Revenue Code of 1986
   ) shall not affect the liability of any person under section 107(a) of such Act [
   42 U.S.C. 9607(a)
   ].”
   ...
   December 31, 1975
   , shall be excluded from gross income in determining
   unrelated business taxable income,
   if such income would have been excluded by paragraph (13) or (14) of
   section 512(b)
   if received in a taxable year beginning before such date. Any deductions directly connected with income excluded under the preceding sentence in determining
   unrelated business taxable income
