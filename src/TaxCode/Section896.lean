...
This project request had uuid: d8fa2203-e1b4-4fa3-b3d8-0cdb1f9f6524
-/
...
/-!
# IRC Section 896 - Adjustment of tax on nationals, residents, and corporations of certain foreign countries

This file formalizes IRC §896 (Adjustment of tax on nationals, residents, and corporations of certain foreign countries).

## References
- [26 USC §896](https://www.law.cornell.edu/uscode/text/26/896)
...
## Summary
   ...
   next
   (a)
   Imposition of more burdensome taxes by foreign country
   ...
   (b)
   Imposition of discriminatory taxes by foreign country
   Whenever the President finds that—
   (1)
   ...
   (c)
   Alleviation of more burdensome or discriminatory taxes
   Whenever the President finds that—
   (1)
