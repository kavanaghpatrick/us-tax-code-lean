...
This project request had uuid: ad28ed78-1321-4359-85ce-9e8749cf3483
-/
...
/-!
# IRC Section 585 - Reserves for losses on loans of banks

This file formalizes IRC §585 (Reserves for losses on loans of banks).

## References
- [26 USC §585](https://www.law.cornell.edu/uscode/text/26/585)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 585 - Reserves for losses on loans of banks
   U.S. Code
   Notes
   Authorities (CFR)
   prev
   ...
   bank
   shall be allowed a deduction for a reasonable addition to a reserve for bad debts. Such deduction shall be in lieu of any deduction under section 166(a).
   (2)
   Bank
   ...
   The term “
   bank
   ” also includes any corporation to which subparagraph (A) would apply except for the fact that it is a foreign corporation. In the case of any such foreign corporation, this section shall apply only with respect to loans outstanding the interest on which is effectively connected with the conduct of a banking business within the United States.
   (b)
   ...
   bank
   , this section shall not apply (and no deduction shall be allowed under any other provision of this subtitle for any addition to a reserve for bad debts).
   (2)
   Large banks
   ...
   is a large
   bank
   if, for the taxable year (or for any preceding taxable year beginning after
   December 31, 1986
   )—
   (A)
   the average adjusted bases of all assets of such
   bank
   ...
   and the average adjusted bases of all assets of such group exceeded $500,000,000.
   (3)
   4-year spread of adjustments
   (A)
   In general
   Except as provided in paragraph (4), in the case of any
   bank
   which for its last taxable year before the
   disqualification year
   maintained a reserve for bad debts—
   (i)
   the provisions of this subsection shall be treated as a change in the method of accounting of such
   bank
   for the
   disqualification year
   ,
   ...
   (iii)
   the net amount of adjustments required by section 481(a) to be taken into account by the taxpayer shall be taken into account in each of the 4 taxable years beginning with the
   disqualification year
   with—
   (I)
   ...
   of the
   bank
   as of the close of each quarter of the taxable year, by
   (II)
   the sum of the amounts of
   equity
   of the
   bank
   as of the close of each such quarter.
   In the case of a
   bank
   which is a member of a
   parent-subsidiary controlled group
   for the taxable year, the preceding sentence shall be applied with respect to such group.
   (v)
   Other definitions
   ...
   The term “
   nonperforming loan
   ” means any loan which is considered to be nonperforming by the primary Federal regulatory agency with respect to the
   bank.
   (II)
   Equity
   The term “
   ...
   of the
   bank
   as determined for Federal regulatory purposes.
   (C)
   ...
   If a
   bank
   makes an election under this paragraph for the
   disqualification year
   —
   (A)
   ...
   (B)
   the taxpayer shall continue to maintain its reserve for loans held by the
   bank
   as of the 1st day of the
   disqualification year
   and charge against such reserve any losses resulting from loans held by the
   bank
   as of such 1st day, and
   (C)
   no deduction shall be allowed under this section (or any other provision of this subtitle) for any addition to such reserve for the
   disqualification year
   ...
   The term “
   parent-subsidiary controlled group
   ” means any controlled group of corporations described in
   section 1563(a)(1).
   In determining the average adjusted bases of assets held by such a group, interests held by one member of such group in another member of such group shall be disregarded.
   (B)
   Disqualification year
   The term “
   disqualification year
   ...
   bank,
   the 1st taxable year beginning after
   December 31, 1986
   , for which such
   bank
   was a large
   ...
   if such
   bank
   maintained a reserve for bad debts for the preceding taxable year.
   (C)
   Election made by each member
   In the case of a
   parent-subsidiary controlled group
   , any election under this section shall be made separately by each member of such group.
   (Added
   ...
   90 Stat. 1834
   ;
   Pub. L. 97–34, title II, § 267(a)
   ,
   Aug. 13, 1981
   ,
   95 Stat. 266
   ;
   Pub. L. 99–514, title IX, § 901(a)
   , (d)(1),
   Oct. 22, 1986
   ,
   100 Stat. 2375
   , 2378;
   Pub. L. 100–203, title X, § 10301(b)(2)
   ,
   Dec. 22, 1987
   ,
   101 Stat. 1330–429
   ;
   Pub. L. 100–647, title I, § 1009(a)(2)
   , (3),
   Nov. 10, 1988
   ,
   102 Stat. 3445
   ;
   Pub. L. 101–508, title XI, § 11801(a)(26)
   , (c)(12)(C)–(E),
   Nov. 5, 1990
   ,
   104 Stat. 1388–521
   , 1388–527;
   Pub. L. 104–188, title I, § 1616(b)(6)
   ,
   Aug. 20, 1996
   ,
   110 Stat. 1856
   ...
   1996—Subsec. (a)(2)(A).
   Pub. L. 104–188
   struck out “other than an organization to which section 593 applies” after “section 581)”.
   1990—Subsec. (b)(1).
   Pub. L. 101–508, § 11801(c)(12)(C)
   , substituted “shall not exceed the addition to the reserve for losses on loans determined under the experience method as provided in paragraph (2).” for “shall not exceed the greater of—
   ...
   Subsec. (b)(2).
   Pub. L. 101–508, § 11801(a)(26)
   , (c)(12)(D), redesignated par. (3) as (2) and struck out former par. (2) which related to use of percentage method for determining amount to add to reserve for bad debts.
   Subsec. (b)(3).
   Pub. L. 101–508, § 11801(c)(12)(D)
   , (E), redesignated par. (4) as (3), substituted heading for one which read: “Regulations; definition of eligible loan, etc.”, and amended text generally. Prior to amendment, text read as follows: “The Secretary shall define the terms ‘loan’ and ‘eligible loan’ and prescribe such regulations as may be necessary to carry out the purposes of this section; except that the term ‘eligible loan’ shall not include—
   “(A) a loan to a
   bank
   (as defined in
   section 581
   ...
   “(C) a loan secured by a deposit (i) in the lending
   bank
   , or (ii) in an institution described in subparagraph (A) or (B) if the lending
   bank
   has control over withdrawal of such deposit,
   ...
   Pub. L. 100–647, § 1009(a)(2)(B)
   , substituted “such higher percentage of such net amount as the taxpayer may elect” for “such greater amount as the taxpayer may designate”.
   Subsec. (c)(3)(B)(ii).
   Pub. L. 100–647, § 1009(a)(2)(C)
   , substituted “elects a higher percentage” for “designates an amount”.
   Subsec. (c)(4).
   Pub. L. 100–647, § 1009(a)(3)
   , inserted at end “If the amount of the reserve referred to in subparagraph (B) as of the close of any taxable year exceeds the outstanding balance (as of such time) of the loans referred to in subparagraph (B), such excess shall be included in gross income for such taxable year.”
   Subsec. (c)(5)(C).
   Pub. L. 100–647, § 1009(a)(2)(A)
   , added subpar. (C).
   1987—Subsec. (c)(3)(C).
   Pub. L. 100–203
   substituted “section 6655(e)(2)(A)(i)” for “section 6655(d)(3)”.
   1986—Subsec. (a).
   Pub. L. 99–514, § 901(a)(1)
   , amended subsec. (a) generally. Prior to amendment, subsec. (a) read as follows: “This section shall apply to the following financial institutions:
   “(1) any
   bank
   (as defined in
   section 581
   ) other than an organization to which section 593 applies, and
