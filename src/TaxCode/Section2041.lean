...
This project request had uuid: 14f38644-a4cf-48b2-a777-595be1516c80
-/
...
This file formalizes IRC §2041 (Powers of appointment).

## References
- [26 USC §2041](https://www.law.cornell.edu/uscode/text/26/2041)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 2041 - Powers of appointment
   U.S. Code
   Notes
   prev
   |
   ...
   (1)
   Powers of appointment created on or before
   October 21, 1942
   To the extent of any property with respect to which a
   ...
   by will, or
   (B)
   by a disposition which is of such nature that if it were a transfer of property owned by the decedent, such property would be includible in the decedent’s gross estate under
   sections 2035
   to 2038, inclusive;
   but the failure to exercise such a power or the complete release of such a power shall not be deemed an exercise thereof. If a
   general power of appointment
   created on or before
   October 21, 1942
   , has been partially released so that it is no longer a
   general power of appointment,
   the exercise of such power shall not be deemed to be the exercise of a
   general power of appointment
   if—
   (i)
   ...
   October 21, 1942
   To the extent of any property with respect to which the decedent has at the time of his death a
   general power of appointment
   created after
   October 21, 1942
   ...
   The term “
   general power of appointment
   ” means a power which is exercisable in favor of the decedent, his estate, his creditors, or the creditors of his estate; except that—
   (A)
   A power to consume, invade, or appropriate property for the benefit of the decedent which is limited by an ascertainable standard relating to the health, education, support, or maintenance of the decedent shall not be deemed a
   general power of appointment
   .
   (B)
   A power of appointment created on or before
   October 21, 1942
   , which is exercisable by the decedent only in conjunction with another person shall not be deemed a
   general power of appointment.
   (C)
   ...
   (i)
   If the power is not exercisable by the decedent except in conjunction with the creator of the power—such power shall not be deemed a
   general power of appointment
   .
   (ii)
   If the power is not exercisable by the decedent except in conjunction with a person having a substantial interest in the property, subject to the power, which is adverse to exercise of the power in favor of the decedent—such power shall not be deemed a
   general power of appointment
   . For the purposes of this clause a person who, after the death of the decedent, may be possessed of a power of appointment (with respect to the property subject to the decedent’s power) which he may exercise in his own favor shall be deemed as having an interest in the property and such interest shall be deemed adverse to such exercise of the decedent’s power.
   (iii)
   If (after the application of clauses (i) and (ii)) the power is a
   general power of appointment
   and is exercisable in favor of such other person—such power shall be deemed a
   general power of appointment
   only in respect of a fractional part of the property subject to such power, such part to be determined by dividing the value of such property by the number of such persons (including the decedent) in favor of whom such power is exercisable.
   ...
   68A Stat. 385
   ;
   Pub. L. 87–834, § 18(a)(2)(H)
   ,
   Oct. 16, 1962
   ,
   76 Stat. 1052
   ;
   Pub. L. 94–455, title XX, § 2009(b)(4)(A)
   ,
   Oct. 4, 1976
   ,
   90 Stat. 1894
   ...
   1976—Subsec. (a)(2).
   Pub. L. 94–455
   struck out provision that a disclaimer or renunciation of a power of appointment not be deemed a release of that power.
   1962—Subsec. (a).
   Pub. L. 87–834
