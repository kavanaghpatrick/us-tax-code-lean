...
This project request had uuid: 88fa269e-a626-47ac-9819-1b43bf74ae48
-/
...
/-!
# IRC Section 467 - Certain payments for the use of property or services

This file formalizes IRC §467 (Certain payments for the use of property or services).

## References
- [26 USC §467](https://www.law.cornell.edu/uscode/text/26/467)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 467 - Certain payments for the use of property or services
   U.S. Code
   Notes
   Authorities (CFR)
   prev
   ...
   In the case of the lessor or lessee under any
   section 467
   rental agreement, there shall be taken into account for purposes of this title for any taxable year the sum of—
   (1)
   ...
   Except as provided in paragraph (2), the determination of the amount of the rent under any
   section 467
   rental agreement which accrues during any taxable year shall be made—
   (A)
   ...
   In the case of any section 467 rental agreement to which this paragraph applies, the portion of the rent which accrues during any taxable year shall be that portion of the
   constant rental amount
   with respect to such agreement which is allocable to such taxable year.
   (3)
   ...
   The Secretary shall prescribe regulations setting forth circumstances under which agreements will not be treated as
   disqualified leaseback or long-term agreements
   , including circumstances relating to—
   (A)
   ...
   If—
   (A)
   the lessor under any
   section 467
   rental agreement disposes of any property subject to such agreement during the term of such agreement, and
   (B)
   such agreement is a
   leaseback or long-term agreement
   to which paragraph (2) of subsection (b) did not apply,
   the
   recapture amount
   ...
   , or
   (B)
   the excess of the amount realized (or in the case of a
   disposition
   other than a sale, exchange, or involuntary conversion, the fair market value of the property) over the adjusted basis of such property.
   The amount determined under subparagraph (B) shall be reduced by the amount of any gain treated as ordinary income on the
   disposition
   ...
   (A)
   the amount which would have been taken into account by the lessor under subsection (a) for periods before the
   disposition
   if subsection (b)(2) had applied to the agreement, over
   (B)
   the amount taken into account under subsection (a) by the lessor for periods before the
   disposition
   .
   (4)
   Leaseback or long-term agreement
   For purposes of this subsection, the term “
   leaseback or long-term agreement
   ” means any agreement described in subsection (b)(4)(A).
   (5)
   Special rules
   ...
   or
   1250
   (whichever is appropriate) shall apply for purposes of this subsection,
   (B)
   any transferee in a
   disposition
   excepted by reason of subparagraph (A) who has a transferred basis in the property shall be treated in the same manner as the transferor, and
   (C)
   ...
   section 467
   rental agreements” means any rental agreement for the use of tangible property under which—
   (A)
   ...
   For purposes of the preceding sentence, rules similar to the rules of clauses (ii) and (iii) of
   section 1274(c)(4)(C)
   shall apply.
   (e)
   Definitions
   ...
   The term “
   constant rental amount
   ” means, with respect to any section 467 rental agreement, the amount which, if paid as of the close of each lease period under the agreement, would result in an aggregate present value equal to the present value of the aggregate payments required under the agreement.
   (2)
   Leaseback transaction
   A transaction is a leaseback transaction if it involves a leaseback to any person who had an interest in such property at any time within 2 years before such leaseback (or to a
   related person
   ).
   (3)
   ...
   In the case of property to which
   section 168
   does not apply, subparagraph (A) shall be applied as if section 168 applies to such property.
   (4)
   ...
   The term “
   related person
   ” has the meaning given to such term by section 465(b)(3)(C).
   (6)
   ...
   or
   404A
   (or any other provision specified in regulations) applies.
   (h)
   Regulations
   ...
   (Added
   Pub. L. 98–369, div. A, title I, § 92(a)
   ,
   July 18, 1984
   ,
   98 Stat. 609
   ; amended
   Pub. L. 99–514, title II, § 201(d)(8)
   , title V, § 511(d)(2)(A), title VI, § 631(e)(10), title XVIII, §§ 1807(b), 1879(f)(1),
   Oct. 22, 1986
   ,
   100 Stat. 2141
   , 2248, 2274, 2816, 2906;
   Pub. L. 100–647, title I
   , §§ 1002(i)(2)(H), 1005(c)(10),
   Nov. 10, 1988
   ,
   102 Stat. 3371
   , 3392;
   ...
   1988—Subsec. (c)(5)(C).
   Pub. L. 100–647, § 1005(c)(10)
   , made technical correction to directory language of
   Pub. L. 99–514, § 511(d)(2)(A)
   . See 1986 Amendment note below.
   Subsec. (e)(3)(A).
   Pub. L. 100–647, § 1002(i)(2)(H)
   , at end of table inserted item relating to any railroad grading or tunnel bore.
   1986—Subsec. (b)(4)(A).
   Pub. L. 99–514, § 1807(b)(2)(A)
   , substituted “statutory recovery period” for “statutory recover period”.
   Subsec. (c)(4).
   Pub. L. 99–514, § 1807(b)(2)(B)
   , substituted “subsection (b)(4)(A)” for “subsection (b)(3)(A)”.
   Subsec. (c)(5)(C).
   Pub. L. 99–514, § 631(e)(10)
   , struck out “453B(d)(2),” after “341(e)(12),”.
   Pub. L. 99–514, § 511(d)(2)(A)
   , as amended by
   Pub. L. 100–647, § 1005(c)(10)
   , struck out “163(d),” after “sections”.
   Subsec. (d)(2).
   Pub. L. 99–514, § 1807(b)(2)(C)
   , substituted “section 1274(c)(4)(C)” for “section 1274(c)(2)(C)”.
   Subsec. (e)(3)(A).
   Pub. L. 99–514, § 201(d)(8)(A)
   ...
   Amendment by
   section 201(d)(8) of Pub. L. 99–514
   ...
   .
   Amendment by
   section 511(d)(2)(A) of Pub. L. 99–514
   ...
   .
   Amendment by
   section 631(e)(10) of Pub. L. 99–514
   ...
   .
   Amendment by
   section 1807(b) of Pub. L. 99–514
   ...
   section 103 of Public Law 99–121
   .”
   Effective Date
   Pub. L. 98–369, div. A, title I, § 92(c)
   ,
   July 18, 1984
   ,
   98 Stat. 612
   ...
   “(A)
   In general.—
   In any case to which paragraph (2)(B) applies, for purposes of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954], the lessor shall be treated as having received or accrued (and the lessee shall be treated as having paid or incurred) rents equal to the greater of—
   “(i)
