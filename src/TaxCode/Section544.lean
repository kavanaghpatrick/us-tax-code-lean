...
This project request had uuid: 511c3fb9-6028-4eba-b87e-03e3f11dae65
-/
...
/-!
# IRC Section 544 - Rules for determining stock ownership

This file formalizes IRC §544 (Rules for determining stock ownership).

## References
- [26 USC §544](https://www.law.cornell.edu/uscode/text/26/544)
...
## Summary
   ...
   , insofar as such determination is based on stock ownership under section 542(a)(2), section 543(a)(7), section 543(a)(6), or
   section 543(a)(4)
   —
   (1)
   ...
   (A)
   for purposes of the stock ownership requirement provided in section 542(a)(2), if, but only if, the effect is to make the corporation a
   personal holding company
   ;
   (B)
   for purposes of section 543(a)(7) (relating to personal
   service contracts
   ), of section 543(a)(6) (relating to use of property by shareholders), or of section 543(a)(4) (relating to copyright royalties), if, but only if, the effect is to make the amounts therein referred to includible under such paragraph as
   ...
   (1)
   for purposes of the stock ownership requirement provided in section 542(a)(2), but only if the effect of the inclusion of all such securities is to make the corporation a
   personal holding company
   ;
   (2)
   for purposes of section 543(a)(7) (relating to personal
   service contracts
   ), but only if the effect of the inclusion of all such securities is to make the amounts therein referred to includible under such paragraph as
   personal holding company income;
   (3)
   for purposes of section 543(a)(6) (relating to the use of property by shareholders), but only if the effect of the inclusion of all such securities is to make the amounts therein referred to includible under such paragraph as
   personal holding company income
   ; and
   (4)
   for purposes of section 543(a)(4) (relating to copyright royalties), but only if the effect of the inclusion of all such securities is to make the amounts therein referred to includible under such paragraph as
   personal holding company income
   .
   ...
   1964—
   Pub. L. 88–272
   substituted “section 543(a)(7)” for “section 543(a)(5)”, and “section 543(a)(4)” for “section 543(a)(9),” wherever appearing.
   1960—Subsec. (a).
   Pub. L. 86–435, § 1(c)(1)
   , inserted reference to section 543(a)(9) in introductory provisions.
   Subsec. (a)(4)(B).
   Pub. L. 86–435, § 1(c)(2)
   , included reference to section 543(a)(9).
   Subsec. (b).
   Pub. L. 86–435, § 1(d)
   , added par. (4), and inserted reference to par. (4) in last sentence.
