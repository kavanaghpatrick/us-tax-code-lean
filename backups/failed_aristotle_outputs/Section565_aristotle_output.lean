...
This project request had uuid: 6513916f-5f27-487a-b3ce-084c74241ac6
-/
...
/-!
# IRC Section 565 - Consent dividends

This file formalizes IRC §565 (Consent dividends).

## References
- [26 USC §565](https://www.law.cornell.edu/uscode/text/26/565)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 565 - Consent dividends
   U.S. Code
   Notes
   prev
   | next
   ...
   (1)
   an amount specified in a consent which, if distributed in money, would constitute, or be part of, a distribution which would be disqualified for purposes of the dividends paid deduction under section 562(c) (relating to preferential dividends), or
   (2)
   an amount specified in a consent which would not constitute a dividend (as defined in section 316) if the total amounts specified in consents filed by the corporation had been distributed in money to shareholders on the last day of the taxable year of such corporation.
   (c)
   Effect of consent
   The amount of a consent dividend shall be considered, for purposes of this title—
   (1)
   as distributed in money by the corporation to the shareholder on the last day of the taxable year of the corporation, and
   (2)
   as contributed to the capital of the corporation by the shareholder on such day.
   (d)
