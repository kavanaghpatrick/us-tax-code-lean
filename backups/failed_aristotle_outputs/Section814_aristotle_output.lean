...
This project request had uuid: bf80a964-9a61-4f2c-9695-64c7b4957847
-/
...
/-!
# IRC Section 814 - Contiguous country branches of domestic life insurance companies

This file formalizes IRC §814 (Contiguous country branches of domestic life insurance companies).

## References
- [26 USC §814](https://www.law.cornell.edu/uscode/text/26/814)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 814 - Contiguous country branches of domestic life insurance companies
   U.S. Code
   Notes
   prev
   |
   ...
   there shall be excluded from each item involved in the determination of
   life insurance company taxable income
   the items separately accounted for in accordance with subsection (c).
   (b)
   ...
   issues
   insurance contracts
   insuring risks in connection with the lives or health of residents of a country which is contiguous to the United States,
   (2)
   ...
   insurance contract
   ” means any life, health, accident, or
   annuity contract
   or reinsurance contract or any contract relating thereto.
   (c)
   ...
   tentative LICTI
   of the domestic life insurance company for the taxable year and for all prior taxable years resulting solely from the application of subsection (a) of this section with respect to such branch, exceeds
   (ii)
   the amount of additions to
   tentative LICTI
   pursuant to subparagraph (A) with respect to such contiguous country branch for all prior taxable years.
   (C)
   Transitional rule
   For purposes of this paragraph, in the case of a prior taxable year beginning before
   January 1, 1984
   , the term
   “tentative LICTI”
   means
   life insurance company taxable income
   determined under this part (as in effect for such year) without regard to this paragraph.
   (f)
   Other rules
   (1)
   ...
   98 Stat. 744
   ; amended
   Pub. L. 105–34, title XI, § 1131(c)(1)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 980
   ;
   Pub. L. 115–97, title I, § 14301(c)(5)
   ,
   Dec. 22, 2017
   ,
   131 Stat. 2222
   ...
   2017—Subsec. (f)(1).
   Pub. L. 115–97
   redesignated subpar. (A) as par. (1), struck out subpar. (A) heading “In general”, and struck out subpar. (B). Prior to amendment, text of subpar. (B) read as follows: “For purposes of sections 78 and 902, where any amount is added to the
   life insurance company taxable income
   of the domestic life insurance company by reason of subsection (e)(2), the contiguous country life insurance branch shall be treated as a foreign corporation. Any amount so added shall be treated as a dividend paid by a foreign corporation, and the taxes paid to any foreign country or possession of the United States with respect to such amount shall be deemed to have been paid by such branch.”
   1997—Subsec. (h).
   Pub. L. 105–34
   struck out “or 1491” after “section 367”.
   Statutory Notes and Related Subsidiaries
   New
   Section 814
   Treated as Continuation of Section 819A
   Pub. L. 98–369, div. A, title II, § 217(a)
   ,
   July 18, 1984
   ,
   98 Stat. 762
   ...
   100 Stat. 2095
   , provided that:
   “For purposes of section 814 of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] (relating to contiguous country branches of domestic life insurance companies)—
   “(1)
   any election under section 819A of such Code (as in effect on the day before the date of the enactment of this Act [
   July 18, 1984
   ]) shall be treated as an election under such section 814, and
   “(2)
   any reference to a provision of such
   section 814
