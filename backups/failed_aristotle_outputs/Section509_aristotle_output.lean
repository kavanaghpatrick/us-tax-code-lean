...
This project request had uuid: 326b2abb-b64f-460e-93d8-e905f2408ee3
-/
...
This file formalizes IRC §509 (Private foundation defined).

## References
- [26 USC §509](https://www.law.cornell.edu/uscode/text/26/509)
...
## Summary
   ...
   support
   in each taxable year from any combination of—
   (i)
   gifts, grants, contributions, or membership fees, and
   (ii)
   gross receipts from admissions, sales of merchandise, performance of services, or furnishing of facilities, in an activity which is not an unrelated trade or business (within the meaning of section 513), not including such receipts from any person, or from any bureau or similar agency of a governmental unit (as described in section 170(c)(1)), in any taxable year to the extent such receipts exceed the greater of $5,000 or 1 percent of the organization’s
   support
   in such taxable year,
   from persons other than disqualified persons (as defined in
   section 4946
   ) with respect to the organization, from governmental units described in section 170(c)(1), or from organizations described in section 170(b)(1)(A) (other than in clauses (vii) and (viii)), and
   (B)
   ...
   (C)
   is not controlled directly or indirectly by one or more disqualified persons (as defined in
   section 4946
   ) other than foundation managers and other than one or more organizations described in paragraph (1) or (2); and
   (4)
   ...
   For purposes of this title, if an organization is a
   private foundation
   (within the meaning of subsection (a)) on
   October 9, 1969
   , or becomes a
   private foundation
   on any subsequent date, such organization shall be treated as a
   private foundation
   for all periods after
   October 9, 1969
   , or after such subsequent date, unless its status as such is terminated under section 507.
   (c)
   ...
   is terminated under
   section 507
   shall (except as provided in section 507(b)(2)) be treated as an organization created on the day after the date of such termination.
   (d)
   Definition of support
   For purposes of this part and chapter 42, the term “
   support
   ” includes (but is not limited to)—
   (1)
   gifts, grants, contributions, or membership fees,
   (2)
   gross receipts from admissions, sales of merchandise, performance of services, or furnishing of facilities in any activity which is not an unrelated trade or business (within the meaning of
   section 513
   ),
   (3)
   ...
   (6)
   the value of services or facilities (exclusive of services or facilities generally furnished to the public without charge) furnished by a governmental unit referred to in
   section 170(c)(1)
   to an organization without charge.
   Such term does not include any gain from the sale or other
   disposition
   of property which would be considered as gain from the sale or exchange of a capital asset, or the value of exemption from any Federal, State, or local tax or any similar benefit.
   (e)
   Definition of gross investment income
   For purposes of subsection (d), the term “
   gross investment income
   ” means the gross amount of income from interest, dividends, payments with respect to securities loans (as defined in
   section 512(a)(5)
   ), rents, and royalties, but not including any such income to the extent included in computing the tax imposed by section 511. Such term shall also include income from sources similar to those in the preceding sentence.
   (f)
   ...
   (A)
   Responsiveness
   For each taxable year beginning after the date of the enactment of this subsection, the organization provides to each
   supported organization
   such information as the Secretary may require to ensure that such organization is responsive to the needs or demands of the
   supported organization
   .
   (B)
   ...
   (i)
   In general
   The organization is not operated in connection with any
   supported organization
   ...
   supported organization
   of an organization described in subparagraph (A), such person is—
   (i)
   a person (other than an organization described in paragraph (1), (2), or (4) of
   section 509(a)
   ) who directly or indirectly controls, either alone or together with persons described in clauses (ii) and (iii), the governing body of such
   supported organization,
   (ii)
   a member of the family (determined under section 4958(f)(4)) of an individual described in clause (i), or
   (iii)
   a 35-percent controlled entity (as defined in
   section 4958(f)(3)
   by substituting “persons described in clause (i) or (ii) of section 509(f)(2)(B)” for “persons described in subparagraph (A) or (B) of paragraph (1)” in subparagraph (A)(i) thereof).
   (3)
   Supported organization
   For purposes of this subsection, the term “
   supported organization
   ” means, with respect to an organization described in subsection (a)(3), an organization described in paragraph (1) or (2) of subsection (a)—
   (A)
   ...
   Pub. L. 109–280
   , which directed the amendment of section 509 without specifying the act to be amended, were executed to this section, which is section 509 of the
   ...
   , amended subpar. (B) generally. Prior to amendment, subpar. (B) read as follows: “is operated, supervised, or controlled by or in connection with one or more organizations described in paragraph (1) or (2), and”. See Codification note above.
   Subsec. (e).
   Pub. L. 109–280, § 1221(a)(2)
   , inserted at end “Such term shall also include income from sources similar to those in the preceding sentence.” See Codification note above.
   Subsec. (f).
   Pub. L. 109–280, § 1241(b)
   , added subsec. (f). See Codification note above.
   1978—Subsec. (e).
   Pub. L. 95–345
   ...
   “(A)
   in the case of trusts operated in connection with an organization described in paragraph (1) or (2) of section 509(a) of the
   Internal Revenue Code of 1986
   on the date of the enactment of this Act, on the date that is one year after the date of the enactment of this Act, and
   “(B)
   ...
   and amending sections 509, 512, 514, 851, and 4940 of this title] apply with respect to—
   “(1)
   amounts received after
   December 31, 1976
   , as payments with respect to securities loans (as defined in section 512(a)(5) of the
   Internal Revenue Code of 1986
   ...
   120 Stat. 1103
   , provided that:
   “For purposes of section 509(a)(3)(B)(iii) of the
   Internal Revenue Code of 1986
   , an organization which is a trust shall not be considered to be operated in connection with any organization described in paragraph (1) or (2) of section 509(a) of such Code solely because—
   “(1)
   it is a charitable trust under State law,
   “(2)
   the
   supported organization
   (as defined in section 509(f)(3) of such Code) is a beneficiary of such trust, and
   “(3)
   the
   supported organization
   (as so defined) has the power to enforce the trust and compel an accounting.”
   ...
   “(1)
   In general.—
   The Secretary of the Treasury shall promulgate new regulations under section 509 of the
   Internal Revenue Code of 1986
   on payments required by type III supporting organizations which are not functionally integrated type III supporting organizations. Such regulations shall require such organizations to make distributions of a percentage of either income or assets to
   supported organizations
   (as defined in section 509(f)(3) of such Code) in order to ensure that a significant amount is paid to such organizations.
   “(2)
   Type iii supporting organization; functionally integrated type iii supporting organization.—
   For purposes of paragraph (1), the terms ‘type III supporting organization’ and ‘functionally integrated type III supporting organization’ have the meanings given such terms under subparagraphs (A) and (B) section 4943(f)(5) of the
   Internal Revenue Code of 1986
   (as added by this Act), respectively.”
   U.S. Code Toolbox
