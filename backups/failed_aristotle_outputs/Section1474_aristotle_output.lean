...
This project request had uuid: 79b453f4-b9b8-46a5-bebb-cbc34322a71f
-/
...
/-!
# IRC Section 1474 - Special rules

This file formalizes IRC §1474 (Special rules).

## References
- [26 USC §1474](https://www.law.cornell.edu/uscode/text/26/1474)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 1474 - Special rules
   U.S. Code
   Notes
   Authorities (CFR)
   prev
   ...
   (A)
   In general
   In the case of any tax properly deducted and withheld under
   section 1471
   from a
   ...
   The term “
   specified financial institution payment
   ” means any payment if the beneficial owner of such payment is a foreign financial institution.
   (3)
   Requirement to identify substantial United States owners
   No credit or refund shall be allowed or paid with respect to any tax properly deducted and withheld under this chapter unless the beneficial owner of the payment provides the Secretary such information as the Secretary may require to determine whether such beneficial owner is a United States owned
   foreign entity
   (as defined in section 1471(d)(3)) and the identity of any
   ...
   The identity of a foreign financial institution which meets the requirements of
   section 1471(b)
   shall not be treated as return information for purposes of section 6103.
   (d)
   ...
   Any tax deducted and withheld pursuant to an agreement described in
   section 1471(b)
   shall be treated for purposes of this title as a tax deducted and withheld by a
   withholding agent
   ...
   Editorial Notes
   Prior Provisions
   For prior sections 1481 and 1482, see Prior Provisions note preceding
