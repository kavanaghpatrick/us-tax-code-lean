...
This project request had uuid: e8a8b302-dd4f-4331-a64b-ed37ce7259e2
-/
...
/-!
# IRC Section 1382 - Taxable income of cooperatives

This file formalizes IRC §1382 (Taxable income of cooperatives).

## References
- [26 USC §1382](https://www.law.cornell.edu/uscode/text/26/1382)
...
## Summary
   ...
   (as defined in
   section 1388(a)
   ), to the extent paid in money, qualified written notices of allocation (as defined in section 1388(c)), or other property (except nonqualified written notices of allocation (as defined in section 1388(d))) with respect to patronage occurring during such taxable year;
   (2)
   ...
   which was paid as a
   patronage dividend
   during the payment period for the taxable year during which the patronage occurred;
   (3)
   as
   per-unit retain allocations
   (as defined in
   section 1388(f)
   ), to the extent paid in money,
   qualified per-unit retain certificates
   (as defined in section 1388(h)), or other property (except
   nonqualified per-unit retain certificates,
   as defined in section 1388(i)) with respect to marketing occurring during such taxable year; or
   (4)
   in money or other property (except
   per-unit retain certificates
   ) in redemption of a
   nonqualified per-unit retain certificate
   which was paid as a
   per-unit retain allocation
   during the payment period for the taxable year during which the marketing occurred.
   ...
   in money or other property (except written notices of allocation) in redemption of a
   nonqualified written notice of allocation
   which was paid, during the payment period for the taxable year during which the earnings were derived, on a patronage basis to a patron with respect to earnings derived from business or sources described in subparagraph (A).
   (d)
   Payment period for each taxable year
   For purposes of subsections (b) and (c)(2), the payment period for any taxable year is the period beginning with the first day of such taxable year and ending with the fifteenth day of the ninth month following the close of such year. For purposes of subsections (b)(1) and (c)(2)(A), a
   qualified check
   issued during the payment period shall be treated as an amount paid in money during such period if endorsed and cashed on or before the 90th day after the close of such period.
   (e)
   ...
   section 1381(a)
   which is engaged in pooling arrangements for the marketing of products may compute its taxable income with respect to any pool opened prior to
   March 1, 1978
   , under the
   ...
   completed crop pool method of accounting
   ” means a method of accounting under which gain or loss is computed separately for each crop year pool in the year in which the last of the products in the pool are disposed of.
   (Added
   Pub. L. 87–834, § 17(a)
   ,
   Oct. 16, 1962
   ...
   1969—Subsec. (b)(3).
   Pub. L. 91–172
   expanded the category of
   per-unit retain allocations
   that may not be taken into account in determining the taxable income of an organization, by including
   per-unit retain allocations
   paid for in money or other property (except
   nonqualified per-unit retain certificates
   as defined in section 1388(i) of this section).
   1966—Subsec. (a).
   Pub. L. 89–809, § 211(a)(1)
   , inserted reference to amounts paid to patrons as a
   per-unit retain allocation
   as defined in section 1388(f).
   Subsec. (b).
   Pub. L. 89–809, § 211(a)(2)
   , inserted “and
   per-unit retain allocations”
   in heading, added pars. (3) and (4), and, in text following par. (4), inserted provisions making existing text applicable only to amounts described in pars. (1) and (2) and inserted text covering the treatment of amounts described in pars. (3) and (4).
   Subsec. (e).
   Pub. L. 89–809, § 211(a)(3)
   , inserted provision that the marketing of products shall be treated as occurring during any of the taxable years in which the pool is open.
   Subsec. (f).
   Pub. L. 89–809, § 211(a)(4)
   , substituted “paragraphs (1) and (2) of subsection (b)” for “subsection (b)”.
   Statutory Notes and Related Subsidiaries
   Effective Date of 1969 Amendment
   Pub. L. 91–172, title IX, § 911(c)
   ,
   Dec. 30, 1969
   ,
   83 Stat. 722
   ...
   per-unit retain allocations
   made during taxable years of an organization described in section 1381(a) (relating to organizations to which part I of subchapter T of chapter 1 applies) beginning after
   April 30, 1966
   , with respect to products delivered during such years.
   “(2)
   The amendments made by subsection (d) [amending
   section 6044 of this title
   ] shall apply with respect to calendar years after 1966.”
   Effective Date
