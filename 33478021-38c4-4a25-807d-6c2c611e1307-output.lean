...
This project request had uuid: 33478021-38c4-4a25-807d-6c2c611e1307
-/
...
/-!
# IRC Section 513 - Unrelated trade or business

This file formalizes IRC §513 (Unrelated trade or business).

## References
- [26 USC §513](https://www.law.cornell.edu/uscode/text/26/513)
...
## Summary
   ...
   section 501
   (or, in the case of an organization described in section 511(a)(2)(B), to the exercise or performance of any purpose or function described in section 501(c)(3)), except that such term does not include any
   trade or business—
   (1)
   in which substantially all the work in carrying on such
   trade or business
   is performed for the organization without compensation; or
   (2)
   which is carried on, in the case of an organization described in
   section 501(c)(3)
   or in the case of a college or university described in section 511(a)(2)(B), by the organization primarily for the convenience of its members, students, patients, officers, or employees, or, in the case of a local association of employees described in section 501(c)(4) organized before
   May 27, 1969
   ...
   (1)
   a trust computing its
   unrelated business taxable income
   under
   section 512
   for purposes of section 681; or
   (2)
   a trust described in section 401(a), or section 501(c)(17), which is exempt from tax under section 501(a);
   any
   trade or business
   regularly carried on by such trust or by a partnership of which it is a member.
   (c)
   Advertising, etc., activities
   For purposes of this section, the term “
   trade or business
   ” includes any activity which is carried on for the production of income from the sale of goods or the performance of services. For purposes of the preceding sentence, an activity does not lose identity as a
   trade or business
   merely because it is carried on within a larger aggregate of similar activities or within a larger complex of other endeavors which may, or may not, be related to the exempt purposes of the organization. Where an activity carried on for profit constitutes an unrelated
   trade or business
   , no part of such
   trade or business
   shall be excluded from such classification merely because it does not result in profit.
   (d)
   ...
   The term “unrelated
   trade or business
   ” does not include qualified public entertainment activities of an organization described in paragraph (2)(C), or qualified convention and trade show activities of an organization described in paragraph (3)(C).
   (2)
   ...
   The term “
   public entertainment activity
   ” means any entertainment or recreational activity of a kind traditionally conducted at fairs or expositions promoting agricultural and educational purposes, including, but not limited to, any activity one of the purposes of which is to attract the public to fairs or expositions or to promote the breeding of animals or the development of products or equipment.
   (B)
   ...
   section 501(c)
   (3), (4), or (5) which regularly conducts, as one of its substantial exempt purposes, an agricultural and educational fair or exposition.
   (3)
   ...
   For purposes of this paragraph, the term “
   qualifying organization
   ” means an organization described in section 501(c)(3), (4), (5), or (6) which regularly conducts as one of its substantial exempt purposes a show which stimulates interest in, and demand for, the products of a particular industry or segment of such industry or which educates persons in attendance regarding new developments or products and services related to the exempt activities of the organization.
   (4)
   Such activities not to affect exempt status
   An organization described in
   section 501(c)
   (3), (4), or (5) shall not be considered as not entitled to the exemption allowed under section 501(a) solely because of qualified public entertainment activities conducted by it.
   (e)
   Certain hospital services
   In the case of a hospital described in section 170(b)(1)(A)(iii), the term “unrelated
   trade or business
   ” does not include the furnishing of one or more of the services described in
   section 501(e)(1)(A)
   to one or more hospitals described in section 170(b)(1)(A)(iii) if—
   (1)
   ...
   In the case of a mutual or cooperative telephone or electric company, the term “unrelated
   trade or business
   ...
   (1)
   In general
   In the case of an organization which is described in section 501 and contributions to which are deductible under paragraph (2) or (3) of section 170(c), the term “unrelated
   trade or business
   ” does not include—
   (A)
   activities relating to the distribution of
   low cost articles
   if the distribution of such articles is incidental to the solicitation of charitable contributions, or
   (B)
   any
   trade or business
   which consists of—
   ...
   The term “
   low cost article
   ” means any article which has a cost not in excess of $5 to the organization which distributes such item (or on whose behalf such item is distributed).
   (B)
   Aggregation rule
   ...
   For purposes of this subsection, any distribution of
   low cost articles
   by an organization shall be treated as a distribution incidental to the solicitation of charitable contributions only if—
   (A)
   ...
   (i)
   a request for a charitable contribution (as defined in
   section 170(c)
   ) by the distributee to such organization, and
   (ii)
   a statement that the distributee may retain the
   low cost article
   regardless of whether such distributee makes a charitable contribution to such organization.
   (i)
   ...
   ” means any payment made by any person engaged in a
   trade or business
   with respect to which there is no arrangement or expectation that such person will receive any substantial return benefit other than the use or acknowledgement of the name or logo (or product lines) of such person’s
   trade or business
   ...
   The term “
   qualified sponsorship payment
   ” does not include any payment if the amount of such payment is contingent upon the level of attendance at one or more events, broadcast ratings, or other factors indicating the degree of public exposure to one or more events.
   (ii)
   ...
   ” does not include—
   (I)
   any payment which entitles the payor to the use or acknowledgement of the name or logo (or product lines) of the payor’s
   trade or business
   in regularly scheduled and printed material published by or on behalf of the payee organization that is not related to and primarily distributed in connection with a specific event conducted by the payee organization, or
   (II)
   ...
   For purposes of this subsection, to the extent that a portion of a payment would (if made as a separate payment) be a
   qualified sponsorship payment
   , such portion of such payment and the other portion of such payment shall be treated as separate payments.
   (j)
   Debt management plan services
   The term “unrelated
   trade or business
   ” includes the provision of debt management plan services (as defined in
   section 501(q)(4)(B)
   ) by any organization other than an organization which meets the requirements of section 501(q).
   (Aug. 16, 1954, ch. 736,
   68A Stat. 172
   ;
   Pub. L. 86–667, § 4
   ...
   90 Stat. 1716
   , 1729;
   Pub. L. 95–502, title III, § 301(a)
   ,
   Oct. 21, 1978
   ,
   92 Stat. 1702
   ;
   Pub. L. 96–605, title I, § 106(b)
   ,
   Dec. 28, 1980
   ,
   94 Stat. 3524
   ;
   Pub. L. 99–514, title XVI
   , §§ 1601(a), 1602(a), (b),
   Oct. 22, 1986
   ,
   100 Stat. 2766
   , 2767;
   Pub. L. 101–508, title XI, § 11101(d)(1)(G)
   ,
   Nov. 5, 1990
   ,
   104 Stat. 1388–405
   ;
   Pub. L. 103–66, title XIII, § 13201(b)(3)(H)
   ,
   Aug. 10, 1993
   ,
   107 Stat. 459
   ;
   Pub. L. 105–34, title IX, § 965(a)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 893
   ;
   Pub. L. 109–280, title XII, § 1220(b)
   ,
   Aug. 17, 2006
   ,
   120 Stat. 1088
   ;
   Pub. L. 115–97, title I, § 11002(d)(1)(Z)
   ,
   Dec. 22, 2017
   ,
   131 Stat. 2060
   ...
   applicable to taxable years beginning after
   Aug. 17, 2006
   , with transition rule for existing organizations, see
   section 1220(c) of Pub. L. 109–280
   , set out as a note under
