...
This project request had uuid: 77e2b5ae-fcbb-44c1-aefa-19f6a39354dd
-/
...
/-!
# IRC Section 1377 - Definitions and special rule

This file formalizes IRC §1377 (Definitions and special rule).

## References
- [26 USC §1377](https://www.law.cornell.edu/uscode/text/26/1377)
...
## Summary
   ...
   (A)
   In general
   Under regulations prescribed by the Secretary, if any shareholder terminates the shareholder’s interest in the corporation during the taxable year and all
   affected shareholders
   and the corporation agree to the application of this paragraph, paragraph (1) shall be applied to the
   affected shareholders
   as if the taxable year consisted of 2 taxable years the first of which ends on the date of the termination.
   (B)
   Affected shareholders
   For purposes of subparagraph (A), the term “
   affected shareholders
   ” means the shareholder whose interest is terminated and all shareholders to whom such shareholder has transferred shares during the taxable year. If such shareholder has transferred shares to the corporation, the term “
   affected shareholders
   ” shall include all persons who are shareholders during the taxable year.
   (b)
   ...
   (B)
   the 120-day period beginning on the date of any
   determination
   pursuant to an audit of the taxpayer which follows the termination of the corporation’s election and which adjusts a subchapter S item of income, loss, or deduction of the corporation arising during the S period (as defined in
   section 1368(e)(2)
   ), and
   (C)
   the 120-day period beginning on the date of a
   determination
   that the corporation’s election under
   section 1362(a)
   ...
   a
   determination
   as defined in section 1313(a), or
   (B)
   ...
   72 Stat. 1656
   ; amended
   Pub. L. 94–455, title IX, § 902(b)(1)
   , title XIX, § 1901(b)(32)(B)(iv),
   Oct. 4, 1976
   ,
   90 Stat. 1608
   , 1800, related to special rules applicable to earnings and profits of electing
   ...
   Subsec. (b)(1)(A) to (C).
   Pub. L. 104–188, § 1307(a)
   , struck out “and” at end of subpar. (A)(ii), added subpar. (B), and redesignated former subpar. (B) as (C).
   Subsec. (b)(2)(A) to (C).
   Pub. L. 104–188, § 1307(b)
   , added subpar. (A), redesignated subpar. (C) as (B), and struck out former subpars. (A) and (B) which read as follows:
   ...
   section 407(c) of Pub. L. 108–311
   , set out as a note under
   section 401 of this title
   .
   Effective Date of 1996 Amendments
   Pub. L. 105–34, title XVI, § 1601(c)(2)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 1087
   , provided that:
   “(A)
   Notwithstanding section 1317 of the
   Small Business Job Protection Act of 1996
   [
   Pub. L. 104–188
   , enacting provisions set out as notes under sections 641 and 1362 of this title], the amendments made by subsections (a) and (b) of section 1307 of such Act [amending this section] shall apply to
   determinations
   made after
   December 31, 1996
   .
   “(B)
   In no event shall the 120-day period referred to in section 1377(b)(1)(B) of the
   Internal Revenue Code of 1986
   (as added by such section 1307) expire before the end of the 120-day period beginning on the date of the enactment of this Act [
   Aug. 5, 1997
   ].”
   Amendment by
   Pub. L. 104–188
