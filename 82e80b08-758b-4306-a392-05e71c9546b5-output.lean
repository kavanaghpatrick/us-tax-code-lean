...
This project request had uuid: 82e80b08-758b-4306-a392-05e71c9546b5
-/
...
This file formalizes IRC §351 (Transfer to corporation controlled by transferor).

## References
- [26 USC §351](https://www.law.cornell.edu/uscode/text/26/351)
...
## Summary
   ...
   (a)
   General rule
   No gain or loss shall be recognized if property is transferred to a corporation by one or more persons solely in exchange for stock in such corporation and immediately after the exchange such person or persons are in
   control
   ...
   investment company
   . For purposes of the preceding sentence, the determination of whether a company is an
   investment company
   shall be made—
   (A)
   by taking into account all stock and
   securities
   held by the company, and
   (B)
   by treating as stock and
   securities
   —
   (i)
   money,
   ...
   section 7704(b)
   ) or any other equity interest (other than in a corporation) which pursuant to its terms or any other arrangement is readily convertible into, or exchangeable for, any asset described in any preceding clause, this clause or clause (v) or (viii),
   (v)
   ...
   A transfer of property of a debtor pursuant to a plan while the debtor is under the jurisdiction of a court in a
   title 11 or similar case
   (within the meaning of
   section 368(a)(3)(A)
   ), to the extent that the stock received in the exchange is used to satisfy the indebtedness of such debtor.
   (f)
   ...
   section 311
   shall apply to any transfer in such exchange by the controlled corporation in the same manner as if such transfer were a distribution to which subpart A of part I applies.
   (g)
   ...
   (B)
   if (and only if) the transferor receives stock other than nonqualified
   preferred stock
   —
   (i)
   ...
   such nonqualified
   preferred stock
   shall be treated as other property for purposes of applying subsection (b).
   (2)
   Nonqualified preferred stock
   For purposes of paragraph (1)—
   (A)
   In general
   The term “nonqualified
   preferred stock
   ” means
   preferred stock
   if—
   ...
   (I)
   a corporation if any class of stock in such corporation or a related party is readily tradable on an established
   securities
   ...
   , and
   356(e)
   . The Secretary may also prescribe regulations, consistent with the treatment under this subsection and such sections, for the treatment of nonqualified
   preferred stock
   ...
   68A Stat. 111
   ;
   Pub. L. 89–809, title II, § 203(a)
   , (b),
   Nov. 13, 1966
   ,
   80 Stat. 1577
   ;
   Pub. L. 94–455, title XIX, § 1901(a)(48)(A)
   , (B),
   Oct. 4, 1976
   ,
   90 Stat. 1772
   ...
   94 Stat. 3406
   ;
   Pub. L. 97–248, title II, § 226(a)(1)(B)
   ,
   Sept. 3, 1982
   ,
   96 Stat. 491
   ...
   102 Stat. 3580
   ;
   Pub. L. 101–239, title VII, § 7203(a)
   , (b),
   Dec. 19, 1989
   ,
   103 Stat. 2333
   ;
   Pub. L. 101–508, title XI, § 11704(a)(3)
   ,
   Nov. 5, 1990
   ,
   104 Stat. 1388–518
   ...
   , §§ 1002(a), 1012(c)(1), 1014(a),
   Aug. 5, 1997
   ,
   111 Stat. 909
   , 916, 919;
   Pub. L. 105–206, title VI, § 6010(c)(3)(A)
   , (e)(1),
   July 22, 1998
   ,
   112 Stat. 813
   , 814;
   Pub. L. 105–277, div. J, title IV, § 4003(f)(1)
   ,
   Oct. 21, 1998
   ,
   112 Stat. 2681–910
   ;
   Pub. L. 106–36, title III, § 3001(d)(1)
   ,
   June 25, 1999
   ,
   113 Stat. 183
   ;
   Pub. L. 107–147, title IV, § 417(9)
   ,
   Mar. 9, 2002
   ,
   116 Stat. 56
   ;
   Pub. L. 108–357, title VIII, § 899(a)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1649
   ;
   Pub. L. 109–135, title IV, § 403(kk)
   ,
   Dec. 21, 2005
   ,
   119 Stat. 2632
   ...
   2005—Subsec. (g)(3)(A).
   Pub. L. 109–135
   inserted at end “If there is not a real and meaningful likelihood that dividends beyond any limitation or preference will actually be paid, the possibility of such payments will be disregarded in determining whether stock is limited and preferred as to dividends.”
   2004—Subsec. (g)(3)(A).
   Pub. L. 108–357
   inserted at end “Stock shall not be treated as participating in corporate growth to any significant extent unless there is a real and meaningful likelihood of the shareholder actually participating in the earnings and growth of the corporation.”
   2002—Subsec. (h)(1).
   Pub. L. 107–147
   inserted comma after “liability”.
   1999—Subsec. (h)(1).
   Pub. L. 106–36
   struck out “, or acquires property subject to a liability,” after “liability”.
   1998—Subsec. (c).
   Pub. L. 105–206, § 6010(c)(3)(A)
   , reenacted heading without change and amended text generally. Prior to amendment, text read as follows: “In determining
   control
   for purposes of this section—
   ...
   section 355
   are met with respect to such distribution, the shareholders shall be treated as in
   control
   of such corporation immediately after the exchange if the shareholders own (immediately after the distribution) stock possessing—
   ...
   Subsec. (g)(1)(A) to (C).
   Pub. L. 105–206, § 6010(e)(1)
   , inserted “and” at end of subpar. (A), added subpar. (B), and struck out former subpars. (B) and (C) which read as follows:
   “(B) subsection (b) shall apply to such transferor, and
   “(C) such nonqualified
   preferred stock
   shall be treated as other property for purposes of applying subsection (b).”
   1997—Subsec. (c).
   Pub. L. 105–34, § 1012(c)(1)
   , amended heading and text of subsec. (c) generally. Prior to amendment, text read as follows: “In determining
   control,
   for purposes of this section, the fact that any corporate transferor distributes part or all of the stock which it receives in the exchange to its shareholders shall not be taken into account.”
   Subsec. (e)(1).
   Pub. L. 105–34, § 1002(a)
   ...
   1990—Subsec. (e)(2).
   Pub. L. 101–508
   substituted “is used” for “are used”.
   1989—Subsec. (a).
   Pub. L. 101–239, § 7203(a)
   , struck out “or
   securities”
   after “stock”.
   Subsecs. (b), (d), (e)(2).
   Pub. L. 101–239, § 7203(b)(1)
   , struck out “or
   securities”
   after “stock”.
   Subsec. (g)(2).
   Pub. L. 101–239, § 7203(b)(2)
   , substituted “stock or property” for “stock,
   securities,
   or property”.
   1988—Subsecs. (f), (g).
   Pub. L. 100–647
   ...
   1980—Subsec. (a).
   Pub. L. 96–589, § 5(e)(2)
   , struck out provision that stock or
   securities
   issued for services shall not be considered as issued in return for property for purposes of this section.
   Subsec. (d).
   Pub. L. 96–589, § 5(e)(1)
   , added subsec. (d). Former subsec. (d) redesignated (e)(1).
   Subsec. (e).
   Pub. L. 96–589, § 5(e)(2)
   , redesignated former subsec. (d) as par. (1) and added par. (2). Former subsec. (e) redesignated (f).
   Subsec. (f).
   Pub. L. 96–589, § 5(e)(1)
   , redesignated former subsec. (e) as (f).
   1976—Subsec. (a).
   Pub. L. 94–455, § 1901(a)(48)(A)
   , struck out “(including, in the case of transfers made on or before
   June 30, 1967
   , an
   investment company)
   ” after “property is transferred to a corporation”.
   Subsec. (d).
   Pub. L. 94–455, § 1901(a)(48)(B)
   , among other changes, substituted “Exception” for “Application of
   June 30, 1967
   , date” in heading and in text provision that this section does not apply to a transfer of property to an
   investment company
   for provisions relating to treatment of a transfer of property to an
   investment company
   as made on or before
   June 30, 1967
   .
   1966—Subsec. (a).
   Pub. L. 89–809, § 203(a)
   , inserted “(including, in the case of transfers made on or before
   June 30, 1967
   , an
   investment company)
   ” after “if property is transferred to a corporation”.
   Subsecs. (d), (e).
   Pub. L. 89–809, § 203(b)
   ...
   June 8, 1997
   , and at all times thereafter before such transfer if such contract provides for the transfer of a fixed amount of property.”
   ...
   111 Stat. 917
   , as amended by
   Pub. L. 105–206, title VI, § 6010(c)(1)
   ,
   July 22, 1998
   ,
   112 Stat. 813
   ...
   “(1)
   Section 355 rules.—
   The amendments made by subsections (a) and (b) [amending sections
   355
   and
   358
   of this title] shall apply to distributions after
   April 16, 1997
   ; except that the amendment made by subsection (a) [amending
   section 355 of this title
   ] shall apply to such distributions only if pursuant to a plan (or series of related transactions) which involves an acquisition described in section 355(e)(2)(A)(ii) of the
   ...
   , and
   368
   of this title] shall not apply to any distribution pursuant to a plan (or series of related transactions) which involves an acquisition described in section 355(e)(2)(A)(ii) of the
   Internal Revenue Code of 1986
   (or, in the case of the amendments made by subsection (c), any transfer) occurring after
   April 16, 1997
   ...
   ’ for ‘
   October 2, 1989
   ’. The preceding sentence shall not apply where the corporation meets the requirements of section 1504(a)(2) of the
   Internal Revenue Code of 1986
   with respect to the transferee corporation (and where the transfer is not part of a plan pursuant to which the transferor subsequently fails to meet such requirements).”
   ...
   ,
   102 Stat. 3580
   , provided that the amendment made by that section is effective with respect to transfers on or after
   June 21, 1988
   .
   Effective Date of 1982 Amendment
   Amendment by
   Pub. L. 97–248
   applicable to transfers occurring after
   Aug. 31, 1982
   , except for certain transfers pursuant to an application to form a BHC filed with the Federal Reserve Board before
   Aug. 16, 1982
   , see
   section 226(c) of Pub. L. 97–248
   , set out as a note under
