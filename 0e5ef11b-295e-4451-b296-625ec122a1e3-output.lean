...
This project request had uuid: 0e5ef11b-295e-4451-b296-625ec122a1e3
-/
...
/-!
# IRC Section 433 - Minimum funding standards for CSEC plans

This file formalizes IRC §433 (Minimum funding standards for CSEC plans).

## References
- [26 USC §433](https://www.law.cornell.edu/uscode/text/26/433)
...
## Summary
   ...
   Section
   Go!
   26 U.S. Code § 433 - Minimum funding standards for CSEC plans
   U.S. Code
   Notes
   prev
   | next
   ...
   (E)
   the amount necessary to amortize in equal annual installments (until fully amortized) over a period of 20 years the contributions which would be required to be made under the plan but for the provisions of section 412(c)(7)(A)(i)(I) (as in effect on the day before the enactment of the
   ...
   (D)
   in the case of a plan year for which the
   accumulated funding deficiency
   is determined under the funding standard account if such plan year follows a plan year for which such deficiency was determined under the alternative minimum funding standard, the excess (if any) of any debit balance in the funding standard account (determined without regard to this subparagraph) over any debit balance in the alternative minimum funding standard account.
   (4)
   ...
   Amortization schedules for amounts described in paragraphs (2) and (3) that are in effect as of the last day of the last plan year beginning before
   January 1, 2014
   , by reason of section 104 of the
   Pension Protection Act of 2006
   shall remain in effect pursuant to their terms and this section, except that such amounts shall not be amortized again under this section.
   (c)
   Special rules
   (1)
   ...
   normal costs
   , accrued liability, past service liabilities, and experience gains and losses shall be determined under the funding method used to determine costs under the plan.
   (2)
   Valuation of assets
   (A)
   In general
   ...
   The Secretary may by regulations provide that the value of any dedicated bond portfolio of a plan shall be determined by using the interest rate under section 412(b)(5) (as in effect on the day before the enactment of the
   Pension Protection Act of 2006
   ).
   (3)
   ...
   (A)
   a change in benefits under the
   Social Security Act
   or in other retirement benefits created under Federal or State law, or
   (B)
   a change in the definition of the term “wages” under
   section 3121
   or a change in the amount of such wages taken into account under regulations prescribed for purposes of section 401(a)(5),
   ...
   All funding methods available to CSEC plans under section 412 (as in effect on the day before the enactment of the
   Pension Protection Act of 2006
   ...
   (i)
   In general
   No actuarial assumption (other than the assumptions described in subsection (h)(3)) used to determine the
   current liability
   for a plan to which this subparagraph applies may be changed without the approval of the Secretary.
   (ii)
   ...
   controlled groups
   (as defined in section 4001(a)(14) of such Act) which are covered by title IV of such Act (disregarding plans with no unfunded vested benefits) exceed $50,000,000, and
   (III)
   the change in assumptions (determined after taking into account any changes in interest rate and mortality table) results in a decrease in the funding shortfall of the plan for the current plan year that exceeds $50,000,000, or that exceeds $5,000,000 and that is 5 percent or more of the
   current liability
   of the plan before such change.
   (6)
   Full funding
   If, as of the close of a plan year, a plan would (without regard to this paragraph) have an
   accumulated funding deficiency
   (determined without regard to the alternative minimum funding standard account permitted under subsection (e)) in excess of the full funding limitation—
   (A)
   ...
   (A)
   the accrued liability (including
   normal cost
   ) under the plan (determined under the entry age normal funding method if such accrued liability cannot be directly calculated under the funding method used for the plan), over
   (B)
   the lesser of—
   (i)
   ...
   90 percent of the
   current liability
   (determined without regard to paragraph (4) of subsection (h)) of the plan (including the expected increase in such
   current liability
   due to benefits accruing during the plan year), over
   (II)
   ...
   The valuation referred to in subparagraph (A) may be made as of a date within the plan year prior to the year to which the valuation refers if, as of such date, the value of the assets of the plan are not less than 100 percent of the plan’s
   current liability
   .
   (iii)
   Adjustments
   ...
   (iv)
   Limitation
   A change in funding method to use a prior year valuation, as provided in clause (ii), may not be made unless as of the valuation date within the prior plan year, the value of the assets of the plan are not less than 125 percent of the plan’s
   current liability
   .
   (9)
   ...
   The period of years required to amortize any unfunded liability (described in any clause of subsection (b)(2)(B)) of any plan may be extended by the Secretary for a period of time (not in excess of 10 years) if the Secretary determines that such extension would carry out the purposes of the
   Employee Retirement Income Security Act of 1974
   and provide adequate protection for participants under the plan and their beneficiaries, and if the Secretary determines that the failure to permit such extension would result in—
   (1)
   ...
   (1)
   In general
   If a CSEC plan which has a
   funded current liability percentage
   for the preceding plan year of less than 100 percent fails to pay the full amount of a
   required installment
   for the plan year, then the rate of interest charged to the funding standard account under subsection (b)(5) with respect to the amount of the underpayment for the period of the underpayment shall be equal to the greater of—
   (A)
   ...
   The period for which interest is charged under this subsection with regard to any portion of the underpayment shall run from the
   due date
   for the installment to the date on which such portion is contributed to or under the plan (determined without regard to subsection (c)(9)).
   (C)
   Order of crediting contributions
   For purposes of subparagraph (A)(ii), contributions shall be credited against unpaid
   ...
   This paragraph shall apply to a CSEC plan other than a plan described in section 412(
   l
   )(6)(A) (as in effect on the day before the enactment of the
   Pension Protection Act of 2006
   ) which—
   (i)
   ...
   (C)
   Period of underpayment
   For purposes of paragraph (1), any portion of an installment that is treated as not paid under subparagraph (A) shall continue to be treated as unpaid until the close of the
   quarter
   in which the
   due date
   ...
   required installment
   is increased by reason of subparagraph (A), in no event shall such increase exceed the amount which, when added to prior installments for the plan year, is necessary to increase the
   funded current liability percentage
   (taking into account the expected increase in
   current liability
   ...
   quarter
   for which such installment is made) of the
   base amount
   with respect to such
   quarter
   over the value (as of such last day) of the plan’s
   liquid assets.
   (ii)
   Base amount
   (I)
   ...
   required installment
   under subsection (f) or any other payment required under this section before the
   due date
   for such installment or other payment, and
   (B)
   the unpaid balance of such installment or other payment (including interest), when added to the aggregate unpaid balance of all preceding such installments or other payments for which payment was not made before the
   due date
   ...
   This subsection shall apply to a CSEC plan for any plan year for which the
   funded current liability percentage
   of such plan is less than 100 percent. This subsection shall not apply to any plan to which section 4021 of the
   Employee Retirement Income Security Act of 1974
   ...
   required installments
   and other payments required under this section (including interest)—
   (A)
   ...
   for the
   required installment
   or other payment and shall continue until the last day of the first plan year in which the plan ceases to be described in paragraph (1)(B). Such lien shall continue to run without regard to whether such plan continues to be described in paragraph (2) during the period referred to in the preceding sentence.
   (C)
   ...
   Pension Benefit Guaranty Corporation
   , by any contributing employer (or any member of the
   controlled group
   ...
   ” and “
   required installment
   ” have the meanings given such terms by subsection (f), except that in the case of a payment other than a
   required installment
   , the
   due date
   shall be the date such payment is required to be made under this section.
   (B)
   Controlled group
   The term “
   controlled group
   ...
   current liability
   under this section shall be the third segment rate determined under section 430(h)(2)(C).
   (B)
   Mortality tables
   (i)
   Secretarial authority
   The Secretary may by regulation prescribe mortality tables to be used in determining
   current liability
   ...
   December 31, 1995
   , the Secretary shall establish mortality tables which may be used (in lieu of the tables under subparagraph (B)) to determine
   current liability
   under this subsection for individuals who are entitled to benefits under the plan on account of disability. The Secretary shall establish separate tables for individuals whose disabilities occur in plan years beginning before
   January 1, 1995
   ...
   (A)
   In general
   In the case of a participant to whom this paragraph applies, only the applicable percentage of the years of service before such individual became a participant shall be taken into account in computing the
   current liability
   of the plan.
   (B)
   ...
   (i)
   has not accrued any other benefit under any defined benefit plan (whether or not terminated) maintained by the employer or a member of the same
   controlled group
   ...
   (A)
   In general
   In the case of a CSEC plan that is in funding restoration status for a plan year, for purposes of section 412, the term “
   accumulated funding deficiency
   ...
   the excess of the
   normal cost
   of the plan for the plan year over the amount actually contributed to or under the plan for the plan year.
   (B)
   Normal cost
   In the case of a CSEC plan that uses a
   spread gain funding method
   , for purposes of this subsection, the term
   “normal cost”
   means
   normal cost
   as determined under the entry age normal funding method.
   (2)
   Plan amendments
   In the case of a CSEC plan that is in funding restoration status for a plan year, no amendment to such plan may take effect during such plan year if such amendment has the effect of increasing liabilities of the plan by means of increases in benefits, establishment of new benefits, changing the rate of benefit accrual, or changing the rate at which benefits become nonforfeitable. This paragraph shall not apply to any plan amendment that is required to comply with any applicable law. This paragraph shall cease to apply with respect to any plan year, effective as of the first day of the plan year (or if later, the effective date of the amendment) upon payment by the
   plan sponsor
   of a contribution to the plan (in addition to any contribution required under this section without regard to this paragraph) in an amount equal to the increase in the
   funding liability
   of the plan attributable to the plan amendment.
   (3)
   Funding restoration plan
   The sponsor of a CSEC plan shall establish a written funding restoration plan within 180 days of the receipt by the
   plan sponsor
   of a certification from the plan actuary that the plan is in funding restoration status for a plan year. Such funding restoration plan shall consist of actions that are calculated, based on reasonably anticipated experience and reasonable actuarial assumptions, to increase the plan’s
   funded percentage
   to 100 percent over a period that is not longer than the greater of 7 years or the shortest amount of time practicable. Such funding restoration plan shall take into account contributions required under this section (without regard to this paragraph). If a plan remains in funding restoration status for 2 or more years, such funding restoration plan shall be updated each year after the 1st such year within 180 days of receipt by the
   plan sponsor
   of a certification from the plan actuary that the plan remains in funding restoration status for the plan year.
   (4)
   Annual certification by plan actuary
   Not later than the 90th day of each plan year of a CSEC plan, the plan actuary shall certify to the
   plan sponsor
   whether or not the plan is in funding restoration status for the plan year, based on the plan’s
   funded percentage
   as of the beginning of the plan year. For this purpose, the actuary may conclusively rely on an estimate of—
   (A)
   the plan’s
   funding liability
   , based on the
   funding liability
   of the plan for the preceding plan year and on reasonable actuarial estimates, assumptions, and methods, and
   (B)
   the amount of any contributions reasonably anticipated to be made for the preceding plan year.
   Contributions described in subparagraph (B) shall be taken into account in determining the plan’s
   funded percentage
   ...
   (A)
   Funding restoration status
   A CSEC plan shall be treated as in funding restoration status for a plan year if the plan’s
   funded percentage
   as of the beginning of such plan year is less than 80 percent.
   (B)
   Funded percentage
   The term “
   funded percentage
   ...
   The term “
   funding liability
   ” for a plan year means the present value of all benefits accrued or earned under the plan as of the beginning of the plan year, based on the assumptions used by the plan pursuant to this section, including the interest rate described in subsection (b)(5)(A) (without regard to subsection (b)(5)(B)).
   (D)
   Spread gain funding method
   The term “
   spread gain funding method
   ” has the meaning given such term under rules and forms issued by the Secretary.
   (E)
   Plan sponsor
   The term “
   plan sponsor
   ” means, with respect to a CSEC plan, the association, committee, joint board of trustees, or other similar group of representatives of the parties who establish or maintain the plan.
   (Added
   Pub. L. 113–97, title II, § 202(a)
   ,
   Apr. 7, 2014
   ,
   128 Stat. 1122
   ; amended
   Pub. L. 115–141, div. U, title IV, § 401(a)(108)
   , (109)(A),
   Mar. 23, 2018
   ,
   132 Stat. 1189
   ...
   Editorial Notes
   References in Text
   Section 412 (as in effect on the day before the enactment of the
   Pension Protection Act of 2006
   ), referred to in subsecs. (b)(2)(E), (c)(2)(B), (5)(A), and (f)(5)(B), means
   ...
   Aug. 17, 2006
   .
   Section 111(a) of Pub. L. 109–280
   generally amended section 412.
   Section 104 of the
   Pension Protection Act of 2006
   , referred to in subsec. (b)(6), is
   ...
   The
   Social Security Act
   , referred to in subsecs. (c)(4)(A) and (h)(3)(C)(ii), is act Aug. 14, 1935, ch. 531,
   49 Stat. 620
   , which is classified generally to chapter 7 (§ 301 et seq.) of Title 42, The Public Health and Welfare. Title II of the Act is classified generally to subchapter II (§ 401 et seq.) of chapter 7 of Title 42. For complete classification of this Act to the Code, see
   section 1305 of Title 42
   and Tables.
   The
   Employee Retirement Income Security Act of 1974
   , referred to in subsecs. (c)(5)(C)(ii)(II), (d), and (g)(2), (4)(C), is
   Pub. L. 93–406
   ,
   Sept. 2, 1974
   ,
   ...
   Retirement Protection Act of 1994
   , referred to in subsec. (g)(2), is the date of enactment of subtitle F of title VII of
   Pub. L. 103–465
   , which was approved
   Dec. 8, 1994
   .
   Amendments
   2018—
   Pub. L. 115–141, § 401(a)(109)(A)
   , inserted “for CSEC plans” after “funding standards” in section catchline.
   Subsec. (c)(5)(C)(ii)(II).
   Pub. L. 115–141, § 401(a)(108)
   , inserted “of such Act” after “title IV”.
   Statutory Notes and Related Subsidiaries
   Effective Date
   Section applicable to years beginning after
   Dec. 31, 2013
   , see
