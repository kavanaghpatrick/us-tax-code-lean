...
This project request had uuid: cbb4fb2d-42d4-4891-8c1c-111d1828bf98
-/
...
Lean version: leanprover/lean4:v4.24.0
Mathlib version: f897ebcf72cd16f89ab4577d0c826cd14afaafc7
This project request had uuid: f8eeacfe-d4f1-444d-b52e-e212d797db86
...
/-!
# IRC Section 267 - Losses, expenses, and interest with respect to transactions between related taxpayers

This file formalizes IRC §267 (Losses, expenses, and interest with respect to transactions between related taxpayers).

## References
- [26 USC §267](https://www.law.cornell.edu/uscode/text/26/267)
...
## Summary
   ...
   then any deduction allowable under this chapter in respect of such amount shall be allowable as of the day as of which such amount is includible in the gross income of the person to whom the payment is made (or, if later, as of the day on which it would be so allowable but for this paragraph). For purposes of this paragraph, in the case of a personal service corporation (within the meaning of
   section 441(i)(2)
   ), such corporation and any employee-owner (within the meaning of section 269A(b)(2), as modified by section 441(i)(2)) shall be treated as persons specified in subsection (b).
   (3)
   ...
   (i)
   In general
   Notwithstanding subparagraph (A), in the case of any item payable to a
   ...
   (3)
   Exception for transfers from tax indifferent parties
   Paragraph (1) shall not apply to the extent any loss sustained by the transferor (if allowed) would not be taken into account in determining a tax imposed under section
   1
   or
   11
   ...
   (1)
   In general
   In the case of any amount paid or incurred by, to, or on behalf of, a
   pass-thru entity
   ...
   in the case of—
   (i)
   a partnership, any person who owns (directly or indirectly) any capital
   interest
   or profits
   interest
   ...
   (C)
   any person who owns (directly or indirectly) any capital
   interest
   or profits
   interest
   of a partnership in which such entity owns (directly or indirectly) any capital
   interest
   or profits
   interest
   , and
   (D)
   any person related (within the meaning of subsection (b) of this section or
   section 707(b)(1)
   ) to a person described in subparagraph (B) or (C),
   shall be treated as persons specified in a paragraph of subsection (b). Subparagraph (C) shall apply to a transaction only if such transaction is related either to the operations of the partnership described in such subparagraph or to an
   interest
   in such partnership.
   (2)
   Pass-thru entity
   ...
   For purposes of determining ownership of a capital
   interest
   or profits
   interest
   of a partnership, the principles of subsection (c) shall apply, except that—
   (A)
   paragraph (3) of subsection (c) shall not apply, and
   (B)
   interests
   owned (directly or indirectly) by or for a C corporation shall be considered as owned by or for any shareholder only if such shareholder owns (directly or indirectly) 5 percent or more in value of the stock of such corporation.
   (4)
   Subsection (a)(2) not to apply to certain guaranteed payments of partnerships
   In the case of any amount paid or incurred by a partnership, subsection (a)(2) shall not apply to the extent that
   section 707(c)
   ...
   paid or incurred by a partnership owning
   low-income housing
   to—
   (i)
   any
   ...
   qualified 5-percent or less partner
   ” means any partner who has (directly or indirectly) an
   interest
   of 5 percent or less in the aggregate capital and profits
   interests
   of the partnership but only if—
   (i)
   such partner owned the
   low-income housing
   at all times during the 2-year period ending on the date such housing was transferred to the partnership, or
   (ii)
   such partnership acquired the
   low-income housing
   pursuant to a purchase, assignment, or other transfer from the
   Department of Housing and Urban Development
   or any State or local housing authority.
   For purposes of the preceding sentence, a partner shall be treated as holding any
   interest
   in the partnership which is held (directly or indirectly) by any person related (within the meaning of subsection (b) of this section or
   section 707(b)(1)
   ) to such partner.
   (C)
   Qualified expenses and interest
   ...
   qualified expenses and interest
   ” means any expense or
   interest
   incurred by the partnership with respect to
   low-income housing
   held by the partnership but—
   (i)
   only if the amount of such expense or
   interest
   (as the case may be) is unconditionally required to be paid by the partnership not later than 10 years after the date such amount was incurred, and
   (ii)
   in the case of such
   interest
   , only if such
   ...
   any
   interest
   in property described in clause (i), (ii), (iii), or (iv) of section 1250(a)(1)(B), and
   (ii)
   any
   interest
   in a partnership owning such property.
   (6)
   Cross reference
   ...
   In the case of any loss from the sale or exchange of property which is between members of the same
   controlled group
   and to which subsection (a)(1) applies (determined without regard to this paragraph but with regard to paragraph (3))—
   (A)
   subsections (a)(1) and (d) shall not apply to such loss, but
   (B)
   such loss shall be deferred until the property is transferred outside such
   controlled group
   and there would be recognition of loss under consolidated return principles or until such other time as may be prescribed in regulations.
   (3)
   ...
   controlled group
   ” shall not include a DISC.
   (B)
   Certain sales of inventory
   Except to the extent provided in regulations prescribed by the Secretary, subsection (a)(1) shall not apply to the sale or exchange of property between members of the same
   controlled group
   (or persons described in subsection (b)(10)) if—
   (i)
   ...
   To the extent provided in regulations, subsection (a)(1) shall not apply to any loss sustained by a member of a
   controlled group
   on the repayment of a loan made to another member of such group if such loan is payable in a foreign currency or is denominated in such a currency and such loss is attributable to a reduction in value of such foreign currency.
   (D)
   ...
   96 Stat. 1689
   ;
   Pub. L. 98–369, div. A, title I, § 174(a)
   –(b)(4), title VII, § 721(s),
   July 18, 1984
   ,
   98 Stat. 704–707
   ...
   , §§ 803(b)(5), 806(c)(2), title XVIII, §§ 1812(c)(1), (2), (3)(C), (4)(A), 1842(a),
   Oct. 22, 1986
   ,
   100 Stat. 2356
   , 2364, 2834, 2835, 2852;
   ...
   102 Stat. 3401
   , 3441;
   Pub. L. 105–34, title XIII, § 1308(a)
   , title XVI, § 1604(e)(1),
   Aug. 5, 1997
   ,
   111 Stat. 1041
   , 1098;
   Pub. L. 106–170, title V, § 532(c)(2)(C)
   ,
   Dec. 17, 1999
   ,
   113 Stat. 1930
   ;
   Pub. L. 108–357, title VIII, § 841(b)
   ,
   Oct. 22, 2004
   ,
   118 Stat. 1598
   ;
   Pub. L. 111–325, title III, § 306(b)
   ,
   Dec. 22, 2010
   ,
   124 Stat. 3549
   ;
   Pub. L. 113–295, div. A, title II, § 221(a)(44)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4044
   ;
   Pub. L. 114–113, div. Q, title III, § 345(a)
   ,
   Dec. 18, 2015
   ,
   129 Stat. 3115
   ...
   2015—Subsec. (d).
   Pub. L. 114–113
   amended subsec. (d) generally. Prior to amendment, text read as follows: “If—
   ...
   2014—Subsec. (d).
   Pub. L. 113–295
   , in concluding provisions, struck out “This subsection applies with respect to taxable years ending after
   December 31, 1953
   . ” after “by the taxpayer.” and “or by reason of section 118 of the
   Internal Revenue Code of 1939
   ” after “sales)”.
   Subsec. (d)(1).
   Pub. L. 113–295
   struck out “(or by reason of section 24(b) of the
   Internal Revenue Code of 1939
   ...
   , added par. (13).
   Subsec. (f)(4).
   Pub. L. 105–34, § 1604(e)(1)
   , added par. (4).
   1988—Subsec. (a)(1).
   Pub. L. 100–647, § 1006(e)(9)
   , struck out “(other than a loss in case of a distribution in corporate liquidation)” after “exchange of property” and inserted at end “The preceding sentence shall not apply to any loss of the distributing corporation (or the distributee) in the case of a distribution in complete liquidation.”
   Subsec. (a)(2).
   Pub. L. 100–647, § 1008(e)(6)
   , made technical correction to directory language of
   Pub. L. 99–514, § 806(c)(2)
   , see 1986 Amendment note below.
   1986—Subsec. (a)(2).
   Pub. L. 99–514, § 806(c)(2)
   , as amended by
   Pub. L. 100–647, § 1008(e)(6)
   , inserted at end “For purposes of this paragraph, in the case of a personal service corporation (within the meaning of section 441(i)(2)), such corporation and any employee-owner (within the meaning of section 269A(b)(2), as modified by section 441(i)(2)) shall be treated as persons specified in subsection (b).”
   Subsec. (a)(3).
   Pub. L. 99–514, § 1812(c)(1)
   , added par. (3).
   Subsec. (b)(12).
   Pub. L. 99–514, § 1812(c)(4)(A)
   , substituted “same persons own” for “same persons owns”.
   Subsec. (e)(5)(D).
   Pub. L. 99–514, § 803(b)(5)
   , substituted in cl. (i)
   “interest
   in property described in clause (i), (ii), (iii), or (iv) of section 1250(a)(1)(B)” for
   “interest
   in
   low-income housing
   (as defined in paragraph (5) of section 189(e))” and in cl. (ii) “such property” for
   “low-income housing
   (as so defined)”.
   Subsec. (e)(6).
   Pub. L. 99–514, § 1812(c)(3)(C)
   , added par. (6).
   Subsec. (f)(3)(B).
   Pub. L. 99–514, § 1812(c)(2)
   , inserted “(or persons described in subsection (b)(10))”.
   Subsec. (g).
   Pub. L. 99–514, § 1842(a)
   , added subsec. (g).
   1984—Subsec. (a).
   Pub. L. 98–369, § 174(a)
   , amended subsec. (a) generally, substituting “In general” for “Deduction disallowed” in heading, “Deduction for losses disallowed” for “Losses” in par. (1) heading, and provisions dealing with matching of deduction and payee income item in the case of expenses and
   interest
   for provisions dealing with unpaid expenses and
   interest
   in par. (2).
   Subsec. (b)(3).
   Pub. L. 98–369, § 174(b)(2)(A)
   , substituted “Two corporations which are members of the same
   controlled group
   (as defined in subsection (f))” for “Two corporations more than 50 percent in value of the outstanding stock of each of which is owned, directly or indirectly, by or for the same individual, if either one of such corporations, with respect to the taxable year of the corporation preceding the date of the sale or exchange was, under the law applicable to such taxable year, a personal holding company or a foreign personal holding company”.
   Subsec. (b)(10).
   Pub. L. 98–369, § 174(b)(3)
   , substituted “A corporation” for “An S corporation” in introductory provisions and “the corporation” for “the S corporation” in subpar. (A).
   Subsec. (b)(12).
   Pub. L. 98–369, § 174(b)(4)
   , substituted “the same persons” for “the same individual”.
   Subsec. (e).
   Pub. L. 98–369, § 174(b)(1)
   , added subsec. (e).
   Pub. L. 98–369, § 174(a)(2)
   ...
   Subsec. (f).
   Pub. L. 98–369, § 174(b)(2)(B)
   , added subsec. (f).
   Pub. L. 98–369, § 174(b)(1)
   , struck out subsec. (f) which related to special rules for unpaid expenses and
   interest
   of S corporations and treatment under such provisions of certain shareholders, etc., as related persons.
   Pub. L. 98–369, § 721(s)
   , in closing provision of par. (1) substituted “then any deduction allowable under such sections in respect of such amount shall be allowable as of the day as of which such payment is includible in the gross income of the person to whom the payment is made (or, if later, as of the day on which it would be so allowable but for this paragraph)” for “then no deduction shall be allowed in respect of expenses otherwise deductible under section 162 or 212, or of
   interest
   otherwise deductible under section 163, before the day as of which the amount thereof is includible in the gross income of the person to whom the payment is made”.
   ...
   Pub. L. 114–113, div. Q, title III, § 345(b)
   ,
   Dec. 18, 2015
   ,
   129 Stat. 3115
   , provided that:
   “The amendment made by this section [amending this section] shall apply to sales and other
   dispositions
   of property acquired after
   December 31, 2015
   , by the taxpayer in a sale or exchange to which section 267(a)(1) of the
   ...
   Amendment by
   Pub. L. 108–357
   applicable to payments accrued on or after
   Oct. 22, 2004
   , see
   section 841(c) of Pub. L. 108–357
   , set out as a note under
   ...
   Pub. L. 105–34, title XIII, § 1308(c)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 1042
   ...
   Pub. L. 105–34, title XVI, § 1604(e)(2)
   ,
   Aug. 5, 1997
   ,
   111 Stat. 1098
   , provided that:
   “The amendment made by paragraph (1) [amending this section] shall take effect as if included in section 174(b) of the
   ...
   Jan. 1, 1987
   , the amendment by
   section 803(b)(5) of Pub. L. 99–514
   is applicable to such
   interest
   ...
   Amendment by
   section 803(b)(5) of Pub. L. 99–514
   applicable, except as otherwise provided, to costs incurred after
   Dec. 31, 1986
   ...
   .
   Amendment by
   section 806(c)(2) of Pub. L. 99–514
   applicable to taxable years beginning after
   Dec. 31, 1986
   , with special provisions applicable to taxpayers who are required to change their accounting periods, see
   section 806(e) of Pub. L. 99–514
   , set out as a note under
   ...
   Pub. L. 98–369, div. A, title I, § 174(c)
   ,
   July 18, 1984
   ,
   98 Stat. 707
   ...
   The amendments made by subsections (a) and (b)(1) [amending this section] shall apply to amounts allowable as deductions under chapter 1 of the
   Internal Revenue Code of 1986
   [formerly I.R.C. 1954] for taxable years beginning after
   December 31, 1983
   . For purposes of the preceding sentence, the allowability of a deduction shall be determined without regard to any disallowance or postponement of deductions under section 267 of such Code.
   “(2)
   Subsection (b) (other than paragraph (1)).—
   “(A)
   In general.—
   Except as provided in subparagraph (B), the amendments made by subsection (b) (other than paragraph (1) thereof) [amending this section and sections
   170
   ,
   368
   ,
   ...
   , and
   1235
   of this title] shall not apply to any amount paid or incurred—
   “(i)
   ...
   September 29, 1983
   , and at all times thereafter before the amount is paid or incurred.
   “(B)
   ...
   September 29, 1983
   , subparagraph (A) shall not apply to any amount paid or incurred on such indebtedness (or pursuant to such contract) after the date of such renegotiation, extension, renewal, or revision.”
   Amendment by
   section 721(s) of Pub. L. 98–369
   ...
   Construction of
   Section 806 of Pub. L. 99–514
   Nothing in
   section 806 of Pub. L. 99–514
   [amending this section] or in any legislative history relating thereto to be construed as requiring the Secretary of the Treasury or his delegate to permit an automatic change of a taxable year, see
   section 1008(e)(9) of Pub. L. 100–647
   , set out as a note under
   section 1378 of this title
   .
   ...
   Pub. L. 99–514, title XVIII, § 1812(c)(5)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2835
   , provided that:
   “Clause (i) of section 174(c)(3)(A) of the
   Tax Reform Act of 1984
   [
   section 174(c)(3)(A)(i) of Pub. L. 98–369
   , set out as a note above] shall be applied by substituting ‘
   December 31, 1983
   ’ for ‘
   September 29, 1983
   ’ in the case of indebtedness which matures on
   January 1, 1999
   , the payments on which from January 1989 through November 1993 equal U/L plus $77,600, the payments on which from December 1993 to maturity equal U/L plus $50,100, and which accrued
   interest
   at 13.75 percent through
   December 31, 1989
   .”
   CFR Title
   Parts
