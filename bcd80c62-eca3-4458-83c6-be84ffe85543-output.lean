...
This project request had uuid: bcd80c62-eca3-4458-83c6-be84ffe85543
-/
...
/-!
# IRC Section 150 - Definitions and special rules

This file formalizes IRC §150 (Definitions and special rules).

## References
- [26 USC §150](https://www.law.cornell.edu/uscode/text/26/150)
...
## Summary
   ...
   The term “
   net proceeds
   ” means, with respect to any issue, the proceeds of such issue reduced by amounts in a reasonably required reserve or replacement fund.
   (4)
   ...
   bond
   (or issue), that the interest on such
   bond
   (or on the
   bonds
   issued as part of such issue) is excluded from gross income.
   (b)
   ...
   (A)
   In general
   In the case of any residence with respect to which financing is provided from the proceeds of a
   tax-exempt
   qualified mortgage
   bond
   or
   ...
   bond
   which, when issued, purported to be a
   tax-exempt
   bond
   described in paragraph (7) of section 142(a), and
   (B)
   which does not meet the requirements of section 142(d),
   no deduction shall be allowed under this chapter for interest on such financing which accrues during the period beginning on the 1st day of the taxable year in which such project fails to meet such requirements and ending on the date such project meets such requirements. If the provisions of prior law corresponding to
   section 142(d)
   apply to a refunded
   bond,
   such provisions shall apply (in lieu of section 142(d)) to the refunding
   bond.
   (3)
   ...
   , if any portion of such facility—
   (i)
   is used in a trade or business of any person other than a
   501(c)(3) organization
   or a governmental unit, but
   (ii)
   continues to be owned by a
   501(c)(3) organization
   ,
   then the owner of such portion shall be treated for purposes of this title as engaged in an unrelated trade or business (as defined in
   section 513
   ) with respect to such portion. The amount of gross income attributable to such portion for any period shall not be less than the fair rental value of such portion for such period.
   (B)
   ...
   In the case of any facility with respect to which financing is provided from the proceeds of any private activity
   bond
   to which this paragraph applies, if such facility is not used for a purpose for which a
   tax-exempt
   bond
   could be issued on the date of such issue, no deduction shall be allowed under this chapter for interest on such financing which accrues during the period beginning on the date such facility is not so used and ending on the date such facility is so used.
   (B)
   Bonds to which paragraph applies
   This paragraph applies to any private activity
   bond
   which, when issued, purported to be a
   tax-exempt
   exempt facility bond
   described in a paragraph (other than paragraph (7)) of
   section 142(a)
   or a
   ...
   If—
   (A)
   financing is provided with respect to any facility from the proceeds of any private activity
   bond
   which, when issued, purported to be a
   tax-exempt
   bond,
   (B)
   such facility is required to be owned by a governmental unit or a
   501(c)(3) organization
   as a condition of such tax exemption, and
   (C)
   ...
   which, when issued, purported to be a
   qualified small issue bond
   , no deduction shall be allowed under this chapter for interest on such financing which accrues during the period such
   bond
   is not a
   qualified small issue bond
   .
   ...
   If the amounts payable for the use of a facility are not interest, subsection (b) shall apply to such amounts as if they were interest but only to the extent such amounts for any period do not exceed the amount of interest accrued on the
   bond
   ...
   (4)
   Cessation with respect to portion of facility
   ...
   A
   qualified scholarship funding bond
   shall be treated as a State or local
   bond.
   (2)
   ...
   (A)
   is a corporation not for profit established and operated exclusively for the purpose of acquiring student loan notes incurred under the
   ...
   Any
   qualified scholarship funding bond
   , and qualified student loan
   bond,
   outstanding on the date of the issuer’s election under this paragraph (and any
   bond
   (or series of
   bonds)
   issued to refund such a
   bond)
   shall not fail to be a
   tax-exempt
   bond solely because the issuer ceases to be described in subparagraphs (A) and (B) of paragraph (2) if the issuer meets the requirements of subparagraphs (B) and (C) of this paragraph.
   (B)
   ...
   (i)
   all of the student loan notes of the issuer and other assets pledged to secure the repayment of
   qualified scholarship funding bond
   indebtedness of the issuer are transferred to another corporation within a reasonable period after the election is made under this paragraph;
   (ii)
   such transferee corporation assumes or otherwise provides for the payment of all of the
   qualified scholarship funding bond
   indebtedness of the issuer within a reasonable period after the election is made under this paragraph;
   (iii)
   ...
   (iv)
   immediately after such transfer, the issuer, together with any other issuer which has made an election under this paragraph in respect of such transferee, hold all of the
   senior stock
   in such transferee corporation; and
   (v)
   such transferee corporation is not exempt from tax under this chapter.
   (C)
   Issuer to operate as independent organization described in section 501(c)(3)
   ...
   (iii)
   at least 80 percent of the members of the board of directors of the issuer are
   independent members
   .
   (D)
   Senior stock
   ...
   The term “
   independent member
   ” means a member of the board of directors of the issuer who (except for services as a member of such board) receives no compensation directly or indirectly—
   (i)
   for services performed in connection with such transferee corporation, or
   (ii)
   for services as a member of the board of directors or as an
   officer
   of such transferee corporation.
   For purposes of clause (ii), the term “
   officer
   ” includes any individual having powers or responsibilities similar to those of
   officers
   .
   (F)
   ...
   (i)
   the last day of the last taxable year for which more than 50 percent of the gross income of such transferee corporation is derived from, or more than 50 percent of the assets (by value) of such transferee corporation consists of, student loan notes incurred under the
   Higher Education Act of 1965
   ; or
   (ii)
   ...
   A
   bond
   of a volunteer fire department shall be treated as a
   bond
   of a political subdivision of a State if—
   (A)
   such department is a
   qualified volunteer fire department
   with respect to an area within the jurisdiction of such political subdivision, and
   (B)
   such
   bond
   is issued as part of an issue 95 percent or more of the
   net proceeds
   of which are to be used for the acquisition, construction, reconstruction, or improvement of a firehouse (including land which is functionally related and subordinate thereto) or firetruck used or to be used by such department.
   (2)
   Qualified volunteer fire department
   ...
   For purposes of subparagraph (A), other firefighting services provided in an area shall be disregarded in determining whether an organization is a
   qualified volunteer fire department
   if such other firefighting services are provided by a
   qualified volunteer fire department
   (determined with the application of this sentence) and such organization and the provider of such other services have been continuously providing firefighting services to such area since
   January 1, 1981
   .
   (3)
   Treatment as private activity bonds only for certain purposes
   Bonds which are part of an issue which meets the requirements of paragraph (1) shall not be treated as private activity
   bonds
   ...
   100 Stat. 2651
   ; amended
   Pub. L. 100–647, title I, § 1013(a)(23)
   , (24)(A), (30)–(33), title VI, § 6182(a), (b),
   Nov. 10, 1988
   ,
   102 Stat. 3542
   , 3543, 3729;
   Pub. L. 104–188, title I, § 1614(a)
   ,
   Aug. 20, 1996
   ,
   110 Stat. 1851
   ...
   The
   Higher Education Act of 1965
   , referred to in subsec. (d)(2)(A), (3)(F)(i), is
   Pub. L. 89–329
   ,
   Nov. 8, 1965
   ,
   79 Stat. 1219
   , which is classified generally to chapter 28 (§ 1001 et seq.) of Title 20, Education. For complete classification of this Act to the Code, see Short Title note set out under
   ...
   added par. (3).
   1988—Subsec. (b)(1)(A).
   Pub. L. 100–647, § 1013(a)(23)(C)
   , inserted
   “tax-exempt”
   before “qualified mortgage
   bond”
   .
   Pub. L. 100–647, § 1013(a)(30)
   , inserted before period at end “and before the date such residence is again the principal residence of at least 1 of the mortgagors who received such financing”.
   Subsec. (b)(2).
   Pub. L. 100–647, § 1013(a)(32)
   , inserted at end “If the provisions of prior law corresponding to section 142(d) apply to a refunded
   bond,
   such provisions shall apply (in lieu of section 142(d)) to the refunding
   bond.
   ”
   Subsec. (b)(2)(A).
   Pub. L. 100–647, § 1013(a)(31)
   , substituted “described in paragraph” for “described paragraph”.
   Subsec. (b)(4).
   Pub. L. 100–647, § 1013(a)(23)(A)
   , (B), inserted “and small issue
   bonds”
   after
   “bonds”
   in heading, and “or a
   qualified small issue bond”
   before period at end of subpar. (B).
   Subsec. (b)(6).
   Pub. L. 100–647, § 1013(a)(33)
   , added par. (6).
   Subsec. (e)(1)(B).
   Pub. L. 100–647, § 6182(b)
   , inserted “(including land which is functionally related and subordinate thereto)” after “a firehouse”.
   Subsec. (e)(2).
   Pub. L. 100–647, § 6182(a)
   , inserted at end “For purposes of subparagraph (A), other firefighting services provided in an area shall be disregarded in determining whether an organization is a
   qualified volunteer fire department
   if such other firefighting services are provided by a
   qualified volunteer fire department
   (determined with the application of this sentence) and such organization and the provider of such other services have been continuously providing firefighting services to such area since
   ...
   .”
   Subsec. (e)(3).
   Pub. L. 100–647, § 1013(a)(24)(A)
   , added par. (3).
   Statutory Notes and Related Subsidiaries
   Effective Date of 1996 Amendment
   Pub. L. 104–188, title I, § 1614(b)
   ,
   Aug. 20, 1996
   ,
   110 Stat. 1853
   ...
   Pub. L. 100–647, title I, § 1013(a)(24)(B)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3543
   ...
   issued after
   Aug. 15, 1986
   , except as otherwise provided, with subsec. (b) applicable to changes in use (and ownership) after
   Aug. 15, 1986
   , but only with respect to financing (including refinancings) provided after such date, and with subsec. (d) applicable to payments made after
   Aug. 15, 1986
   , see sections 1311 to 1318 of
   Pub. L. 99–514
