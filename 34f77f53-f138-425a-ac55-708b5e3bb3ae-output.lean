...
This project request had uuid: 34f77f53-f138-425a-ac55-708b5e3bb3ae
-/
...
This file formalizes IRC §183 (Activities not engaged in for profit).

## References
- [26 USC §183](https://www.law.cornell.edu/uscode/text/26/183)
...
## Summary
   ...
   activity not engaged in for profit
   ” means any activity other than one with respect to which deductions are allowable for the taxable year under
   section 162
   ...
   (4)
   Time for assessing deficiency attributable to activity
   ...
   (Added
   Pub. L. 91–172, title II, § 213(a)
   ,
   Dec. 30, 1969
   ,
   83 Stat. 571
   ; amended
   Pub. L. 92–178, title III, § 311(a)
   ,
   Dec. 10, 1971
   ,
   85 Stat. 525
   ;
   Pub. L. 94–455, title II, § 214(a)
   ...
   96 Stat. 1694
   ;
   Pub. L. 99–514, title I, § 143(a)
   ,
   Oct. 22, 1986
   ,
   100 Stat. 2120
   ;
   Pub. L. 100–647, title I, § 1001(h)(3)
   ,
   Nov. 10, 1988
   ,
   102 Stat. 3352
   ;
   Pub. L. 113–295, div. A, title II, § 221(a)(36)
   ,
   Dec. 19, 2014
   ,
   128 Stat. 4042
   ...
   2014—Subsec. (e)(1).
   Pub. L. 113–295
   struck out “For purposes of the preceding sentence, a taxpayer shall be treated as not having engaged in an activity during any taxable year beginning before
   January 1, 1970
   .” at end.
   1988—Subsec. (e)(2).
   Pub. L. 100–647
   substituted “activity for 3 (or 2 if applicable)” for “activity for 2”.
   1986—Subsec. (d).
   Pub. L. 99–514
   substituted “3” for “2” before “or more” in first sentence and “ ‘2’ for ‘3’ and ‘7’ for ‘5’ ” for “the period of 7 consecutive taxable years for the period of 5 consecutive taxable years” in second sentence.
   1982—Subsec. (a).
   Pub. L. 97–354
   ...
   section 6212 of this title
   ] shall apply with respect to taxable years beginning after
   December 31, 1969
   ; except that such amendments shall not apply to any taxable year ending before the date of the enactment of this Act [
   Oct. 4, 1976
   ] with respect to which the period for assessing a deficiency has expired before such date of enactment.”
   Effective Date of 1971 Amendment
   Pub. L. 92–178, title III, § 311(b)
   ,
   Dec. 10, 1971
   ,
   85 Stat. 526
   ...
   section 6504 of this title
   , and repealing
   section 270 of this title
